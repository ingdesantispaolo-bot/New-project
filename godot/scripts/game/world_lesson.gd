...
const LESSONS := {
	...
	11: {
		"subject": "storia",
		"objectives": ["Collocare gli eventi nel tempo (prima/dopo, a.C./d.C.).", "Riconoscere le prime civiltà e le loro tracce.", "Distinguere i tipi di fonte storica."],
		"prerequisites": ["Ordinare eventi in sequenza.", "Distinguere passato e presente."],
		"topics": ["preistoria", "egizi", "cronologia"],
		"conceptActions": [
			{"concept": "linea del tempo", "worldAction": "metti in fila le ere e gli eventi, dal più antico al più recente"},
		...
		"nora": {
			...
			"onStreak": "Colleghi bene tracce ed epoche: continua.",
	...
	23: {
		"subject": "storia",
		"objectives": ["Ricostruire cause e conseguenze di un evento.", "Collegare Roma e il Medioevo lungo la linea del tempo.", "Usare le fonti per spiegare un cambiamento."],
		"prerequisites": ["Linea del tempo e prime civiltà (L11).", "Distinguere a.C. e d.C."],
		"topics": ["roma", "medioevo", "cronologia"],
		"conceptActions": [
			{"concept": "da Roma al Medioevo", "worldAction": "ordina gli eventi che portano dalla nascita di Roma alla sua caduta e oltre"},
		...
		"nora": {
			...
			"onStreak": "Ricostruisci bene il filo del tempo: continua.",
