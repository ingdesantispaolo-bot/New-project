...
export const STORIA_PROGRAMMA = [
  ...
  { topic: "roma", difficulty: 2, difficulty8: true,
    ...
    answer: "permettevano di arrivare in fretta ovunque", distractors: ["servivano a commerciare grano e olio", "erano soprattutto un simbolo di potenza imperiale", "collegavano solo le città grandi"],
    ...
    distractorWhy: { "servivano a commerciare grano e olio": "Lo facevano anche, ma il grano viaggiava soprattutto via mare, che costa meno.", "erano soprattutto un simbolo di potenza imperiale": "Lo erano, ma un simbolo non spiega perché valessero quanto un esercito.", "collegavano solo le città grandi": "Arrivavano anche agli accampamenti e ai confini, dove città non ce n'erano." } },
