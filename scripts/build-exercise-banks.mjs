...
const CODING_EXTRA = [
  { topic: "variabili", difficulty: 1, prompt: "Quale di questi è un nome di variabile valido in Python?", answer: "punti_totali", distractors: ["2punti","punti totali","punti-totali"], explanation: "Un nome può avere lettere, cifre e underscore, ma non può iniziare con una cifra né contenere spazi o trattini.",
    distractorWhy: { "2punti": "Un nome non può iniziare con una cifra.", "punti totali": "Un nome non può contenere spazi.", "punti-totali": "Un nome non può contenere trattini: il trattino viene letto come un'operazione di sottrazione." } },
  ...
  { topic: "variabili", difficulty: 2, prompt: "In Python, il simbolo = serve a…", answer: "Mettere un valore dentro una variabile", distractors: ["Verificare se due valori sono uguali","Stampare un valore","Definire una funzione"], explanation: "= assegna, cioè scrive un valore nella variabile a sinistra. Per confrontare serve ==.",
    distractorWhy: { "Verificare se due valori sono uguali": "Il confronto si fa con ==, non con un singolo =.", "Stampare un valore": "Per stampare serve print(), non =.", "Definire una funzione": "Per definire una funzione serve def, non =." } },
  ...
  { topic: "variabili", difficulty: 3, prompt: "Quale scrittura è più breve per punti = punti + 1?", answer: "punti += 1", distractors: ["punti ++","punti = ++1","punti =+ 1"], explanation: "+= aggiunge al valore esistente. Python non ha l'operatore ++ di altri linguaggi.",
    distractorWhy: { "punti ++": "Python non ha l'operatore ++ presente in altri linguaggi: dà errore di sintassi.", "punti = ++1": "Questo assegnerebbe sempre 1 a punti, ignorando il valore precedente.", "punti =+ 1": "È letto come «punti = (+1)», cioè assegna sempre 1, non incrementa." } },
  { topic: "variabili", difficulty: 2, prompt: "Perché conviene chiamare una variabile punti_vita invece di p?", answer: "Perché rileggendo il codice si capisce cosa contiene", distractors: ["Perché i nomi lunghi rendono il programma più veloce", "Perché in Python i nomi di una lettera sola sono vietati", "Perché un nome corto fa occupare meno memoria"], explanation: "Il codice si legge molte più volte di quante si scriva: un nome che spiega sé stesso fa risparmiare tempo dopo.",
    distractorWhy: { "Perché i nomi lunghi rendono il programma più veloce": "La lunghezza del nome non cambia la velocità di esecuzione.", "Perché in Python i nomi di una lettera sola sono vietati": "I nomi di una lettera sono validi in Python: p = 5 funziona benissimo.", "Perché un nome corto fa occupare meno memoria": "La differenza di memoria per il nome è trascurabile: il vantaggio è la leggibilità." } },
  { topic: "variabili", difficulty: 3, prompt: "x = 5\nprint(y)\n\nPerché questo programma si ferma?", answer: "y non è mai stata definita", distractors: ["print accetta solo testo","x e y devono avere lo stesso valore","manca il punto e virgola"], explanation: "Una variabile esiste solo dopo che le si è assegnato qualcosa: prima Python non sa cosa sia y.",
    distractorWhy: { "print accetta solo testo": "print() accetta anche numeri e altri tipi: il problema è che y non esiste.", "x e y devono avere lo stesso valore": "Non c'è nessun obbligo che due variabili abbiano lo stesso valore.", "manca il punto e virgola": "Python non richiede il punto e virgola a fine riga: il problema è che y non è mai stata assegnata." } },
  ...
  { topic: "variabili", difficulty: 2, prompt: "In Python, PUNTI e punti sono…", answer: "Due variabili diverse", distractors: ["La stessa variabile","Un errore di sintassi","Sinonimi automatici"], explanation: "Python distingue maiuscole e minuscole: sono due nomi diversi, ed è una fonte di errori molto comune.",
    distractorWhy: { "La stessa variabile": "Python è case-sensitive: maiuscole e minuscole creano nomi distinti.", "Un errore di sintassi": "Entrambi i nomi sono validi singolarmente: non c'è nessun errore di sintassi nell'usarli.", "Sinonimi automatici": "Python non collega automaticamente nomi scritti in modo diverso." } },
  { topic: "variabili", difficulty: 3, prompt: "Che cosa contiene una variabile subito dopo nome = 'Eli'?", answer: "La stringa Eli", distractors: ["La lettera n","Il numero 3","Niente, va assegnata due volte"], explanation: "L'assegnazione è immediata: da quel momento la variabile nome vale 'Eli'.",
    distractorWhy: { "La lettera n": "L'assegnazione mette l'intera stringa 'Eli', non solo la prima lettera del nome della variabile.", "Il numero 3": "'Eli' è testo fra virgolette, non un numero: 3 non è mai stato scritto qui.", "Niente, va assegnata due volte": "Una sola assegnazione basta: il valore è disponibile subito dopo quella riga." } },
  ...
  { topic: "tipi", difficulty: 2, prompt: "Di che tipo è il valore True?", answer: "Booleano", distractors: ["Stringa","Numero intero","Lista"], explanation: "True e False sono i due valori booleani: rappresentano vero e falso, e si scrivono con la maiuscola.",
    distractorWhy: { "Stringa": "True non ha le virgolette: se le avesse ('True') sarebbe una stringa, ma così è un booleano.", "Numero intero": "True non è scritto come cifra: è la parola chiave booleana, anche se internamente equivale a 1.", "Lista": "True non ha parentesi quadre: non è una lista." } },
  { topic: "tipi", difficulty: 2, prompt: "Di che tipo è il valore 3.5?", answer: "Numero con la virgola (float)", distractors: ["Numero intero senza decimali (int)", "Stringa di testo fra virgolette", "Booleano, cioè vero o falso"], explanation: "Un numero con la parte decimale è un float. In Python il separatore è il punto, non la virgola.",
    distractorWhy: { "Numero intero senza decimali (int)": "3.5 ha una parte decimale: un int non può averla.", "Stringa di testo fra virgolette": "3.5 non ha virgolette: è un numero, non testo.", "Booleano, cioè vero o falso": "3.5 non è né True né False: è un valore numerico." } },
  { topic: "tipi", difficulty: 3, prompt: "Qual è la differenza fra 7 e '7'?", answer: "Il primo è un numero, il secondo è testo", distractors: ["Nessuna: Python li tratta allo stesso modo","Sono entrambi numeri, scritti in due modi","Il secondo non è una scrittura valida"], explanation: "Le virgolette cambiano il tipo: con 7 si può fare aritmetica, con '7' si può solo unire ad altro testo.",
    distractorWhy: { "Nessuna: Python li tratta allo stesso modo": "Python li tratta in modo diverso: 7 + 7 fa 14, ma '7' + '7' fa '77'.", "Sono entrambi numeri, scritti in due modi": "'7' fra virgolette è testo, non un numero: sono tipi diversi.", "Il secondo non è una scrittura valida": "'7' è una stringa perfettamente valida in Python, solo di tipo diverso da 7." } },
  ...
  { topic: "tipi", difficulty: 4, prompt: "Cosa succede con int('ciao')?", answer: "Un errore: non è un numero", distractors: ["Restituisce 0","Restituisce 'ciao'","Restituisce la lunghezza"], explanation: "int() converte solo stringhe che rappresentano un numero: su un testo qualsiasi si ferma.",
    distractorWhy: { "Restituisce 0": "int() non inventa uno zero di default: se il testo non è un numero, si ferma con un errore.", "Restituisce 'ciao'": "int() dovrebbe restituire un numero, non lasciare il testo invariato: se non può, dà errore.", "Restituisce la lunghezza": "int() non conta i caratteri: prova a leggere il testo come numero, e fallendo dà errore." } },
  { topic: "tipi", difficulty: 3, prompt: "Quale funzione dice di che tipo è un valore?", answer: "type()", distractors: ["kind()","typeof()","class()"], explanation: "type(x) restituisce il tipo di x: utile quando un programma si comporta in modo inatteso.",
    distractorWhy: { "kind()": "Non esiste una funzione kind() in Python.", "typeof()": "typeof è un operatore di JavaScript, non esiste in Python.", "class()": "class è una parola chiave per definire classi, non una funzione per controllare il tipo di un valore." } },
  { topic: "tipi", difficulty: 3, prompt: "Cosa restituisce str(9)?", answer: "La stringa '9'", distractors: ["Il numero 9","Il booleano True","Un errore"], explanation: "str() trasforma un valore in testo: serve quando si vuole unirlo ad altre stringhe.",
    distractorWhy: { "Il numero 9": "str() converte proprio in testo: il risultato non è più un numero.", "Il booleano True": "str() non produce un booleano: converte in stringa.", "Un errore": "str() funziona su qualunque valore, inclusi i numeri: non dà errore." } },
  ...
  { topic: "tipi", difficulty: 2, prompt: "Di che tipo è [1, 2, 3]?", answer: "Lista", distractors: ["Stringa","Numero","Booleano"], explanation: "Le parentesi quadre con valori separati da virgole formano una lista.",
    distractorWhy: { "Stringa": "Non ci sono virgolette: non è testo, è una sequenza di valori fra parentesi quadre.", "Numero": "Le parentesi quadre con più valori non formano un numero singolo.", "Booleano": "Non è né True né False: è una collezione di valori." } },
  { topic: "tipi", difficulty: 4, prompt: "Cosa stampa: print(3 + 2.0)?", answer: "5.0", distractors: ["5","32.0","errore"], explanation: "Mescolando int e float Python usa il tipo più «largo»: il risultato è un float.",
    distractorWhy: { "5": "Il risultato di una somma fra int e float è sempre float, quindi con il punto decimale, non 5 intero.", "32.0": "+ somma i numeri, non li affianca come farebbe con le stringhe: non dà 32.0.", "errore": "Python somma tranquillamente int e float: non dà nessun errore." } },
  { topic: "tipi", difficulty: 3, prompt: "Perché serve convertire il risultato di input() prima di fare calcoli?", answer: "Perché input() restituisce sempre testo", distractors: ["Perché input() restituisce sempre un float","Perché i calcoli vanno fatti a fine programma","Perché altrimenti il programma è lento"], explanation: "Anche quando l'utente scrive 42, il programma riceve la stringa '42': senza conversione i calcoli non funzionano.",
    distractorWhy: { "Perché input() restituisce sempre un float": "input() restituisce sempre una stringa di testo, mai un float automaticamente.", "Perché i calcoli vanno fatti a fine programma": "Il momento del calcolo non c'entra: il problema è il tipo del valore restituito da input().", "Perché altrimenti il programma è lento": "La velocità non è il problema: senza conversione i calcoli danno proprio errore." } },
  { topic: "booleani", difficulty: 2, prompt: "Quali sono i due soli valori booleani in Python?", answer: "True e False", distractors: ["Vero e Falso, in italiano", "Soltanto i numeri 1 e 0", "Le parole Sì e No"], explanation: "Si scrivono in inglese e con l'iniziale maiuscola: true minuscolo darebbe errore.",
    distractorWhy: { "Vero e Falso, in italiano": "Python usa le parole chiave inglesi True e False, non l'italiano.", "Soltanto i numeri 1 e 0": "1 e 0 sono equivalenti numerici, ma i veri valori booleani si scrivono True e False.", "Le parole Sì e No": "«Sì» e «No» non sono parole chiave di Python: non esistono come valori booleani." } },
  { topic: "booleani", difficulty: 2, prompt: "Quanto vale 5 > 3?", answer: "True", distractors: ["False","5","'True'"], explanation: "Un confronto non restituisce un numero: restituisce vero o falso.",
    distractorWhy: { "False": "5 è effettivamente maggiore di 3: il confronto è vero, non falso.", "5": "Un confronto non restituisce uno dei due numeri confrontati: restituisce un booleano.", "'True'": "Il risultato è il booleano True, non la stringa di testo 'True' fra virgolette." } },
  { topic: "booleani", difficulty: 3, prompt: "Quanto vale (4 > 2) and (1 > 5)?", answer: "False", distractors: ["True","Errore","4"], explanation: "and è vero solo se lo sono entrambe le parti: la seconda è falsa, quindi tutto è falso.",
    distractorWhy: { "True": "and richiede che siano vere entrambe le parti: la seconda (1 > 5) è falsa.", "Errore": "L'espressione è sintatticamente corretta: non genera nessun errore.", "4": "Il risultato di and è un booleano, non uno dei numeri usati nel confronto." } },
  { topic: "booleani", difficulty: 3, prompt: "Quanto vale (4 > 2) or (1 > 5)?", answer: "True", distractors: ["False","Errore","2"], explanation: "or basta che una parte sia vera: la prima lo è.",
    distractorWhy: { "False": "or basta che una delle due parti sia vera: la prima (4 > 2) lo è.", "Errore": "L'espressione è sintatticamente corretta: non genera nessun errore.", "2": "Il risultato di or è un booleano, non uno dei numeri usati nel confronto." } },
  { topic: "booleani", difficulty: 3, prompt: "Quanto vale not True?", answer: "False", distractors: ["True","0","Errore"], explanation: "not capovolge il valore: rende falso ciò che è vero e viceversa.",
    distractorWhy: { "True": "not capovolge il valore: non può restituire lo stesso valore di partenza.", "0": "not restituisce un booleano (False), non il numero 0.", "Errore": "not True è un'espressione valida: non genera errore." } },
  { topic: "booleani", difficulty: 4, prompt: "Quanto vale 3 == 3.0?", answer: "True", distractors: ["False","Errore","3"], explanation: "== confronta i valori, non i tipi: tre intero e tre virgola zero valgono lo stesso.",
    distractorWhy: { "False": "== confronta il valore numerico, non il tipo: 3 e 3.0 rappresentano lo stesso numero.", "Errore": "Confrontare int e float con == è perfettamente valido in Python.", "3": "Il risultato di == è un booleano, non uno dei due numeri confrontati." } },
  { topic: "booleani", difficulty: 3, prompt: "Quale operatore verifica che due valori siano DIVERSI?", answer: "!=", distractors: ["=/=","<>","not ="], explanation: "!= si legge «diverso da» e restituisce True quando i due valori non coincidono.",
    distractorWhy: { "=/=": "Questo simbolo non esiste in Python: darebbe errore di sintassi.", "<>": "«<>» era usato in vecchie versioni di Python 2, ma non è valido in Python 3.", "not =": "Non è un operatore valido: darebbe errore di sintassi." } },
  { topic: "booleani", difficulty: 4, prompt: "eta = 12\nprint(10 <= eta <= 14)\n\nCosa stampa?", answer: "True", distractors: ["False","12","Errore"], explanation: "Python permette di concatenare i confronti: legge «eta è fra 10 e 14, estremi compresi».",
    distractorWhy: { "False": "12 è effettivamente compreso fra 10 e 14: il confronto concatenato è vero.", "12": "Il risultato di un confronto è un booleano, non il valore della variabile eta.", "Errore": "Python permette confronti concatenati come questo: non genera nessun errore." } },
  { topic: "booleani", difficulty: 2, prompt: "A cosa serve un valore booleano in un programma?", answer: "A decidere quale strada prendere", distractors: ["A contare gli elementi","A stampare a schermo","A dare un nome alle variabili"], explanation: "if e while lavorano su valori booleani: sono loro a decidere se un blocco si esegue o si ripete.",
    distractorWhy: { "A contare gli elementi": "Contare elementi è compito di funzioni come len(), non dei valori booleani.", "A stampare a schermo": "Stampare è compito di print(), non del valore booleano in sé.", "A dare un nome alle variabili": "I nomi delle variabili si scelgono nel codice: non dipendono dai valori booleani." } },
  ...
  { topic: "funzioni", difficulty: 2, prompt: "Quale parola introduce la definizione di una funzione?", answer: "def", distractors: ["function","fun","define"], explanation: "def sta per «define»: dopo di essa vengono il nome, i parametri fra parentesi e i due punti.",
    distractorWhy: { "function": "«function» non è una parola chiave di Python: si usa def.", "fun": "«fun» non è una parola chiave di Python.", "define": "«define» per esteso non è la parola chiave: Python usa l'abbreviazione def." } },
  { topic: "funzioni", difficulty: 3, prompt: "Che cosa segna il corpo di una funzione in Python?", answer: "L'indentazione, cioè lo spazio a sinistra", distractors: ["Le parentesi graffe attorno al blocco", "Il punto e virgola a fine riga", "La parola end alla fine del blocco"], explanation: "In Python il rientro non è estetica: è la sintassi che dice quali righe appartengono alla funzione.",
    distractorWhy: { "Le parentesi graffe attorno al blocco": "Le graffe sono usate in altri linguaggi (come Java o C), non in Python.", "Il punto e virgola a fine riga": "Il punto e virgola non delimita blocchi in Python: al massimo separa istruzioni sulla stessa riga.", "La parola end alla fine del blocco": "Python non usa una parola end come altri linguaggi (per esempio Ruby): usa l'indentazione." } },
  ...
  { topic: "funzioni", difficulty: 3, prompt: "Perché una funzione dovrebbe fare una cosa sola?", answer: "Perché è più facile capirla e correggerla", distractors: ["Perché Python rifiuta le funzioni troppo lunghe", "Perché una funzione corta viene eseguita prima", "Perché così il programma occupa meno memoria"], explanation: "Una funzione che fa cinque cose si può riusare solo quando servono tutte e cinque, e quando sbaglia non si sa quale delle cinque.",
    distractorWhy: { "Perché Python rifiuta le funzioni troppo lunghe": "Python non impone limiti di lunghezza alle funzioni: è una questione di buona pratica, non di regola del linguaggio.", "Perché una funzione corta viene eseguita prima": "La lunghezza della funzione non determina l'ordine di esecuzione.", "Perché così il programma occupa meno memoria": "La memoria occupata non dipende in modo significativo dal fatto che una funzione faccia una o più cose." } },
  ...
  { topic: "cicli", difficulty: 3, prompt: "Quando si usa while invece di for?", answer: "Quando non si sa in anticipo quante ripetizioni servono", distractors: ["Quando le ripetizioni da fare sono più di dieci", "Quando si deve lavorare con stringhe invece che numeri", "Quando dentro il ciclo serve chiamare una funzione"], explanation: "for scorre una sequenza nota; while continua finché una condizione resta vera, anche senza sapere per quanto.",
    distractorWhy: { "Quando le ripetizioni da fare sono più di dieci": "Il numero di ripetizioni non è il criterio: for gestisce benissimo anche migliaia di giri se il numero è noto.", "Quando si deve lavorare con stringhe invece che numeri": "Il tipo di dato non determina la scelta fra for e while.", "Quando dentro il ciclo serve chiamare una funzione": "Chiamare funzioni dentro un ciclo è normale con entrambi i tipi di ciclo: non è il criterio di scelta." } },
  ...
  { topic: "cicli", difficulty: 4, prompt: "Che cosa succede se in un while la condizione non diventa mai falsa?", answer: "Il programma non finisce più", distractors: ["Python lo interrompe da solo dopo poco","Il ciclo gira una volta sola","Viene segnalato un errore di sintassi"], explanation: "È il ciclo infinito: bisogna assicurarsi che dentro il corpo qualcosa avvicini la condizione al falso.",
    distractorWhy: { "Python lo interrompe da solo dopo poco": "Python non interrompe automaticamente un ciclo che gira all'infinito: continua finché non lo si ferma da fuori.", "Il ciclo gira una volta sola": "while ripete finché la condizione è vera: se resta sempre vera, continua a girare, non si ferma dopo un giro.", "Viene segnalato un errore di sintassi": "Non è un errore di sintassi: il codice è corretto, ma logicamente non termina mai." } },
  { topic: "cicli", difficulty: 3, prompt: "Quale parola interrompe subito un ciclo?", answer: "break", distractors: ["stop","exit","return"], explanation: "break esce dal ciclo immediatamente, senza completare i giri rimanenti.",
    distractorWhy: { "stop": "«stop» non è una parola chiave di Python.", "exit": "exit() termina l'intero programma, non solo il ciclo.", "return": "return esce da una funzione, non specificamente da un ciclo." } },
  { topic: "cicli", difficulty: 4, prompt: "Quale parola salta al giro successivo senza eseguire il resto del corpo?", answer: "continue", distractors: ["skip", "next", "resume"], explanation: "continue abbandona il giro corrente e riparte dal successivo; break invece esce dal ciclo del tutto.",
    distractorWhy: { "skip": "«skip» non è una parola chiave di Python.", "next": "«next» non è la parola chiave per saltare un giro in Python (è next() per gli iteratori, un uso diverso).", "resume": "«resume» non è una parola chiave di Python." } },
  ...
  { topic: "cicli", difficulty: 2, prompt: "for lettera in 'ciao':\n\nSu che cosa sta girando questo ciclo?", answer: "Sui caratteri della stringa", distractors: ["Sui numeri da 0 a 4","Sulle parole della frase","Sulle righe del file"], explanation: "Un for può scorrere qualsiasi sequenza: una stringa viene percorsa un carattere alla volta.",
    distractorWhy: { "Sui numeri da 0 a 4": "Il ciclo scorre direttamente i caratteri della stringa, non degli indici numerici.", "Sulle parole della frase": "'ciao' è una singola parola: il ciclo va carattere per carattere, non parola per parola.", "Sulle righe del file": "Non c'è nessun file coinvolto: si sta iterando su una stringa scritta direttamente nel codice." } },
  ...
  { topic: "liste", difficulty: 4, prompt: "Cosa succede con numeri = [1, 2, 3] e poi print(numeri[3])?", answer: "Errore: l'indice è fuori dalla lista", distractors: ["Stampa 3, cioè l'ultimo elemento", "Stampa None perché la posizione è vuota", "Stampa una lista vuota senza errori"], explanation: "Con tre elementi gli indici validi sono 0, 1 e 2: il 3 non esiste.",
    distractorWhy: { "Stampa 3, cioè l'ultimo elemento": "L'ultimo elemento è all'indice 2, non 3: l'indice 3 non esiste e causa errore.", "Stampa None perché la posizione è vuota": "Python non restituisce None per un indice fuori range: genera un errore (IndexError).", "Stampa una lista vuota senza errori": "Accedere con un indice fuori range non restituisce una lista vuota: causa un errore." } },
  { topic: "liste", difficulty: 3, prompt: "In una lista si possono mettere valori di tipo diverso?", answer: "Sì, per esempio numeri e stringhe insieme", distractors: ["No, devono essere tutti dello stesso tipo","Solo se sono tutti numeri","Solo se la lista è vuota"], explanation: "Python non lo vieta. Spesso però una lista omogenea è più facile da usare senza sbagliare.",
    distractorWhy: { "No, devono essere tutti dello stesso tipo": "Python non impone questo vincolo: una lista può contenere tipi diversi.", "Solo se sono tutti numeri": "Non è vero: una lista può contenere anche stringhe, booleani o altre liste insieme.", "Solo se la lista è vuota": "Una lista vuota non ha elementi da mescolare: il mix di tipi è permesso anche in liste piene." } },
  ...
  { topic: "liste", difficulty: 4, prompt: "Come si scorre una lista senza usare gli indici?", answer: "for elemento in lista:", distractors: ["for i in len(lista):","while lista:","for lista in elemento:"], explanation: "Il for su una lista dà direttamente ogni elemento: più corto e senza il rischio di sbagliare gli indici.",
    distractorWhy: { "for i in len(lista):": "len(lista) restituisce un numero, non una sequenza su cui iterare: darebbe errore.", "while lista:": "Un while sulla lista controlla solo se è vuota o no: non scorre gli elementi uno a uno.", "for lista in elemento:": "Ha nomi invertiti: sta iterando su «elemento», che non è la sequenza da scorrere." } },
  ...
  { topic: "condizioni", difficulty: 3, prompt: "Come si scrive «x è fra 1 e 10»?", answer: "if 1 <= x <= 10:", distractors: ["if 1 <= x or x <= 10:","if x >= 1 and 10:","if x fra 1 e 10:"], explanation: "Python permette il confronto concatenato; l'alternativa corretta sarebbe x >= 1 and x <= 10.",
    distractorWhy: { "if 1 <= x or x <= 10:": "Con «or» basta che una delle due sia vera: sarebbe quasi sempre vero, non verifica davvero l'intervallo.", "if x >= 1 and 10:": "«and 10» non è un confronto valido: manca l'operatore fra x e 10.", "if x fra 1 e 10:": "«fra» non è una parola chiave di Python: darebbe errore di sintassi." } },
  ...
  { topic: "operatori", difficulty: 3, prompt: "Quale operatore unisce due stringhe?", answer: "+", distractors: ["&","*","."], explanation: "Fra stringhe + concatena. Fra numeri lo stesso simbolo somma: il significato dipende dai tipi.",
    distractorWhy: { "&": "& è l'operatore AND bit a bit in Python, non serve a unire stringhe.", "*": "* fra stringa e numero ripete la stringa, ma non unisce due stringhe fra loro.", "." : "Il punto si usa per accedere a metodi e attributi, non per concatenare stringhe." } },
  { topic: "operatori", difficulty: 4, prompt: "Quanto fa 9 / 2 in Python?", answer: "4.5", distractors: ["4","5","4,5"], explanation: "/ restituisce sempre un float. Per la divisione intera si usa //.",
    distractorWhy: { "4": "4 sarebbe il risultato della divisione intera (//), non di / che dà sempre un float.", "5": "9 diviso 2 non arrotonda per eccesso: il risultato preciso è 4.5.", "4,5": "In Python il separatore decimale è il punto, non la virgola: si scrive 4.5, non 4,5." } },
  ...
  { topic: "input", difficulty: 3, prompt: "Come si trasforma in numero intero ciò che restituisce input()?", answer: "int(input('...'))", distractors: ["str(input('...'))","num(input('...'))","input(int('...'))"], explanation: "int() converte la stringa in numero intero. Va messo attorno a input(), non dentro.",
    distractorWhy: { "str(input('...'))": "str() converte in stringa, ma input() restituisce già una stringa: non produce un numero.", "num(input('...'))": "«num» non è una funzione integrata di Python.", "input(int('...'))": "Qui int() agirebbe sul testo del messaggio, non sul risultato: l'ordine è invertito rispetto a quello corretto." } },
  ...
  { topic: "output", difficulty: 2, prompt: "Cosa stampa: print('ciao', 'mondo')?", answer: "ciao mondo", distractors: ["ciaomondo","'ciao' 'mondo'","ciao,mondo"], explanation: "Separando con la virgola, print() mette automaticamente uno spazio fra i due valori.",
    distractorWhy: { "ciaomondo": "print() con la virgola aggiunge automaticamente uno spazio: non li attacca senza spazio.", "'ciao' 'mondo'": "print() rimuove le virgolette quando stampa il testo: mostra il contenuto, non la sintassi.", "ciao,mondo": "print() separa gli argomenti con uno spazio, non con una virgola nel testo stampato." } },
  ...
  { topic: "output", difficulty: 2, prompt: "Cosa stampa: print('2 * 3')?", answer: "2 * 3", distractors: ["6","'2 * 3'","errore"], explanation: "Tra virgolette è testo: Python non calcola niente e stampa i caratteri così come sono.",
    distractorWhy: { "6": "Il calcolo avverrebbe solo senza virgolette: con le virgolette è testo, non un'operazione.", "'2 * 3'": "print() rimuove le virgolette quando stampa il contenuto: non le mostra insieme al testo.", "errore": "Stampare una stringa di testo è un'operazione perfettamente valida: non genera errore." } },
  { topic: "output", difficulty: 3, prompt: "x = 4\nprint('x')\n\nCosa stampa?", answer: "x", distractors: ["4","'x'","errore"], explanation: "'x' fra virgolette è la lettera x, non la variabile. Senza virgolette avrebbe stampato 4.",
    distractorWhy: { "4": "Con le virgolette 'x' è testo letterale, non il nome della variabile: il valore 4 non viene usato.", "'x'": "print() rimuove le virgolette quando stampa: mostra solo il carattere x.", "errore": "Stampare la stringa 'x' è valido: non genera nessun errore." } },
  { topic: "output", difficulty: 3, prompt: "eta = 11\nprint('Ho', eta, 'anni')\n\nCosa stampa?", answer: "Ho 11 anni", distractors: ["Ho eta anni","Ho, 11, anni","Ho11anni"], explanation: "Le virgole separano i pezzi e print() li unisce con uno spazio, sostituendo il valore della variabile.",
    distractorWhy: { "Ho eta anni": "eta senza virgolette è la variabile: print() ne mostra il valore (11), non il nome scritto letteralmente.", "Ho, 11, anni": "print() separa gli argomenti con uno spazio, non inserisce virgole nel testo stampato.", "Ho11anni": "print() con la virgola inserisce automaticamente uno spazio fra i pezzi: non li attacca senza spazio." } },
  { topic: "output", difficulty: 3, prompt: "Cosa stampa: print(10 / 2)?", answer: "5.0", distractors: ["5","'5'","10/2"], explanation: "In Python la divisione / dà sempre un numero con la virgola, anche quando il risultato è esatto.",
    distractorWhy: { "5": "/ restituisce sempre un float, anche quando il risultato è un numero esatto: quindi 5.0, non 5 intero.", "'5'": "Il risultato è un numero, non una stringa di testo fra virgolette.", "10/2": "print() calcola l'espressione prima di stamparla: non mostra i simboli originali." } },
  ...
  { topic: "output", difficulty: 2, prompt: "Quale simbolo racchiude il testo da stampare?", answer: "Le virgolette", distractors: ["Le parentesi quadre","Le graffe","I due punti"], explanation: "Le virgolette (singole o doppie) dicono a Python che quello è testo e non un nome di variabile.",
    distractorWhy: { "Le parentesi quadre": "Le parentesi quadre delimitano le liste, non il testo.", "Le graffe": "Le graffe delimitano dizionari e insiemi, non il testo.", "I due punti": "I due punti introducono blocchi di codice (come dopo if o def), non il testo da stampare." } },
  { topic: "output", difficulty: 3, prompt: "print('somma:', 3 + 4)\n\nCosa stampa?", answer: "somma: 7", distractors: ["somma: 3 + 4","somma:7","somma: 34"], explanation: "Il testo resta testo, ma 3 + 4 è fuori dalle virgolette: Python lo calcola prima di stampare.",
    distractorWhy: { "somma: 3 + 4": "3 + 4 è fuori dalle virgolette: Python lo calcola come somma, non lo mostra come simboli.", "somma:7": "print() con la virgola aggiunge automaticamente uno spazio fra gli argomenti.", "somma: 34": "3 + 4 è un'addizione perché sono numeri, non testo: il risultato è 7, non la concatenazione '34'." } },
  ...
  { topic: "output", difficulty: 3, prompt: "Perché print(x) e print('x') danno risultati diversi?", answer: "Il primo stampa il valore, il secondo la lettera", distractors: ["Sono identici: cambia soltanto lo stile di scrittura", "Il secondo modo dà sempre un errore di sintassi", "Il primo modo funziona soltanto con i numeri"], explanation: "Le virgolette trasformano tutto in testo: senza, Python cerca una variabile con quel nome.",
    distractorWhy: { "Sono identici: cambia soltanto lo stile di scrittura": "Non sono identici: senza virgolette Python cerca una variabile, con le virgolette stampa la lettera letterale.", "Il secondo modo dà sempre un errore di sintassi": "print('x') è sintassi perfettamente valida: stampa semplicemente il carattere x.", "Il primo modo funziona soltanto con i numeri": "print(x) funziona con qualsiasi tipo di variabile, non solo con i numeri." } },
  ...
  { topic: "stringhe", difficulty: 2, prompt: "Quale funzione dice quanto è lunga una stringa?", answer: "len()", distractors: ["size()","count()","length()"], explanation: "len() restituisce il numero di caratteri. Funziona anche con le liste.",
    distractorWhy: { "size()": "size() non è una funzione integrata di Python per le stringhe.", "count()": "count() conta quante volte appare un elemento specifico, non la lunghezza totale.", "length()": "In Python non esiste length() come funzione integrata: si usa len()." } },
  { topic: "stringhe", difficulty: 3, prompt: "s = 'python'\nprint(s[0])\n\nCosa stampa?", answer: "p", distractors: ["y","python","errore"], explanation: "Gli indici partono da zero: s[0] è il primo carattere, non il secondo.",
    distractorWhy: { "y": "s[0] è il primo carattere, che è 'p': 'y' sarebbe s[5], l'ultimo.", "python": "s[0] restituisce un solo carattere, non l'intera stringa.", "errore": "s[0] è un indice valido per una stringa non vuota: non genera errore." } },
  { topic: "stringhe", difficulty: 3, prompt: "s = 'ciao'\nCon quale indice si prende l'ultima lettera?", answer: "s[-1]", distractors: ["s[4]","s[fine]","s[ultimo]"], explanation: "Gli indici negativi contano dalla fine: -1 è l'ultimo. s[4] darebbe errore, perché gli indici vanno da 0 a 3.",
    distractorWhy: { "s[4]": "'ciao' ha 4 caratteri con indici da 0 a 3: l'indice 4 è fuori range e dà errore.", "s[fine]": "«fine» non è una parola chiave riconosciuta: darebbe errore.", "s[ultimo]": "«ultimo» non è una parola chiave riconosciuta: darebbe errore." } },
  { topic: "stringhe", difficulty: 3, prompt: "Cosa stampa: print('ab' * 3)?", answer: "ababab", distractors: ["ab3","abababab","errore"], explanation: "Con una stringa e un numero, * ripete: 'ab' tre volte di fila.",
    distractorWhy: { "ab3": "* non concatena il numero come testo: ripete la stringa 'ab' tre volte.", "abababab": "'ab' viene ripetuta esattamente 3 volte (6 lettere), non 4 volte.", "errore": "Moltiplicare una stringa per un intero è un'operazione valida in Python: non dà errore." } },
  { topic: "stringhe", difficulty: 2, prompt: "Cosa fa .upper() su una stringa?", answer: "La rende tutta maiuscola", distractors: ["La rende tutta minuscola","Ne conta i caratteri","La mette al contrario"], explanation: "'ciao'.upper() dà 'CIAO'. La stringa originale non cambia: .upper() ne restituisce una nuova.",
    distractorWhy: { "La rende tutta minuscola": "Quello è .lower(), l'operazione opposta a .upper().", "Ne conta i caratteri": "Contare i caratteri è compito di len(), non di .upper().", "La mette al contrario": "Invertire una stringa è un'altra operazione (slicing), non ciò che fa .upper()." } },
  { topic: "stringhe", difficulty: 4, prompt: "s = 'ciao'\ns.upper()\nprint(s)\n\nCosa stampa?", answer: "ciao", distractors: ["CIAO","Ciao","errore"], explanation: "Le stringhe non si modificano: .upper() restituisce una nuova stringa, e senza assegnarla il risultato si perde.",
    distractorWhy: { "CIAO": "s.upper() restituisce una nuova stringa maiuscola, ma senza assegnarla a s, la variabile s resta invariata.", "Ciao": "Non c'è nessuna operazione che renda solo la prima lettera maiuscola in questo codice.", "errore": "Chiamare .upper() senza usarne il risultato è valido: non genera errore, solo non modifica s." } },
  { topic: "stringhe", difficulty: 3, prompt: "Come si unisce nome = 'Eli' con ' Quest'?", answer: "nome + ' Quest'", distractors: ["nome & ' Quest'","nome . ' Quest'","nome, ' Quest'"], explanation: "Con le stringhe l'operatore + concatena, cioè attacca la seconda in coda alla prima.",
    distractorWhy: { "nome & ' Quest'": "& è l'operatore AND bit a bit in Python, non serve a unire stringhe.", "nome . ' Quest'": "Il punto si usa per accedere a metodi e attributi, non per concatenare stringhe.", "nome, ' Quest'": "La virgola crea una coppia di valori separati (una tupla), non una stringa unita." } },
  ...
  { topic: "stringhe", difficulty: 3, prompt: "Perché print('5' + '5') dà 55 e non 10?", answer: "Perché sono stringhe e + le unisce", distractors: ["Perché Python sbaglia le somme","Perché mancano le parentesi","Perché 5 non è un numero valido"], explanation: "Le virgolette rendono i due 5 testo: con il testo + significa «attacca», non «somma».",
    distractorWhy: { "Perché Python sbaglia le somme": "Python non sbaglia: sta correttamente concatenando due stringhe, non sommando numeri.", "Perché mancano le parentesi": "Le parentesi non c'entrano: il comportamento dipende dal tipo delle due '5', che sono stringhe.", "Perché 5 non è un numero valido": "5 è un numero valido, ma qui è scritto fra virgolette come '5', quindi è testo, non un numero." } },
  ...
  { topic: "algoritmi", difficulty: 3, prompt: "Per trovare il numero più grande in una lista, quale idea funziona?", answer: "Tenere da parte il maggiore visto finora", distractors: ["Prendere sempre l'ultimo della lista", "Sommare tutti i numeri della lista", "Contare quanti numeri ci sono in tutto"], explanation: "Si scorre la lista una volta sola confrontando ogni numero con il record: alla fine il record è il massimo.",
    distractorWhy: { "Prendere sempre l'ultimo della lista": "L'ultimo elemento non è necessariamente il più grande: serve confrontare tutti i valori.", "Sommare tutti i numeri della lista": "La somma dà il totale, non il valore massimo tra gli elementi.", "Contare quanti numeri ci sono in tutto": "Il conteggio degli elementi non dice nulla su quale sia il più grande." } },
  { topic: "algoritmi", difficulty: 3, prompt: "Cercare una parola in un dizionario di carta aprendo a metà è un esempio di…", answer: "Ricerca binaria", distractors: ["Ricerca a caso","Ordinamento","Conteggio"], explanation: "Ogni apertura scarta metà del dizionario: bastano pochi passi anche con migliaia di pagine.",
    distractorWhy: { "Ricerca a caso": "Non è casuale: si sfrutta sistematicamente l'ordine alfabetico per dimezzare lo spazio di ricerca ogni volta.", "Ordinamento": "Ordinare è un'altra operazione: qui il dizionario è già ordinato, e si sta solo cercando una parola.", "Conteggio": "Non si sta contando nulla: si sta cercando una posizione specifica." } },
  ...
  { topic: "output", difficulty: 1, prompt: "In Python, quale istruzione mostra un messaggio a schermo?", answer: "print()", distractors: ["show()", "echo()", "display()"], explanation: "print() stampa a schermo ciò che gli passi.",
    distractorWhy: { "show()": "show() non è una funzione integrata di Python per stampare testo.", "echo()": "echo è il comando per stampare in altri contesti (come la shell o PHP), non in Python.", "display()": "display() non è la funzione standard di Python per stampare a schermo." } },
  { topic: "output", difficulty: 2, prompt: "Cosa stampa: print(3 + 4)?", answer: "7", distractors: ["34", "3 + 4", "'7'"], explanation: "Con i numeri, + è la somma: 3 + 4 = 7.",
    distractorWhy: { "34": "Sono numeri, non stringhe: + li somma invece di concatenarli.", "3 + 4": "print() calcola l'espressione prima di stamparla: non mostra i simboli originali.", "'7'": "Il risultato è il numero 7, non la stringa di testo '7' fra virgolette." } },
  { topic: "output", difficulty: 3, prompt: "Cosa stampa: print('3' + '4')?", answer: "34", distractors: ["7", "'34'", "errore"], explanation: "Con le stringhe, + le unisce (concatenazione): '3'+'4' = '34'.",
    distractorWhy: { "7": "Sono stringhe fra virgolette, non numeri: + le concatena invece di sommarle.", "'34'": "print() rimuove le virgolette quando stampa: mostra 34, non '34' con le virgolette.", "errore": "Concatenare due stringhe con + è un'operazione valida: non genera errore." } },
  // Variabili
  { topic: "variabili", difficulty: 1, prompt: "In x = 5, che cos'è x?", answer: "Una variabile che vale 5", distractors: ["Una funzione senza nome", "Un errore di scrittura", "Un testo fisso tra virgolette"], explanation: "Una variabile è un contenitore con un nome e un valore.",
    distractorWhy: { "Una funzione senza nome": "x = 5 non definisce nessuna funzione: assegna un valore a una variabile.", "Un errore di scrittura": "x = 5 è sintassi perfettamente valida in Python.", "Un testo fisso tra virgolette": "5 non ha virgolette: è un numero, non del testo." } },
  { topic: "variabili", difficulty: 2, prompt: "Dopo x = 5 e poi x = x + 1, quanto vale x?", answer: "6", distractors: ["5", "51", "errore"], explanation: "x + 1 = 5 + 1 = 6, e viene rimesso in x.",
    distractorWhy: { "5": "La seconda riga ricalcola x aggiungendo 1: il valore cambia da 5 a 6.", "51": "+ fra numeri somma, non concatena come farebbe con le stringhe: il risultato è 6, non 51.", "errore": "x = x + 1 è un'operazione valida: rilegge il valore attuale di x e ne scrive uno nuovo." } },
  // Tipi di dato
  { topic: "tipi", difficulty: 2, prompt: "Di che tipo è il valore 'ciao'?", answer: "Stringa (testo)", distractors: ["Numero intero", "Booleano", "Lista"], explanation: "Il testo tra virgolette è una stringa.",
    distractorWhy: { "Numero intero": "'ciao' ha le virgolette: è testo, non un numero.", "Booleano": "'ciao' non è né True né False: è una stringa di testo.", "Lista": "'ciao' non ha parentesi quadre: è una stringa, non una lista." } },
  { topic: "tipi", difficulty: 2, prompt: "Di che tipo è il valore 7?", answer: "Numero intero (int)", distractors: ["Stringa di testo", "Booleano (vero/falso)", "Lista di valori"], explanation: "7 senza virgolette è un numero intero.",
    distractorWhy: { "Stringa di testo": "7 non ha le virgolette: è un numero, non testo.", "Booleano (vero/falso)": "7 non è né True né False: è un valore numerico.", "Lista di valori": "7 non ha parentesi quadre: è un singolo numero, non una lista." } },
  // Operatori
  { topic: "operatori", difficulty: 2, prompt: "Cosa calcola 10 % 3 in Python (operatore modulo)?", answer: "1 (il resto)", distractors: ["3 (il quoziente)", "30 (il prodotto)", "3.33 (la divisione)"], explanation: "% dà il resto della divisione: 10 = 3×3 + 1.",
    distractorWhy: { "3 (il quoziente)": "Il quoziente si ottiene con //, non con %: % dà il resto, che è 1.", "30 (il prodotto)": "% non moltiplica i numeri: dà il resto della divisione.", "3.33 (la divisione)": "% non è la divisione normale (/): dà il resto intero della divisione." } },
  { topic: "operatori", difficulty: 3, prompt: "Cosa calcola 2 ** 3 in Python?", answer: "8", distractors: ["6", "9", "5"], explanation: "** è l'elevamento a potenza: 2 alla 3 = 8.",
    distractorWhy: { "6": "6 sarebbe 2×3, ma ** non moltiplica: eleva a potenza, quindi 2×2×2=8.", "9": "9 sarebbe 3², ma qui la base è 2 e l'esponente è 3: 2³=8.", "5": "5 sarebbe 2+3, ma ** non somma: eleva a potenza." } },
  // Condizioni
  { topic: "condizioni", difficulty: 2, prompt: "Quale parola introduce una condizione in Python?", answer: "if", distractors: ["for", "while", "def"], explanation: "if verifica una condizione ed esegue il blocco se è vera.",
    distractorWhy: { "for": "for introduce un ciclo su una sequenza, non una condizione.", "while": "while introduce un ciclo basato su una condizione che si ripete, non una condizione singola come if.", "def": "def introduce la definizione di una funzione, non una condizione." } },
  { topic: "condizioni", difficulty: 3, prompt: "Con x = 4, cosa stampa: if x > 3: print('grande')?", answer: "grande", distractors: ["4", "niente", "errore"], explanation: "4 > 3 è vero, quindi esegue print('grande').",
    distractorWhy: { "4": "print('grande') stampa il testo 'grande', non il valore di x.", "niente": "4 > 3 è vero, quindi il blocco dentro l'if viene eseguito, non saltato.", "errore": "Il codice è sintatticamente corretto: non genera errore." } },
  { topic: "condizioni", difficulty: 3, prompt: "Quale operatore verifica se due valori sono uguali?", answer: "==", distractors: ["=", "=>", "><"], explanation: "= assegna un valore; == confronta due valori.",
    distractorWhy: { "=": "Un solo uguale assegna un valore a una variabile, non confronta.", "=>": "«=>» non è un operatore valido in Python.", "><": "«><» non è un operatore valido in Python." } },
  // Cicli
  { topic: "cicli", difficulty: 2, prompt: "Quale istruzione ripete del codice più volte?", answer: "for (oppure while)", distractors: ["if (oppure else)", "def (oppure return)", "print (oppure input)"], explanation: "I cicli for e while ripetono un blocco di istruzioni.",
    distractorWhy: { "if (oppure else)": "if/else eseguono un blocco al massimo una volta, in base a una condizione: non ripetono.", "def (oppure return)": "def definisce una funzione, return restituisce un valore: nessuno dei due ripete codice da solo.", "print (oppure input)": "print e input eseguono un'unica azione ciascuno: non ripetono codice." } },
  { topic: "cicli", difficulty: 3, prompt: "Quante volte stampa: for i in range(3): print(i)?", answer: "3 volte (0, 1, 2)", distractors: ["1 volta", "3 volte (1, 2, 3)", "4 volte"], explanation: "range(3) genera 0, 1, 2: tre ripetizioni.",
    distractorWhy: { "1 volta": "Il ciclo for ripete il blocco per ogni valore generato da range(3), non una sola volta.", "3 volte (1, 2, 3)": "range(3) parte da 0, non da 1: genera 0, 1, 2, non 1, 2, 3.", "4 volte": "range(3) genera esattamente tre valori (0, 1, 2), non quattro." } },
  // Liste
...
const SCIENZE_CORE = [
  { topic: "ambiente", difficulty: 2, prompt: "Che cos'è la biodiversità?", answer: "La varietà di specie viventi in un ambiente", distractors: ["Il numero totale di animali presenti","La quantità di piante di una specie","La superficie occupata da un bosco"], explanation: "Non conta quanti individui ci sono, ma quante specie diverse: un ambiente vario resiste meglio ai cambiamenti.",
    distractorWhy: { "Il numero totale di animali presenti": "Contare gli individui non basta: la biodiversità misura la varietà di specie, non la quantità totale.", "La quantità di piante di una specie": "Una sola specie molto numerosa non è biodiversità: serve varietà, non abbondanza di un solo tipo.", "La superficie occupata da un bosco" : "L'estensione del territorio non misura la varietà di specie che lo abitano." } },
  { topic: "ambiente", difficulty: 2, prompt: "Perché gli alberi sono importanti per l'aria che respiriamo?", answer: "Perché assorbono anidride carbonica e liberano ossigeno", distractors: ["Perché filtrano la pioggia prima che tocchi il suolo","Perché abbassano di molto la temperatura dell'aria","Perché fermano il vento quando soffia troppo forte"], explanation: "Con la fotosintesi prendono CO₂ e restituiscono ossigeno: sono il polmone di ogni ecosistema terrestre.",
    distractorWhy: { "Perché filtrano la pioggia prima che tocchi il suolo": "Questo effetto esiste, ma non è il motivo per cui gli alberi sono importanti per l'aria che respiriamo.", "Perché abbassano di molto la temperatura dell'aria": "L'ombra rinfresca localmente, ma non è questo il ruolo chiave per l'aria che respiriamo.", "Perché fermano il vento quando soffia troppo forte": "Il ruolo da frangivento non ha a che fare con la qualità dell'aria che respiriamo." } },
  { topic: "ambiente", difficulty: 3, prompt: "Che cosa succede a un ecosistema se sparisce una specie chiave?", answer: "Può cambiare l'equilibrio di molte altre specie", distractors: ["Non cambia nulla per le altre specie","Le altre specie diventano più numerose","L'ambiente si ricostruisce in pochi giorni"], explanation: "Le specie sono collegate: togliere un predatore fa esplodere le sue prede, che a loro volta consumano più piante.",
    distractorWhy: { "Non cambia nulla per le altre specie": "Le specie sono collegate fra loro: la scomparsa di una ne influenza molte altre.", "Le altre specie diventano più numerose": "Non tutte diventano più numerose: alcune, come le prede senza predatori naturali che le limitano, ma altre soffrono.", "L'ambiente si ricostruisce in pochi giorni": "Il riequilibrio di un ecosistema richiede tempi molto più lunghi di pochi giorni." } },
  { topic: "ambiente", difficulty: 3, prompt: "Perché la plastica dispersa è un problema per il mare?", answer: "Perché impiega secoli a degradarsi", distractors: ["Perché rende l'acqua più salata","Perché fa aumentare la temperatura","Perché toglie ossigeno ai pesci"], explanation: "Si spezza in pezzi sempre più piccoli senza sparire: le microplastiche entrano nella catena alimentare.",
    distractorWhy: { "Perché rende l'acqua più salata": "La plastica non altera la salinità dell'acqua: il problema è che non si degrada per secoli.", "Perché fa aumentare la temperatura": "La plastica non riscalda l'acqua del mare: il problema è la sua persistenza nell'ambiente.", "Perché toglie ossigeno ai pesci": "La plastica non sottrae ossigeno direttamente: il danno viene dalla sua permanenza e frammentazione." } },
  { topic: "ambiente", difficulty: 3, prompt: "Che cos'è una fonte di energia rinnovabile?", answer: "Una fonte che si rigenera in tempi brevi", distractors: ["Una fonte che non costa niente","Una fonte che non produce energia","Una fonte che si trova sottoterra"], explanation: "Sole, vento e acqua si rinnovano di continuo; carbone e petrolio hanno impiegato milioni di anni a formarsi.",
    distractorWhy: { "Una fonte che non costa niente": "Le fonti rinnovabili hanno comunque un costo: la caratteristica chiave è che si rigenerano rapidamente.", "Una fonte che non produce energia": "Una fonte rinnovabile produce energia eccome: la differenza è che si rigenera in tempi brevi.", "Una fonte che si trova sottoterra": "Le fonti sottoterra come carbone e petrolio sono di solito fossili, cioè non rinnovabili." } },
  { topic: "ambiente", difficulty: 2, prompt: "Quale di queste è una fonte di energia rinnovabile?", answer: "Il vento", distractors: ["Il carbone","Il petrolio","Il gas naturale"], explanation: "Il vento soffia di continuo e non si esaurisce; le altre tre sono riserve fossili che finiscono.",
    distractorWhy: { "Il carbone": "Il carbone è un combustibile fossile: ha impiegato milioni di anni a formarsi e si esaurisce.", "Il petrolio": "Il petrolio è un combustibile fossile: ha impiegato milioni di anni a formarsi e si esaurisce.", "Il gas naturale": "Il gas naturale è un combustibile fossile: ha impiegato milioni di anni a formarsi e si esaurisce." } },
  { topic: "ambiente", difficulty: 4, prompt: "Perché fare la raccolta differenziata riduce l'uso di materie prime?", answer: "Perché il materiale riciclato sostituisce quello nuovo", distractors: ["Perché i rifiuti pesano complessivamente meno","Perché le discariche diventano più ordinate","Perché si producono meno rifiuti in totale"], explanation: "Una lattina riciclata risparmia l'alluminio che si sarebbe dovuto estrarre, e insieme l'energia per estrarlo.",
    distractorWhy: { "Perché i rifiuti pesano complessivamente meno": "Il peso dei rifiuti non cambia con la differenziazione: cambia il fatto che vengono riutilizzati invece di scartati.", "Perché le discariche diventano più ordinate": "L'ordine delle discariche non è il punto: il risparmio sta nell'evitare di estrarre materiali nuovi.", "Perché si producono meno rifiuti in totale": "Differenziare non riduce la quantità di rifiuti prodotti: permette di riutilizzarli invece di estrarne di nuovi." } },
  { topic: "ambiente", difficulty: 3, prompt: "Che cos'è l'effetto serra?", answer: "Alcuni gas trattengono il calore vicino alla Terra", distractors: ["Il Sole scalda di più in certe stagioni","Le serre agricole riscaldano l'atmosfera","L'aria si riscalda salendo verso l'alto"], explanation: "Senza effetto serra la Terra sarebbe gelida: il problema nasce quando quei gas aumentano troppo e il calore trattenuto cresce.",
    distractorWhy: { "Il Sole scalda di più in certe stagioni": "Le stagioni dipendono dall'inclinazione dell'asse terrestre, un fenomeno diverso dall'effetto serra.", "Le serre agricole riscaldano l'atmosfera": "Le serre agricole sono una cosa diversa: l'effetto serra riguarda gas atmosferici, non serre reali.", "L'aria si riscalda salendo verso l'alto": "In realtà l'aria si raffredda salendo di quota: non è questo il meccanismo dell'effetto serra." } },
  { topic: "ambiente", difficulty: 4, prompt: "Perché il consumo di suolo preoccupa gli scienziati?", answer: "Perché il terreno fertile impiega secoli a formarsi", distractors: ["Perché il terreno cementificato costa di più","Perché le città diventano troppo affollate","Perché il suolo si sposta con il vento"], explanation: "Servono centinaia di anni per formare pochi centimetri di suolo fertile, e coprirlo di cemento lo rende irrecuperabile.",
    distractorWhy: { "Perché il terreno cementificato costa di più": "Il costo economico non è la preoccupazione scientifica principale: conta la perdita irreversibile di fertilità.", "Perché le città diventano troppo affollate": "L'affollamento urbano è un problema diverso, non legato direttamente alla perdita di suolo fertile.", "Perché il suolo si sposta con il vento" : "L'erosione eolica è un fenomeno diverso dal consumo di suolo per cementificazione." } },
  { topic: "ambiente", difficulty: 2, prompt: "Che cosa significa «specie a rischio di estinzione»?", answer: "Una specie che rischia di sparire per sempre", distractors: ["Una specie che vive in pochi luoghi","Una specie che si sposta ogni anno","Una specie che si riproduce lentamente"], explanation: "Estinzione significa che non ne resta più nessun individuo: è una perdita che non si può annullare.",
    distractorWhy: { "Una specie che vive in pochi luoghi": "Vivere in pochi luoghi può essere un fattore di rischio, ma non è la definizione di specie a rischio.", "Una specie che si sposta ogni anno": "La migrazione stagionale non ha a che fare con il rischio di estinzione.", "Una specie che si riproduce lentamente": "La riproduzione lenta può essere un fattore di rischio, ma non definisce da sola una specie a rischio." } },
  { topic: "ambiente", difficulty: 3, prompt: "Perché l'acqua dolce è una risorsa preziosa?", answer: "Perché è una piccolissima parte dell'acqua terrestre", distractors: ["Perché è più pesante e densa dell'acqua salata","Perché si trova soltanto dentro i ghiacciai polari","Perché evapora molto più lentamente di quella salata"], explanation: "Quasi tutta l'acqua del pianeta è salata; di quella dolce, gran parte è ghiacciata: ne resta pochissima disponibile.",
    distractorWhy: { "Perché è più pesante e densa dell'acqua salata": "È il contrario: l'acqua dolce è meno densa di quella salata, e comunque non è questo il motivo della sua preziosità.", "Perché si trova soltanto dentro i ghiacciai polari": "Non si trova solo nei ghiacciai: c'è anche in fiumi, laghi e falde, ma la quantità totale resta piccola.", "Perché evapora molto più lentamente di quella salata": "La velocità di evaporazione non è la ragione: è la scarsità della quantità totale disponibile." } },
  { topic: "ambiente", difficulty: 4, prompt: "Che cos'è una specie invasiva?", answer: "Una specie portata altrove che danneggia l'ambiente", distractors: ["Una specie che si riproduce molto in fretta","Una specie che caccia di notte in gruppo","Una specie che vive in ambienti diversi"], explanation: "Fuori dal suo ambiente d'origine può non avere predatori: si moltiplica senza freni e soffoca le specie locali.",
    distractorWhy: { "Una specie che si riproduce molto in fretta": "La riproduzione rapida da sola non basta: serve che sia stata portata fuori dal suo ambiente originario e danneggi quello nuovo.", "Una specie che caccia di notte in gruppo": "Il comportamento di caccia non definisce una specie invasiva: conta l'essere fuori dal proprio ambiente d'origine.", "Una specie che vive in ambienti diversi": "Vivere in più ambienti non basta a renderla invasiva: serve che danneggi l'ecosistema in cui è stata introdotta." } },
  { topic: "metodo", difficulty: 2, prompt: "Che cos'è un'ipotesi scientifica?", answer: "Una risposta possibile ancora da verificare", distractors: ["Una conclusione già dimostrata","Un'opinione personale del ricercatore","Una domanda a cui non si può rispondere"], explanation: "L'ipotesi si formula prima dell'esperimento, e l'esperimento serve proprio a metterla alla prova.",
    distractorWhy: { "Una conclusione già dimostrata": "Una conclusione dimostrata viene dopo l'esperimento: l'ipotesi viene prima, ancora da verificare.", "Un'opinione personale del ricercatore": "Un'ipotesi scientifica deve poter essere verificata con dati, non essere una semplice opinione.", "Una domanda a cui non si può rispondere": "Un'ipotesi deve essere verificabile: se non si può rispondere, non è un'ipotesi scientifica utile." } },
  { topic: "metodo", difficulty: 3, prompt: "Perché in un esperimento si cambia una sola variabile per volta?", answer: "Per sapere quale ha causato il risultato", distractors: ["Per fare l'esperimento più in fretta","Per risparmiare materiale da laboratorio","Perché due variabili non si possono misurare"], explanation: "Se cambi tre cose insieme e qualcosa succede, non sai a quale delle tre attribuirlo.",
    distractorWhy: { "Per fare l'esperimento più in fretta": "Cambiare una sola variabile spesso richiede più prove, non meno tempo: il motivo è isolare la causa.", "Per risparmiare materiale da laboratorio": "Il risparmio di materiale non è il motivo scientifico: è isolare quale fattore causa l'effetto.", "Perché due variabili non si possono misurare": "Si possono misurare anche più variabili insieme: il problema è che non sapresti quale ha causato l'effetto." } },
  { topic: "metodo", difficulty: 3, prompt: "A che cosa serve il gruppo di controllo?", answer: "A confrontare con ciò che accade senza intervento", distractors: ["A ripetere lo stesso esperimento due volte","A misurare gli strumenti prima dell'uso","A verificare i calcoli fatti alla fine"], explanation: "Senza un termine di paragone non sai se il cambiamento sarebbe avvenuto comunque.",
    distractorWhy: { "A ripetere lo stesso esperimento due volte": "Il gruppo di controllo non è una ripetizione identica: è un confronto senza l'intervento studiato.", "A misurare gli strumenti prima dell'uso": "Calibrare gli strumenti è un'altra pratica: il gruppo di controllo serve al confronto dei risultati.", "A verificare i calcoli fatti alla fine": "Il gruppo di controllo non riguarda i calcoli: fornisce un termine di paragone durante l'esperimento." } },
  { topic: "metodo", difficulty: 3, prompt: "Perché un esperimento va ripetuto più volte?", answer: "Perché un risultato singolo può essere un caso", distractors: ["Perché la prima volta si sbaglia sempre","Perché così si consuma meno materiale","Perché lo richiedono i regolamenti"], explanation: "La ripetizione distingue un effetto reale da una coincidenza: se succede una volta sola, non prova niente.",
    distractorWhy: { "Perché la prima volta si sbaglia sempre": "Non è detto che la prima prova sia sbagliata: il punto è escludere che sia stata una coincidenza.", "Perché così si consuma meno materiale": "Ripetere l'esperimento consuma più materiale, non meno: il motivo è la validità statistica del risultato.", "Perché lo richiedono i regolamenti": "Non è una questione burocratica: è un principio del metodo scientifico stesso." } },
  { topic: "metodo", difficulty: 4, prompt: "Un'ipotesi che non si può smentire in nessun modo è…", answer: "Inutile dal punto di vista scientifico", distractors: ["La più solida di tutte le ipotesi","Vera fino a prova contraria","Difficile ma comunque verificabile"], explanation: "Se nessun risultato possibile potrebbe contraddirla, l'esperimento non aggiunge nulla: non è un'ipotesi scientifica.",
    distractorWhy: { "La più solida di tutte le ipotesi": "Al contrario: se non si può mai smentire, non è verificabile e quindi non è scientificamente utile.", "Vera fino a prova contraria": "Un'ipotesi non falsificabile non può nemmeno avere una «prova contraria»: per questo è inutile.", "Difficile ma comunque verificabile": "Se non si può smentire in nessun modo, non è verificabile: è proprio questo il problema." } },
  { topic: "metodo", difficulty: 3, prompt: "Che differenza c'è fra osservare e interpretare?", answer: "L'osservazione registra, l'interpretazione spiega", distractors: ["L'osservazione è più lenta da eseguire","L'interpretazione si fa con gli strumenti","Non c'è differenza fra le due cose"], explanation: "«La pianta è gialla» è un'osservazione; «le manca acqua» è un'interpretazione, e va verificata.",
    distractorWhy: { "L'osservazione è più lenta da eseguire": "La velocità non è ciò che distingue le due cose: conta il fatto che una registra e l'altra spiega.", "L'interpretazione si fa con gli strumenti": "Gli strumenti servono per l'osservazione: l'interpretazione è un ragionamento successivo, non richiede strumenti.", "Non c'è differenza fra le due cose": "Sono passaggi diversi: registrare un fatto e spiegarne la causa sono operazioni distinte." } },
  { topic: "metodo", difficulty: 4, prompt: "Perché gli scienziati pubblicano i loro dati?", answer: "Perché altri possano ripetere e controllare", distractors: ["Perché così diventano più famosi","Perché lo impongono le università","Perché i dati occupano troppo spazio"], explanation: "Un risultato che nessuno può verificare non entra nella conoscenza condivisa: la controllabilità è il cuore del metodo.",
    distractorWhy: { "Perché così diventano più famosi": "La fama personale non è il motivo scientifico: è permettere ad altri di verificare il lavoro.", "Perché lo impongono le università": "Non è solo una regola istituzionale: è un principio fondamentale del metodo scientifico.", "Perché i dati occupano troppo spazio": "Lo spazio occupato non c'entra: la pubblicazione serve alla verificabilità, non a liberare spazio." } },
  { topic: "metodo", difficulty: 2, prompt: "Che cos'è una variabile in un esperimento?", answer: "Un fattore che può cambiare e influenzare il risultato", distractors: ["Un errore commesso durante una misurazione","Uno strumento che si usa dentro il laboratorio","Un risultato che cambia a ogni ripetizione"], explanation: "Luce, acqua, temperatura: sono variabili. Sapere quali controllare è metà del lavoro.",
    distractorWhy: { "Un errore commesso durante una misurazione": "Una variabile non è un errore: è un fattore che si può controllare o modificare intenzionalmente.", "Uno strumento che si usa dentro il laboratorio": "Una variabile non è uno strumento: è un fattore che può influenzare l'esperimento.", "Un risultato che cambia a ogni ripetizione": "Il risultato è ciò che si osserva alla fine: la variabile è il fattore che si modifica in ingresso." } },
  { topic: "metodo", difficulty: 3, prompt: "Un esperimento smentisce l'ipotesi. Che cosa hai imparato?", answer: "Che quell'ipotesi non funziona, ed è un risultato", distractors: ["Niente: l'esperimento è tutto da rifare","Che gli strumenti usati erano sbagliati","Che la domanda di partenza era mal posta"], explanation: "Escludere una spiegazione restringe il campo: è progresso, anche se non è la risposta che si sperava.",
    distractorWhy: { "Niente: l'esperimento è tutto da rifare": "Smentire un'ipotesi è comunque un risultato utile: non significa che l'esperimento sia stato inutile.", "Che gli strumenti usati erano sbagliati": "Non c'è motivo di presumere che gli strumenti siano difettosi solo perché l'ipotesi è stata smentita.", "Che la domanda di partenza era mal posta": "Una domanda può essere ben posta anche se la risposta attesa risulta sbagliata: è comunque progresso." } },
  { topic: "metodo", difficulty: 4, prompt: "Perché la misura di un solo studente vale meno di dieci misure?", answer: "Perché più misure riducono l'effetto degli errori", distractors: ["Perché uno studente misura più lentamente","Perché servono dieci strumenti diversi","Perché una misura sola non è mai leggibile"], explanation: "Ogni misura porta un piccolo errore casuale: mediando molte misure gli errori tendono a compensarsi.",
    distractorWhy: { "Perché uno studente misura più lentamente": "La velocità di misurazione non è il punto: conta la riduzione statistica degli errori con più misure.", "Perché servono dieci strumenti diversi": "Non servono strumenti diversi: si può usare lo stesso strumento più volte per ridurre l'errore casuale.", "Perché una misura sola non è mai leggibile": "Una misura singola è leggibile: il problema è che porta con sé un errore che tante misure aiutano a compensare." } },
  { topic: "ecosistema", difficulty: 2, prompt: "Che cos'è un ecosistema?", answer: "L'insieme dei viventi e dell'ambiente in cui stanno", distractors: ["Il gruppo di animali di una stessa specie","La zona protetta di un parco naturale","L'insieme delle piante di una regione"], explanation: "Comprende sia gli esseri viventi sia l'acqua, il suolo, il clima: tutto ciò che interagisce in quel luogo.",
    distractorWhy: { "Il gruppo di animali di una stessa specie": "Una singola specie non basta: l'ecosistema comprende tutti i viventi e l'ambiente insieme.", "La zona protetta di un parco naturale": "Un ecosistema non richiede protezione legale: è un concetto biologico, presente ovunque ci sia vita.", "L'insieme delle piante di una regione": "Le sole piante non bastano: l'ecosistema comprende tutti i viventi e l'ambiente fisico." } },
  { topic: "ecosistema", difficulty: 2, prompt: "In una catena alimentare, chi sono i produttori?", answer: "Le piante, che si fabbricano il nutrimento", distractors: ["Gli animali che cacciano le prede","I funghi che decompongono i resti","Gli animali che mangiano le piante"], explanation: "I produttori usano la luce del Sole per costruire sostanze nutritive: tutta l'energia della catena comincia da loro.",
    distractorWhy: { "Gli animali che cacciano le prede": "Quelli sono i predatori/consumatori, che dipendono dal cibo prodotto da altri, non i produttori.", "I funghi che decompongono i resti": "Quelli sono i decompositori, che chiudono il ciclo, non i produttori che lo aprono.", "Gli animali che mangiano le piante": "Quelli sono gli erbivori, consumatori primari: dipendono dalle piante, non producono il proprio nutrimento." } },
  { topic: "ecosistema", difficulty: 3, prompt: "Che ruolo hanno i decompositori?", answer: "Trasformano i resti in sostanze riutilizzabili", distractors: ["Cacciano gli animali più deboli","Producono nutrimento con la luce","Trasportano i semi da un luogo all'altro"], explanation: "Funghi e batteri chiudono il ciclo: senza di loro le sostanze resterebbero bloccate nei resti e il suolo si esaurirebbe.",
    distractorWhy: { "Cacciano gli animali più deboli": "Quello è il ruolo dei predatori, non dei decompositori, che si nutrono di resti già morti.", "Producono nutrimento con la luce": "Quello è il ruolo dei produttori (piante), non dei decompositori.", "Trasportano i semi da un luogo all'altro": "Quello è il ruolo di alcuni animali impollinatori o dispersori di semi, non dei decompositori." } },
  { topic: "ecosistema", difficulty: 3, prompt: "Perché in una catena alimentare i predatori sono meno numerosi delle prede?", answer: "Perché a ogni passaggio si perde molta energia", distractors: ["Perché i predatori sono animali più grandi","Perché le prede si riproducono in fretta","Perché i predatori vivono più a lungo"], explanation: "Solo una piccola parte dell'energia passa da un anello all'altro: in cima ne resta poca, e sostiene pochi individui.",
    distractorWhy: { "Perché i predatori sono animali più grandi": "La dimensione non è la causa diretta: è la perdita di energia a ogni passaggio a limitare il numero di predatori.", "Perché le prede si riproducono in fretta": "La velocità di riproduzione delle prede non spiega perché ce ne siano più dei predatori: conta la perdita di energia lungo la catena.", "Perché i predatori vivono più a lungo": "La durata della vita non determina il numero di individui: conta l'energia disponibile a ogni livello." } },
  { topic: "ecosistema", difficulty: 3, prompt: "Che cos'è una rete alimentare?", answer: "Più catene alimentari collegate fra loro", distractors: ["Una catena alimentare molto lunga","L'insieme dei soli animali carnivori","Il percorso che il cibo fa nel corpo"], explanation: "Nella realtà un animale mangia più cose e viene mangiato da più predatori: le catene si intrecciano in una rete.",
    distractorWhy: { "Una catena alimentare molto lunga": "Non è una questione di lunghezza: la rete è fatta di più catene intrecciate fra loro.", "L'insieme dei soli animali carnivori": "La rete alimentare comprende tutti i livelli, non solo i carnivori.", "Il percorso che il cibo fa nel corpo": "Quello è un processo digestivo interno, non la relazione fra specie di un ecosistema." } },
  { topic: "ecosistema", difficulty: 4, prompt: "Che cos'è la simbiosi?", answer: "Una convivenza stretta fra due specie diverse", distractors: ["La competizione fra due specie simili","La caccia praticata in gruppo","La migrazione stagionale di una specie"], explanation: "Può giovare a entrambi, come per le api e i fiori, oppure a uno solo: l'importante è che la convivenza sia stabile.",
    distractorWhy: { "La competizione fra due specie simili": "La competizione è l'opposto della simbiosi: qui le specie si contendono le stesse risorse, non convivono stabilmente.", "La caccia praticata in gruppo": "La caccia di gruppo riguarda una sola specie che collabora, non una convivenza stretta fra due specie diverse.", "La migrazione stagionale di una specie": "La migrazione è lo spostamento di una specie, non una relazione stretta fra due specie diverse." } },
  { topic: "ecosistema", difficulty: 3, prompt: "Che cos'è l'habitat di una specie?", answer: "Il luogo con le condizioni adatte a viverci", distractors: ["Il territorio che difende dai rivali","Il periodo dell'anno in cui si riproduce","Il gruppo con cui si sposta di solito"], explanation: "È l'indirizzo di casa: temperatura, cibo e riparo devono essere quelli che quella specie tollera.",
    distractorWhy: { "Il territorio che difende dai rivali": "Il territorio difeso è un concetto diverso e più specifico: l'habitat è il luogo con le condizioni adatte in generale.", "Il periodo dell'anno in cui si riproduce": "Quello è un momento temporale, non un luogo: l'habitat è una questione di spazio, non di tempo.", "Il gruppo con cui si sposta di solito": "Il gruppo sociale non è l'habitat: l'habitat è il luogo fisico con le condizioni adatte." } },
  { topic: "ecosistema", difficulty: 4, prompt: "Perché due specie che mangiano la stessa cosa raramente convivono a lungo?", answer: "Perché competono e una prevale sull'altra", distractors: ["Perché non riescono a comunicare fra loro","Perché si accoppiano fra specie diverse","Perché consumano l'ambiente troppo in fretta"], explanation: "Se la risorsa è la stessa e limitata, la specie che la sfrutta meglio finisce per escludere l'altra, o la costringe a cambiare abitudini.",
    distractorWhy: { "Perché non riescono a comunicare fra loro": "La comunicazione fra specie non è il punto: è la competizione per la stessa risorsa limitata.", "Perché si accoppiano fra specie diverse": "Specie diverse di solito non si accoppiano fra loro: il problema è la competizione per il cibo.", "Perché consumano l'ambiente troppo in fretta": "Non è la velocità di consumo in sé: è la competizione diretta per la stessa risorsa a determinare chi prevale." } },
  { topic: "ecosistema", difficulty: 2, prompt: "Un animale che mangia solo piante si chiama…", answer: "Erbivoro", distractors: ["Carnivoro","Onnivoro","Decompositore"], explanation: "Erbivoro mangia vegetali, carnivoro carne, onnivoro entrambi. I decompositori si nutrono di resti.",
    distractorWhy: { "Carnivoro": "Il carnivoro mangia carne, non piante: è l'opposto dell'erbivoro.", "Onnivoro": "L'onnivoro mangia sia piante sia carne, non solo piante come l'erbivoro.", "Decompositore": "Il decompositore si nutre di resti organici in decomposizione, non semplicemente di piante vive." } },
  ...
  { topic: "energia", difficulty: 2, prompt: "Che cosa dice il principio di conservazione dell'energia?", answer: "L'energia non si crea né si distrugge, si trasforma", distractors: ["L'energia diminuisce un poco a ogni passaggio","L'energia si può creare usando certe macchine","L'energia si conserva soltanto alle basse temperature"], explanation: "Cambia forma continuamente — movimento, calore, luce — ma la quantità totale resta la stessa.",
    distractorWhy: { "L'energia diminuisce un poco a ogni passaggio": "L'energia totale non diminuisce mai: si trasforma in altre forme, come il calore.", "L'energia si può creare usando certe macchine": "Nessuna macchina crea energia dal nulla: può solo trasformarla da una forma a un'altra.", "L'energia si conserva soltanto alle basse temperature": "Il principio di conservazione vale a qualsiasi temperatura, non solo a quelle basse." } },
  { topic: "energia", difficulty: 3, prompt: "Quando accendi una lampadina, l'energia elettrica diventa…", answer: "Luce e calore", distractors: ["Solo luce, senza altro","Solo calore, senza luce","Movimento e suono"], explanation: "Nessuna trasformazione è perfetta: una parte dell'energia finisce sempre in calore, anche quando non serve.",
    distractorWhy: { "Solo luce, senza altro": "Nessuna trasformazione è perfetta: una parte dell'energia diventa sempre calore, non solo luce.", "Solo calore, senza luce": "Una lampadina produce anche luce, il suo scopo principale, non solo calore.", "Movimento e suono": "Una lampadina non produce movimento né suono: produce luce e, come sottoprodotto, calore." } },
  { topic: "energia", difficulty: 3, prompt: "Che cos'è l'energia potenziale?", answer: "L'energia che un corpo ha per la sua posizione", distractors: ["L'energia che un corpo ha per il movimento","L'energia che si produce con il calore","L'energia che un corpo può ancora creare"], explanation: "Un sasso in cima a una collina ha energia proprio perché sta in alto: appena può, la trasforma in movimento.",
    distractorWhy: { "L'energia che un corpo ha per il movimento": "Quella è l'energia cinetica, non quella potenziale legata alla posizione.", "L'energia che si produce con il calore": "Il calore è un'altra forma di energia, non ciò che definisce l'energia potenziale.", "L'energia che un corpo può ancora creare": "Un corpo non crea energia: l'energia potenziale è quella già immagazzinata per via della posizione." } },
  { topic: "energia", difficulty: 3, prompt: "Da dove viene quasi tutta l'energia che usiamo sulla Terra?", answer: "Dal Sole, direttamente o indirettamente", distractors: ["Dal calore interno del pianeta","Dal movimento delle maree","Dalle centrali costruite dall'uomo"], explanation: "Il vento nasce dal Sole che scalda l'aria; il petrolio da piante antiche cresciute grazie al Sole. Perfino il cibo.",
    distractorWhy: { "Dal calore interno del pianeta": "Il calore geotermico esiste, ma è una fonte minoritaria rispetto all'energia solare, diretta o indiretta.", "Dal movimento delle maree": "Le maree sono generate dalla Luna e dal Sole, ma sono una fonte minoritaria rispetto all'energia solare totale.", "Dalle centrali costruite dall'uomo": "Le centrali trasformano energia già esistente (spesso di origine solare): non la creano." } },
  { topic: "energia", difficulty: 4, prompt: "Perché nessuna macchina può funzionare all'infinito da sola?", answer: "Perché parte dell'energia si disperde in calore", distractors: ["Perché i materiali si consumano subito","Perché manca sempre qualcuno che la accenda","Perché l'energia si crea troppo lentamente"], explanation: "Attriti e resistenze trasformano energia utile in calore disperso: non torna indietro, e la macchina si ferma.",
    distractorWhy: { "Perché i materiali si consumano subito": "L'usura dei materiali è un fattore separato: il problema fisico di fondo è la dispersione di energia in calore.", "Perché manca sempre qualcuno che la accenda": "Una volta avviata, una macchina si fermerebbe comunque per la dispersione di energia, non per mancanza di un operatore.", "Perché l'energia si crea troppo lentamente": "L'energia non si crea affatto: il problema è che si disperde, non che venga creata lentamente." } },
  { topic: "energia", difficulty: 2, prompt: "Che cos'è l'energia cinetica?", answer: "L'energia che ha un corpo perché si muove", distractors: ["L'energia che ha un corpo perché è in alto","L'energia che un corpo emette come calore","L'energia contenuta negli alimenti"], explanation: "Più un corpo è veloce e pesante, più energia cinetica ha: è per questo che un'auto veloce frena in più spazio.",
    distractorWhy: { "L'energia che ha un corpo perché è in alto": "Quella è l'energia potenziale, legata alla posizione, non al movimento.", "L'energia che un corpo emette come calore": "Il calore è un'altra forma di energia, distinta da quella cinetica legata al movimento.", "L'energia contenuta negli alimenti": "Quella è energia chimica, immagazzinata nei legami molecolari, non energia cinetica." } },
  { topic: "energia", difficulty: 4, prompt: "In una centrale idroelettrica, quale trasformazione avviene per prima?", answer: "L'acqua in alto diventa acqua in movimento", distractors: ["L'acqua diventa direttamente elettricità","Il calore dell'acqua diventa movimento","Il movimento diventa energia chimica"], explanation: "L'acqua cade e acquista velocità, poi fa girare la turbina, e solo alla fine l'alternatore produce elettricità.",
    distractorWhy: { "L'acqua diventa direttamente elettricità": "Non c'è una trasformazione diretta: prima l'acqua cade e si muove, poi fa girare la turbina, solo alla fine si produce elettricità.", "Il calore dell'acqua diventa movimento": "Non è il calore dell'acqua a produrre movimento: è la caduta dovuta alla gravità.", "Il movimento diventa energia chimica": "L'energia meccanica diventa elettrica tramite l'alternatore, non energia chimica." } },
  { topic: "energia", difficulty: 3, prompt: "Che tipo di energia contiene il cibo che mangi?", answer: "Energia chimica", distractors: ["Energia cinetica","Energia elettrica","Energia luminosa"], explanation: "È immagazzinata nei legami fra le molecole: il corpo li spezza e ne ricava movimento e calore.",
    distractorWhy: { "Energia cinetica": "L'energia cinetica è legata al movimento: il cibo fermo non ne ha, ma contiene energia chimica immagazzinata.", "Energia elettrica": "Il cibo non contiene elettricità: contiene energia chimica nei legami molecolari.", "Energia luminosa": "Il cibo non emette luce: la sua energia è chimica, immagazzinata nei legami molecolari." } },
  { topic: "energia", difficulty: 3, prompt: "Perché una pallina che rimbalza non torna mai all'altezza di partenza?", answer: "Perché parte dell'energia si disperde a ogni urto", distractors: ["Perché la gravità aumenta a ogni rimbalzo","Perché la pallina diventa più leggera","Perché l'aria la spinge verso il basso"], explanation: "A ogni rimbalzo un po' di energia diventa calore e suono: quella che resta non basta a risalire fino in cima.",
    distractorWhy: { "Perché la gravità aumenta a ogni rimbalzo": "La gravità resta costante: non aumenta con i rimbalzi.", "Perché la pallina diventa più leggera": "Il peso della pallina non cambia con i rimbalzi: cambia solo l'energia disponibile, che si disperde.", "Perché l'aria la spinge verso il basso": "L'aria non spinge sistematicamente verso il basso: la vera causa è la dispersione di energia a ogni urto." } },
  ...
  { topic: "terra-universo", difficulty: 2, prompt: "Che cosa causa l'alternarsi del giorno e della notte?", answer: "La rotazione della Terra su sé stessa", distractors: ["Il movimento della Terra attorno al Sole","Lo spostamento della Luna nel cielo","L'inclinazione dell'asse terrestre"], explanation: "Il Sole non si sposta: siamo noi a girare, e ogni punto passa alternativamente in luce e in ombra.",
    distractorWhy: { "Il movimento della Terra attorno al Sole": "Quello (la rivoluzione) determina l'anno e le stagioni, non l'alternanza di giorno e notte.", "Lo spostamento della Luna nel cielo": "La Luna non causa il giorno e la notte: è la rotazione terrestre a farlo.", "L'inclinazione dell'asse terrestre": "L'inclinazione causa le stagioni, non l'alternanza quotidiana di giorno e notte." } },
  { topic: "terra-universo", difficulty: 3, prompt: "Che cosa causa le stagioni?", answer: "L'inclinazione dell'asse terrestre", distractors: ["La distanza variabile dal Sole","La rotazione della Terra su sé stessa","Il passaggio della Luna davanti al Sole"], explanation: "L'asse inclinato fa arrivare i raggi più o meno obliqui secondo il periodo: non è la distanza dal Sole a decidere.",
    distractorWhy: { "La distanza variabile dal Sole": "La distanza dal Sole cambia poco durante l'anno: sono l'inclinazione dell'asse a determinare le stagioni.", "La rotazione della Terra su sé stessa": "Quella causa il giorno e la notte, non le stagioni.", "Il passaggio della Luna davanti al Sole": "Quello causerebbe un'eclissi, un evento raro, non il ciclo regolare delle stagioni." } },
  { topic: "terra-universo", difficulty: 3, prompt: "Perché vediamo la Luna cambiare forma?", answer: "Perché ne vediamo illuminata una parte diversa", distractors: ["Perché la Luna cambia davvero forma","Perché a volte è coperta dalle nuvole","Perché si allontana e si avvicina"], explanation: "La Luna è sempre una sfera per metà illuminata: cambia solo quanta di quella metà è rivolta verso di noi.",
    distractorWhy: { "Perché la Luna cambia davvero forma": "La Luna resta sempre una sfera: cambia solo quanta parte illuminata vediamo da Terra.", "Perché a volte è coperta dalle nuvole": "Le nuvole terrestri non causano le fasi lunari regolari: dipende dalla posizione relativa Sole-Terra-Luna.", "Perché si allontana e si avvicina": "La distanza della Luna varia poco e non è la causa delle fasi: conta quale parte illuminata vediamo." } },
  { topic: "terra-universo", difficulty: 3, prompt: "Che cos'è una galassia?", answer: "Un enorme insieme di stelle, gas e polveri", distractors: ["Un gruppo di pianeti attorno a una stella","Una stella molto più grande delle altre","Lo spazio vuoto fra due sistemi solari"], explanation: "La nostra si chiama Via Lattea e contiene centinaia di miliardi di stelle: il Sole è una di quelle.",
    distractorWhy: { "Un gruppo di pianeti attorno a una stella": "Quello è un sistema solare/planetario, molto più piccolo di una galassia che contiene miliardi di stelle.", "Una stella molto più grande delle altre": "Una galassia non è una singola stella: è un insieme enorme di miliardi di stelle.", "Lo spazio vuoto fra due sistemi solari": "Una galassia non è vuoto: è piena di stelle, gas e polveri." } },
  { topic: "terra-universo", difficulty: 4, prompt: "Perché di giorno non vediamo le stelle?", answer: "Perché la luce del Sole diffusa nell'aria le copre", distractors: ["Perché le stelle si spengono di giorno","Perché si spostano dietro il Sole","Perché la Terra le nasconde con l'ombra"], explanation: "Le stelle ci sono anche di giorno: è l'atmosfera illuminata a diventare troppo luminosa perché si vedano.",
    distractorWhy: { "Perché le stelle si spengono di giorno": "Le stelle non si spengono: continuano a brillare, ma la luce diffusa del Sole le sovrasta.", "Perché si spostano dietro il Sole": "Le stelle non si spostano dietro il Sole ogni giorno: restano nella stessa posizione relativa nel cielo.", "Perché la Terra le nasconde con l'ombra": "L'ombra della Terra copre la Luna in un'eclissi, ma non nasconde le stelle di giorno: è la luce solare diffusa a farlo." } },
  { topic: "terra-universo", difficulty: 3, prompt: "Quale pianeta è il più vicino al Sole?", answer: "Mercurio", distractors: ["Venere","Nettuno","Saturno"], explanation: "L'ordine è Mercurio, Venere, Terra, Marte: Mercurio è il primo e compie il giro più breve.",
    distractorWhy: { "Venere": "Venere è il secondo pianeta dal Sole, dopo Mercurio.", "Nettuno": "Nettuno è l'ultimo pianeta, il più lontano dal Sole, non il più vicino.", "Saturno": "Saturno è molto più lontano dal Sole di Mercurio." } },
  { topic: "terra-universo", difficulty: 4, prompt: "Che cos'è un'eclissi di Sole?", answer: "La Luna si mette fra la Terra e il Sole", distractors: ["L'ombra della Terra cade sopra la Luna piena","Il Sole si spegne del tutto per qualche minuto","Una nube molto densa copre il Sole per un istante"], explanation: "L'ombra della Luna cade sulla Terra: dove passa, il Sole appare coperto. Nell'eclissi di Luna è la Terra a fare ombra.",
    distractorWhy: { "L'ombra della Terra cade sopra la Luna piena": "Quella è l'eclissi di Luna, non di Sole: nell'eclissi di Sole è la Luna a fare ombra sulla Terra.", "Il Sole si spegne del tutto per qualche minuto": "Il Sole non si spegne mai: appare coperto perché la Luna si frappone, ma continua a brillare.", "Una nube molto densa copre il Sole per un istante": "Non è una nube atmosferica: è la Luna stessa a bloccare la vista del Sole." } },
  ...
  { topic: "materia", difficulty: 2, prompt: "In quale stato la materia ha forma e volume propri?", answer: "Solido", distractors: ["Liquido","Gassoso","Nessuno dei tre"], explanation: "Il solido tiene la sua forma; il liquido prende quella del recipiente; il gas riempie tutto lo spazio disponibile.",
    distractorWhy: { "Liquido": "Il liquido ha volume proprio ma non forma propria: prende quella del recipiente.", "Gassoso": "Il gas non ha né forma né volume propri: riempie tutto lo spazio disponibile.", "Nessuno dei tre": "Il solido ha proprio entrambe le caratteristiche: forma e volume propri." } },
  { topic: "materia", difficulty: 3, prompt: "Come si chiama il passaggio da liquido a gassoso?", answer: "Evaporazione", distractors: ["Condensazione","Solidificazione","Fusione"], explanation: "La condensazione fa il contrario; la fusione è da solido a liquido.",
    distractorWhy: { "Condensazione": "La condensazione è il passaggio contrario, da gas a liquido.", "Solidificazione": "La solidificazione è il passaggio da liquido a solido, non a gas.", "Fusione": "La fusione è il passaggio da solido a liquido, non da liquido a gas." } },
  { topic: "materia", difficulty: 3, prompt: "Che cosa succede alle particelle quando un solido si scalda e fonde?", answer: "Si muovono di più e perdono la posizione fissa", distractors: ["Diventano più grandi e pesanti","Si moltiplicano formando altra materia","Si fermano completamente sul posto"], explanation: "Il calore aumenta il movimento: superata una certa soglia le particelle non restano più al loro posto e il solido diventa liquido.",
    distractorWhy: { "Diventano più grandi e pesanti": "Le particelle non cambiano dimensione o peso: cambia solo il loro movimento.", "Si moltiplicano formando altra materia": "Il numero di particelle resta lo stesso: cambia solo come si muovono e si dispongono.", "Si fermano completamente sul posto": "È il contrario: il calore aumenta il movimento delle particelle, non lo ferma." } },
  { topic: "materia", difficulty: 3, prompt: "Che cos'è un miscuglio?", answer: "Più sostanze mescolate ma non combinate", distractors: ["Una sostanza pura molto fine","Due sostanze legate chimicamente","Un liquido che contiene solo acqua"], explanation: "Nel miscuglio le sostanze restano quelle di prima e spesso si possono separare: sabbia e sale, per esempio.",
    distractorWhy: { "Una sostanza pura molto fine": "Un miscuglio contiene più sostanze diverse, non una sola sostanza pura.", "Due sostanze legate chimicamente": "Nel miscuglio le sostanze non si legano chimicamente: restano distinte e separabili.", "Un liquido che contiene solo acqua": "Un miscuglio può non contenere affatto acqua: è la combinazione di più sostanze in generale." } },
  { topic: "materia", difficulty: 4, prompt: "Perché l'acqua ghiacciata occupa più spazio dell'acqua liquida?", answer: "Perché le molecole si dispongono più distanziate", distractors: ["Perché il freddo aggiunge nuova materia","Perché il ghiaccio pesa più dell'acqua","Perché entra aria fra le molecole"], explanation: "Congelandosi le molecole formano una struttura ordinata e più aperta: stessa materia, più volume. Per questo il ghiaccio galleggia.",
    distractorWhy: { "Perché il freddo aggiunge nuova materia": "Il freddo non aggiunge materia: la quantità di acqua resta la stessa, cambia solo la disposizione delle molecole.", "Perché il ghiaccio pesa più dell'acqua": "Il ghiaccio non pesa di più: a parità di massa occupa più spazio, quindi è meno denso, non più pesante.", "Perché entra aria fra le molecole": "Non è aria a entrare: è la struttura cristallina del ghiaccio a distanziare di più le molecole d'acqua stesse." } },
  { topic: "materia", difficulty: 4, prompt: "Come si può separare il sale dall'acqua salata?", answer: "Facendo evaporare l'acqua", distractors: ["Filtrando con un panno fitto","Raffreddando fino a congelare","Mescolando molto energicamente"], explanation: "Il sale è sciolto, quindi il filtro non lo trattiene: bisogna far andare via l'acqua e lasciarlo depositato.",
    distractorWhy: { "Filtrando con un panno fitto": "Il sale è disciolto a livello molecolare: nessun filtro, per quanto fitto, può trattenerlo.", "Raffreddando fino a congelare": "Congelare non separa efficacemente il sale: resta comunque disciolto nel ghiaccio formato.", "Mescolando molto energicamente": "Mescolare non separa le sostanze: anzi, aiuta il sale a sciogliersi ancora meglio." } },
  { topic: "materia", difficulty: 3, prompt: "Che cos'è la densità di un materiale?", answer: "Quanta massa c'è in un certo volume", distractors: ["Quanto pesa un oggetto in totale","Quanto è duro un materiale al tatto","Quanto spazio occupa un oggetto"], explanation: "Un chilo di piombo e uno di piume pesano uguale, ma il piombo sta in molto meno spazio: ha densità maggiore.",
    distractorWhy: { "Quanto pesa un oggetto in totale": "Il peso totale non è la densità: la densità è il rapporto fra massa e volume.", "Quanto è duro un materiale al tatto": "La durezza è una proprietà diversa, non collegata direttamente alla densità.", "Quanto spazio occupa un oggetto": "Quello è il volume, non la densità: la densità è la massa in relazione a quel volume." } },
  { topic: "materia", difficulty: 2, prompt: "In quale stato le particelle sono più libere di muoversi?", answer: "Gassoso", distractors: ["Solido","Liquido","Sono uguali in tutti"], explanation: "Nel gas le particelle sono lontane e veloci: per questo un gas riempie tutto lo spazio disponibile.",
    distractorWhy: { "Solido": "Nel solido le particelle sono le meno libere: restano in posizioni fisse.", "Liquido": "Nel liquido le particelle sono più libere che nel solido, ma meno che nel gas.", "Sono uguali in tutti": "La libertà di movimento delle particelle cambia molto fra i tre stati: non è uguale." } },
  { topic: "corpo", difficulty: 2, prompt: "Che cosa trasporta l'ossigeno dai polmoni al resto del corpo?", answer: "Il sangue", distractors: ["I nervi","I muscoli","La linfa"], explanation: "L'ossigeno passa negli alveoli, entra nel sangue e viaggia nelle arterie fino a ogni cellula.",
    distractorWhy: { "I nervi": "I nervi trasmettono segnali elettrici, non trasportano ossigeno.", "I muscoli": "I muscoli consumano ossigeno, ma non lo trasportano attraverso il corpo.", "La linfa": "La linfa trasporta altre sostanze e cellule immunitarie, non l'ossigeno." } },
  { topic: "corpo", difficulty: 2, prompt: "A che cosa servono i polmoni?", answer: "A scambiare ossigeno e anidride carbonica", distractors: ["A filtrare il sangue dalle scorie","A digerire il cibo che mangiamo","A produrre le cellule del sangue"], explanation: "Nell'inspirazione entra ossigeno e nell'espirazione esce anidride carbonica: lo scambio avviene negli alveoli.",
    distractorWhy: { "A filtrare il sangue dalle scorie": "Quello è il compito dei reni, non dei polmoni.", "A digerire il cibo che mangiamo": "La digestione avviene in stomaco e intestino, non nei polmoni.", "A produrre le cellule del sangue": "Le cellule del sangue si producono nel midollo osseo, non nei polmoni." } },
  { topic: "corpo", difficulty: 3, prompt: "Dove comincia la digestione?", answer: "In bocca, con la masticazione e la saliva", distractors: ["Nello stomaco, con i succhi gastrici","Nell'intestino, con l'assorbimento","Nell'esofago, durante la deglutizione"], explanation: "La saliva contiene già sostanze che cominciano a smontare gli amidi: masticare bene aiuta tutto il resto.",
    distractorWhy: { "Nello stomaco, con i succhi gastrici": "Lo stomaco continua la digestione, ma non è dove comincia: la saliva agisce già in bocca.", "Nell'intestino, con l'assorbimento": "L'assorbimento avviene molto più avanti nel processo digestivo, non all'inizio.", "Nell'esofago, durante la deglutizione": "L'esofago trasporta il cibo verso lo stomaco: la digestione vera e propria comincia già in bocca." } },
  { topic: "corpo", difficulty: 3, prompt: "Che cosa fa lo scheletro oltre a sostenere il corpo?", answer: "Protegge gli organi e produce cellule del sangue", distractors: ["Digerisce le sostanze più dure del cibo","Regola la temperatura di tutto il corpo","Trasporta i segnali nervosi al cervello"], explanation: "Cranio e costole fanno da armatura, e dentro le ossa lunghe il midollo produce le cellule del sangue.",
    distractorWhy: { "Digerisce le sostanze più dure del cibo": "La digestione è compito dell'apparato digerente, non dello scheletro.", "Regola la temperatura di tutto il corpo": "La regolazione della temperatura è compito della pelle e della circolazione, non dello scheletro.", "Trasporta i segnali nervosi al cervello": "Quello è il compito del sistema nervoso, non dello scheletro." } },
  { topic: "corpo", difficulty: 3, prompt: "Come si muovono le ossa?", answer: "Grazie ai muscoli che le tirano", distractors: ["Perché si allungano da sole","Grazie al sangue che le spinge","Perché le articolazioni si gonfiano"], explanation: "I muscoli si accorciano e tirano il tendine attaccato all'osso: le ossa da sole non possono muoversi.",
    distractorWhy: { "Perché si allungano da sole": "Le ossa non si muovono autonomamente: hanno bisogno della trazione dei muscoli.", "Grazie al sangue che le spinge": "Il sangue trasporta ossigeno e nutrienti, ma non fornisce la forza meccanica per muovere le ossa.", "Perché le articolazioni si gonfiano": "Le articolazioni permettono il movimento, ma non lo generano: serve la contrazione dei muscoli." } },
  { topic: "corpo", difficulty: 4, prompt: "Perché quando corri il respiro accelera?", answer: "Perché i muscoli chiedono più ossigeno", distractors: ["Perché il cuore diventa più grande","Perché aumenta la temperatura esterna","Perché i polmoni si riempiono d'acqua"], explanation: "Lavorando, i muscoli consumano più ossigeno e producono più anidride carbonica: respiro e battito aumentano per stare al passo.",
    distractorWhy: { "Perché il cuore diventa più grande": "Il cuore batte più veloce durante lo sforzo, ma non cambia dimensione in pochi minuti.", "Perché aumenta la temperatura esterna": "La temperatura dell'ambiente non è la causa: è il maggior bisogno di ossigeno dei muscoli.", "Perché i polmoni si riempiono d'acqua": "I polmoni non si riempiono d'acqua durante la corsa: questo sarebbe un problema serio, non normale." } },
  { topic: "corpo", difficulty: 3, prompt: "Qual è il compito dei reni?", answer: "Filtrare il sangue e produrre l'urina", distractors: ["Pompare il sangue nelle arterie","Assorbire i nutrienti dal cibo","Immagazzinare le riserve di zucchero"], explanation: "Ripuliscono il sangue dalle sostanze di scarto, che vengono eliminate con l'urina.",
    distractorWhy: { "Pompare il sangue nelle arterie": "Quello è il compito del cuore, non dei reni.", "Assorbire i nutrienti dal cibo": "L'assorbimento dei nutrienti avviene nell'intestino, non nei reni.", "Immagazzinare le riserve di zucchero": "Le riserve di zucchero si immagazzinano soprattutto nel fegato, non nei reni." } },
  { topic: "corpo", difficulty: 4, prompt: "Perché è importante dormire abbastanza?", answer: "Perché durante il sonno il corpo si ripara e consolida la memoria", distractors: ["Perché durante la notte si consuma molto meno cibo","Perché il cuore si ferma qualche istante per riposare","Perché i muscoli riescono a crescere soltanto al buio"], explanation: "Nel sonno avvengono riparazioni dei tessuti e il cervello riorganizza ciò che ha imparato durante il giorno.",
    distractorWhy: { "Perché durante la notte si consuma molto meno cibo": "Il consumo di cibo non ha a che fare con il motivo per cui dormire è importante.", "Perché il cuore si ferma qualche istante per riposare": "Il cuore non si ferma mai durante il sonno: continua a battere, anche se a ritmo più lento.", "Perché i muscoli riescono a crescere soltanto al buio": "Il buio in sé non è la condizione: è il processo di sonno stesso a favorire riparazione e memoria." } },
  { topic: "viventi", difficulty: 2, prompt: "Che cos'hanno in comune tutti gli esseri viventi?", answer: "Nascono, crescono, si riproducono e muoiono", distractors: ["Si muovono da un posto all'altro","Hanno tutti bisogno di luce solare","Sono formati da molte cellule"], explanation: "Anche una pianta, che non si sposta, compie il ciclo vitale. È quello a definire un vivente.",
    distractorWhy: { "Si muovono da un posto all'altro": "Le piante non si spostano ma sono comunque viventi: il movimento non è una caratteristica comune a tutti.", "Hanno tutti bisogno di luce solare": "Molti organismi (come alcuni funghi e batteri) non hanno bisogno diretto di luce solare.", "Sono formati da molte cellule": "Molti esseri viventi, come i batteri, sono formati da una sola cellula." } },
  { topic: "viventi", difficulty: 3, prompt: "Qual è l'unità di base di tutti gli esseri viventi?", answer: "La cellula", distractors: ["L'organo","Il tessuto","La molecola"], explanation: "Ogni vivente è fatto di cellule: alcuni ne hanno una sola, altri miliardi.",
    distractorWhy: { "L'organo": "Un organo è fatto di tessuti, che a loro volta sono fatti di cellule: la cellula è l'unità più piccola.", "Il tessuto": "Un tessuto è un insieme di cellule simili: la cellula è l'unità di base più piccola.", "La molecola": "Le molecole compongono le cellule, ma non sono considerate l'unità di base dei viventi." } },
  { topic: "viventi", difficulty: 3, prompt: "Che differenza c'è fra un vertebrato e un invertebrato?", answer: "Il vertebrato ha una colonna vertebrale", distractors: ["Il vertebrato è sempre più grande","L'invertebrato vive soltanto in acqua","L'invertebrato non ha organi interni"], explanation: "La colonna vertebrale è lo scheletro interno: la maggior parte degli animali, in realtà, ne è priva.",
    distractorWhy: { "Il vertebrato è sempre più grande": "La dimensione non è il criterio: esistono vertebrati piccoli e invertebrati molto grandi.", "L'invertebrato vive soltanto in acqua": "Molti invertebrati vivono sulla terraferma, come insetti e lombrichi.", "L'invertebrato non ha organi interni": "Gli invertebrati hanno organi interni: quello che manca loro è la colonna vertebrale." } },
  { topic: "viventi", difficulty: 4, prompt: "Che cos'è un adattamento?", answer: "Una caratteristica che aiuta a vivere in un ambiente", distractors: ["Un cambiamento deciso dall'animale stesso","Una malattia che si trasmette ai figli","Uno spostamento verso un clima migliore"], explanation: "Il collo lungo della giraffa o le foglie a spina del cactus: caratteristiche selezionate perché in quell'ambiente funzionano.",
    distractorWhy: { "Un cambiamento deciso dall'animale stesso": "Un adattamento non è una scelta consapevole: è il risultato della selezione naturale nel tempo.", "Una malattia che si trasmette ai figli": "Un adattamento è vantaggioso per la sopravvivenza, non una malattia.", "Uno spostamento verso un clima migliore": "Uno spostamento è un comportamento temporaneo, non una caratteristica ereditaria come l'adattamento." } },
  { topic: "viventi", difficulty: 3, prompt: "Perché i funghi non sono considerati piante?", answer: "Perché non fanno la fotosintesi", distractors: ["Perché crescono soltanto all'ombra","Perché non hanno bisogno di acqua","Perché si spostano lentamente nel suolo"], explanation: "Le piante si costruiscono il nutrimento con la luce; i funghi lo assorbono da materia già esistente, viva o morta.",
    distractorWhy: { "Perché crescono soltanto all'ombra": "Alcuni funghi crescono anche in luoghi luminosi: non è questo il criterio che li distingue dalle piante.", "Perché non hanno bisogno di acqua": "I funghi hanno bisogno di acqua come le piante: non è questo a distinguerli.", "Perché si spostano lentamente nel suolo": "I funghi non si spostano più delle piante: la differenza chiave è come ottengono il nutrimento." } },
  ...
  { topic: "metodo", difficulty: 1, prompt: "In un esperimento controllato, quante variabili cambi per volta?", answer: "Una sola", distractors: ["Tutte insieme", "Almeno tre", "Nessuna"], explanation: "Cambiando una sola variabile capisci quale causa l'effetto.",
    distractorWhy: { "Tutte insieme": "Cambiando tutte insieme non sapresti quale ha causato l'effetto osservato.", "Almeno tre": "Cambiare più variabili contemporaneamente rende impossibile isolare la causa.", "Nessuna": "Senza cambiare nulla non c'è nessun effetto da osservare o misurare." } },
  { topic: "metodo", difficulty: 2, prompt: "Cosa distingue un'ipotesi da una conclusione?", answer: "L'ipotesi è una previsione da verificare", distractors: ["Sono la stessa cosa", "L'ipotesi arriva dopo i dati", "La conclusione precede l'esperimento"], explanation: "Prima l'ipotesi (previsione), poi i dati, infine la conclusione.",
    distractorWhy: { "Sono la stessa cosa": "Sono momenti diversi del metodo scientifico: l'ipotesi viene prima, la conclusione dopo i dati.", "L'ipotesi arriva dopo i dati": "È il contrario: l'ipotesi si formula prima di raccogliere i dati.", "La conclusione precede l'esperimento": "È il contrario: la conclusione arriva dopo l'esperimento e i dati raccolti." } },
  { topic: "metodo", difficulty: 3, prompt: "A cosa serve un 'gruppo di controllo' in un esperimento?", answer: "A confrontare con qualcosa che non è stato cambiato", distractors: ["A rendere l'esperimento molto più lungo del solito", "A cambiare più cose insieme e vedere", "A saltare qualche misura per fare prima"], explanation: "Il gruppo di controllo mostra cosa succede senza la variabile che stai studiando.",
    distractorWhy: { "A rendere l'esperimento molto più lungo del solito": "Il gruppo di controllo non serve ad allungare i tempi: serve a fornire un termine di paragone.", "A cambiare più cose insieme e vedere": "È l'opposto: il gruppo di controllo non cambia nulla, proprio per fare da confronto.", "A saltare qualche misura per fare prima": "Il gruppo di controllo richiede comunque misure complete: serve al confronto, non a velocizzare." } },
  { topic: "metodo", difficulty: 4, prompt: "Cambi luce E acqua insieme e la pianta cresce di più. Cosa puoi concludere?", answer: "Non sai quale delle due abbia agito", distractors: ["È stata solo la luce", "È stata solo l'acqua", "Sono state entrambe di sicuro"], explanation: "Cambiando due variabili insieme non puoi isolare la causa: vanno provate separatamente.",
    distractorWhy: { "È stata solo la luce": "Non puoi saperlo con certezza: hai cambiato anche l'acqua nello stesso esperimento.", "È stata solo l'acqua": "Non puoi saperlo con certezza: hai cambiato anche la luce nello stesso esperimento.", "Sono state entrambe di sicuro": "Non è detto: potrebbe essere stata solo una delle due, ma cambiandole insieme non puoi saperlo." } },
  ...
  { topic: "materia", difficulty: 1, prompt: "Quali sono i tre stati principali della materia?", answer: "Solido, liquido, gassoso", distractors: ["Caldo, freddo, tiepido", "Duro, molle, liquido", "Pieno, vuoto, misto"], explanation: "Sono le stesse particelle, legate in modo diverso: ferme e strette nel solido, vicine ma libere di scorrere nel liquido, lontane e indipendenti nel gassoso.",
    distractorWhy: { "Caldo, freddo, tiepido": "Queste sono sensazioni di temperatura, non stati della materia.", "Duro, molle, liquido": "«Duro» e «molle» non sono stati della materia: sono proprietà, non categorie fisiche complete.", "Pieno, vuoto, misto": "Questi termini non descrivono gli stati fisici della materia." } },
  { topic: "materia", difficulty: 1, prompt: "Come si chiama l'acqua allo stato solido?", answer: "Ghiaccio", distractors: ["Vapore", "Rugiada", "Nuvola"], explanation: "L'acqua solida è il ghiaccio; allo stato gassoso è vapore.",
    distractorWhy: { "Vapore": "Il vapore è l'acqua allo stato gassoso, non solido.", "Rugiada": "La rugiada è acqua liquida condensata, non lo stato solido.", "Nuvola": "Una nuvola è fatta di minuscole goccioline o cristalli sospesi, non è il nome dello stato solido dell'acqua." } },
  { topic: "materia", difficulty: 2, prompt: "Come si chiama il passaggio dell'acqua da liquido a vapore?", answer: "Evaporazione", distractors: ["Fusione", "Solidificazione", "Condensazione"], explanation: "Nell'evaporazione il liquido diventa gas; nella condensazione avviene il contrario.",
    distractorWhy: { "Fusione": "La fusione è il passaggio da solido a liquido, non da liquido a gas.", "Solidificazione": "La solidificazione è il passaggio da liquido a solido, non a gas.", "Condensazione": "La condensazione è il passaggio contrario, da gas a liquido." } },
  { topic: "materia", difficulty: 2, prompt: "Come si chiama il passaggio da gas (vapore) a liquido?", answer: "Condensazione", distractors: ["Evaporazione", "Fusione", "Sublimazione"], explanation: "La condensazione forma le goccioline: è il contrario dell'evaporazione.",
    distractorWhy: { "Evaporazione": "L'evaporazione è il passaggio contrario, da liquido a gas.", "Fusione": "La fusione è il passaggio da solido a liquido, non da gas a liquido.", "Sublimazione": "La sublimazione è il passaggio diretto da solido a gas, non da gas a liquido." } },
  { topic: "materia", difficulty: 3, prompt: "Come si chiama il passaggio da solido a liquido?", answer: "Fusione", distractors: ["Evaporazione", "Sublimazione", "Solidificazione"], explanation: "Il ghiaccio che diventa acqua è fusione.",
    distractorWhy: { "Evaporazione": "L'evaporazione è il passaggio da liquido a gas, non da solido a liquido.", "Sublimazione": "La sublimazione è il passaggio diretto da solido a gas, non a liquido.", "Solidificazione": "La solidificazione è il passaggio contrario, da liquido a solido." } },
  { topic: "materia", difficulty: 4, prompt: "Come si chiama il passaggio diretto da solido a gas, senza passare per il liquido?", answer: "Sublimazione", distractors: ["Fusione", "Evaporazione", "Condensazione"], explanation: "Nella sublimazione un solido diventa gas direttamente (es. la neve che 'sparisce' senza sciogliersi).",
    distractorWhy: { "Fusione": "La fusione è il passaggio da solido a liquido, non direttamente a gas.", "Evaporazione": "L'evaporazione parte dallo stato liquido, non direttamente dal solido.", "Condensazione": "La condensazione è il passaggio da gas a liquido, l'opposto della sublimazione." } },
  // --- Esseri viventi ---
  { topic: "viventi", difficulty: 1, prompt: "Quale parte della pianta assorbe l'acqua dal terreno?", answer: "Le radici", distractors: ["I fiori", "Le foglie", "I frutti"], explanation: "Le radici assorbono acqua e sali minerali dal suolo.",
    distractorWhy: { "I fiori": "I fiori servono alla riproduzione della pianta, non all'assorbimento dell'acqua.", "Le foglie": "Le foglie fanno la fotosintesi e traspirano acqua, ma non la assorbono dal terreno.", "I frutti": "I frutti contengono i semi, non assorbono acqua dal terreno." } },
  { topic: "viventi", difficulty: 1, prompt: "Di cosa hanno bisogno le piante per fare la fotosintesi?", answer: "Luce, acqua e anidride carbonica", distractors: ["Soltanto acqua abbondante", "Buio completo e freddo", "Soltanto terra da giardino"], explanation: "Con luce, acqua e CO2 la pianta produce nutrimento e ossigeno.",
    distractorWhy: { "Soltanto acqua abbondante": "L'acqua da sola non basta: servono anche luce e anidride carbonica.", "Buio completo e freddo": "La fotosintesi richiede luce, non buio: senza luce non può avvenire.", "Soltanto terra da giardino": "La terra da sola non basta: servono anche luce, acqua e anidride carbonica." } },
  { topic: "viventi", difficulty: 2, prompt: "Quale gas rilasciano le piante durante la fotosintesi?", answer: "Ossigeno", distractors: ["Anidride carbonica", "Azoto", "Idrogeno"], explanation: "Le piante assorbono CO2 e liberano ossigeno.",
    distractorWhy: { "Anidride carbonica": "L'anidride carbonica è ciò che le piante assorbono durante la fotosintesi, non ciò che rilasciano.", "Azoto": "L'azoto non è un prodotto della fotosintesi.", "Idrogeno": "L'idrogeno non viene rilasciato come gas libero durante la fotosintesi." } },
  { topic: "viventi", difficulty: 2, prompt: "Come si chiamano gli animali che si nutrono solo di piante?", answer: "Erbivori", distractors: ["Carnivori", "Onnivori", "Predatori"], explanation: "Gli erbivori mangiano vegetali; i carnivori altri animali.",
    distractorWhy: { "Carnivori": "I carnivori mangiano carne, non piante: è l'opposto degli erbivori.", "Onnivori": "Gli onnivori mangiano sia piante sia carne, non solo piante come gli erbivori.", "Predatori": "I predatori cacciano altri animali: non è il termine per chi mangia solo piante." } },
  { topic: "viventi", difficulty: 3, prompt: "Come si chiamano gli animali che mangiano sia piante sia altri animali?", answer: "Onnivori", distractors: ["Erbivori", "Carnivori", "Decompositori"], explanation: "Gli onnivori (come l'orso o l'uomo) si nutrono di tutto.",
    distractorWhy: { "Erbivori": "Gli erbivori mangiano solo piante, non anche altri animali.", "Carnivori": "I carnivori mangiano solo carne, non anche piante.", "Decompositori": "I decompositori si nutrono di resti organici in decomposizione, non genericamente di piante e animali vivi." } },
  { topic: "viventi", difficulty: 4, prompt: "Come si chiama il processo con cui gli esseri viventi ricavano energia usando l'ossigeno?", answer: "Respirazione cellulare", distractors: ["Fotosintesi", "Digestione lenta", "Evaporazione rapida"], explanation: "La respirazione cellulare libera l'energia del cibo; la fotosintesi invece la immagazzina nelle piante.",
    distractorWhy: { "Fotosintesi": "La fotosintesi immagazzina energia nelle piante, è il processo opposto alla respirazione cellulare.", "Digestione lenta": "La digestione scompone il cibo in nutrienti: la respirazione cellulare è il processo successivo che ne ricava energia.", "Evaporazione rapida": "L'evaporazione è un fenomeno fisico dell'acqua, non un processo biologico per ricavare energia." } },
  // --- Ecosistema ---
  { topic: "ecosistema", difficulty: 2, prompt: "In una catena alimentare, chi mangia gli erbivori?", answer: "I carnivori", distractors: ["Le piante", "Il Sole", "I produttori"], explanation: "I carnivori si nutrono di altri animali, come gli erbivori.",
    distractorWhy: { "Le piante": "Le piante sono cibo per gli erbivori, non i loro predatori.", "Il Sole": "Il Sole fornisce energia alle piante, ma non mangia nessuno.", "I produttori": "I produttori sono le piante stesse, alla base della catena, non chi mangia gli erbivori." } },
  { topic: "ecosistema", difficulty: 3, prompt: "In una catena alimentare, chi produce il proprio nutrimento?", answer: "Le piante (produttori)", distractors: ["I predatori (carnivori)", "I decompositori", "Gli erbivori"], explanation: "Le piante sono i produttori: creano nutrimento con la fotosintesi.",
    distractorWhy: { "I predatori (carnivori)": "I predatori dipendono da altri animali per il cibo: non producono il proprio nutrimento.", "I decompositori": "I decompositori si nutrono di resti, non producono nutrimento con la fotosintesi.", "Gli erbivori": "Gli erbivori dipendono dalle piante per il cibo: non producono il proprio nutrimento." } },
  { topic: "ecosistema", difficulty: 3, prompt: "Come si chiamano gli organismi (funghi, batteri) che decompongono i resti dei viventi?", answer: "Decompositori", distractors: ["Produttori", "Predatori", "Erbivori"], explanation: "I decompositori riciclano la materia, restituendo sostanze utili al terreno.",
    distractorWhy: { "Produttori": "I produttori (piante) creano nutrimento con la fotosintesi, non decompongono resti.", "Predatori": "I predatori cacciano prede vive, non decompongono resti organici.", "Erbivori": "Gli erbivori mangiano piante vive, non decompongono resti." } },
  { topic: "ecosistema", difficulty: 4, prompt: "Se in un bosco sparissero tutte le piante, cosa accadrebbe agli erbivori?", answer: "Diminuirebbero per mancanza di cibo", distractors: ["Aumenterebbero di numero", "Non cambierebbe proprio nulla", "Diventerebbero tutti carnivori"], explanation: "Senza produttori manca la base della catena alimentare: tutti gli altri ne risentono.",
    distractorWhy: { "Aumenterebbero di numero": "Senza cibo disponibile gli erbivori non potrebbero aumentare: diminuirebbero.", "Non cambierebbe proprio nulla": "Le piante sono la base della catena alimentare: la loro scomparsa avrebbe effetti enormi.", "Diventerebbero tutti carnivori": "Un erbivoro non può trasformarsi in carnivoro per necessità: la sua fisiologia è adattata alle piante." } },
  // --- Corpo umano ---
  { topic: "corpo", difficulty: 1, prompt: "Quale organo ci permette di pensare e comandare il corpo?", answer: "Il cervello", distractors: ["Il cuore", "Lo stomaco", "I muscoli"], explanation: "Riceve i segnali dai sensi e manda ordini ai muscoli in continuo: lavora anche mentre dormi.",
    distractorWhy: { "Il cuore": "Il cuore pompa il sangue, ma non è la sede del pensiero.", "Lo stomaco": "Lo stomaco digerisce il cibo, non comanda il corpo.", "I muscoli": "I muscoli eseguono i comandi, non li generano: quello è compito del cervello." } },
  { topic: "corpo", difficulty: 2, prompt: "A cosa serve lo scheletro?", answer: "A sostenere e proteggere il corpo", distractors: ["A digerire il cibo più in fretta", "A respirare più a lungo", "A vedere meglio i colori"], explanation: "Le ossa sostengono il corpo e proteggono gli organi (il cranio protegge il cervello).",
    distractorWhy: { "A digerire il cibo più in fretta": "La digestione è compito dell'apparato digerente, non dello scheletro.", "A respirare più a lungo": "La respirazione è compito dei polmoni, non dello scheletro.", "A vedere meglio i colori": "La vista è compito degli occhi, non dello scheletro." } },
  { topic: "corpo", difficulty: 2, prompt: "Quale organo pompa il sangue nel corpo?", answer: "Il cuore", distractors: ["I polmoni", "Il fegato", "Lo stomaco"], explanation: "È un muscolo che si contrae da solo, circa centomila volte al giorno, senza che tu debba pensarci.",
    distractorWhy: { "I polmoni": "I polmoni scambiano ossigeno e anidride carbonica, non pompano il sangue.", "Il fegato": "Il fegato filtra sostanze e produce bile, non pompa il sangue.", "Lo stomaco": "Lo stomaco digerisce il cibo, non pompa il sangue." } },
  { topic: "corpo", difficulty: 3, prompt: "In quale organo avviene lo scambio di ossigeno con il sangue?", answer: "I polmoni", distractors: ["Il cuore", "I reni", "L'intestino"], explanation: "Nei polmoni il sangue prende ossigeno e cede anidride carbonica.",
    distractorWhy: { "Il cuore": "Il cuore pompa il sangue, ma lo scambio di gas avviene nei polmoni.", "I reni": "I reni filtrano il sangue dalle scorie, non scambiano ossigeno.", "L'intestino": "L'intestino assorbe nutrienti dal cibo, non ossigeno dall'aria." } },
  { topic: "corpo", difficulty: 4, prompt: "In quale organo il cibo digerito viene assorbito nel sangue?", answer: "L'intestino", distractors: ["I polmoni", "Il cuore", "I reni"], explanation: "Nell'intestino le sostanze nutritive passano nel sangue.",
    distractorWhy: { "I polmoni": "I polmoni scambiano gas respiratori, non assorbono nutrienti dal cibo.", "Il cuore": "Il cuore pompa il sangue, ma non assorbe nutrienti dal cibo digerito.", "I reni": "I reni filtrano il sangue dalle scorie, non assorbono nutrienti dal cibo." } },
  // --- Energia (nuovo topic) ---
  { topic: "energia", difficulty: 2, prompt: "Da dove arriva quasi tutta l'energia che riscalda la Terra?", answer: "Dal Sole", distractors: ["Dalla Luna", "Dal vento", "Dalle stelle lontane"], explanation: "Il Sole è la fonte principale di luce e calore per la Terra.",
    distractorWhy: { "Dalla Luna": "La Luna non emette luce o calore propri: riflette solo quella del Sole.", "Dal vento": "Il vento stesso nasce dal Sole che scalda l'aria in modo diseguale: non è la fonte primaria.", "Dalle stelle lontane": "Le altre stelle sono troppo lontane per contribuire in modo significativo al calore della Terra." } },
  { topic: "energia", difficulty: 3, prompt: "Come si chiama l'energia prodotta dal vento che fa girare le pale?", answer: "Energia eolica", distractors: ["Energia idroelettrica", "Energia solare", "Energia nucleare"], explanation: "L'energia eolica sfrutta il vento; quella idroelettrica l'acqua che scorre.",
    distractorWhy: { "Energia idroelettrica": "L'energia idroelettrica sfrutta l'acqua in movimento, non il vento.", "Energia solare": "L'energia solare sfrutta direttamente la luce del Sole, non il vento.", "Energia nucleare": "L'energia nucleare viene dalle reazioni degli atomi, non dal vento." } },
  { topic: "energia", difficulty: 3, prompt: "L'energia dell'acqua che scorre e fa girare le turbine si chiama…", answer: "Energia idroelettrica", distractors: ["Energia eolica", "Energia solare", "Energia geotermica"], explanation: "Le dighe sfruttano l'acqua in movimento per produrre elettricità.",
    distractorWhy: { "Energia eolica": "L'energia eolica sfrutta il vento, non l'acqua che scorre.", "Energia solare": "L'energia solare sfrutta la luce del Sole, non l'acqua.", "Energia geotermica": "L'energia geotermica sfrutta il calore interno della Terra, non l'acqua che scorre." } },
  { topic: "energia", difficulty: 4, prompt: "Quali fonti di energia non si esauriscono e inquinano poco?", answer: "Sole, vento e acqua (rinnovabili)", distractors: ["Carbone e petrolio estratti", "Gas e benzina dei motori", "Plastica bruciata negli inceneritori"], explanation: "Le fonti rinnovabili si rigenerano e sono più pulite dei combustibili fossili.",
    distractorWhy: { "Carbone e petrolio estratti": "Sono combustibili fossili: si esauriscono e inquinano molto, l'opposto delle rinnovabili.", "Gas e benzina dei motori": "Sono derivati da fonti fossili: si esauriscono e inquinano, non sono rinnovabili.", "Plastica bruciata negli inceneritori": "Bruciare plastica produce inquinamento significativo: non è una fonte pulita e rinnovabile." } },
  ...
  { topic: "terra-universo", difficulty: 1, prompt: "Attorno a cosa gira la Terra?", answer: "Il Sole", distractors: ["La Luna", "Marte", "Una cometa"], explanation: "La Terra orbita intorno al Sole in circa un anno.",
    distractorWhy: { "La Luna": "È la Luna a girare intorno alla Terra, non il contrario.", "Marte": "Marte è un altro pianeta che orbita intorno al Sole, come la Terra: non è il centro dell'orbita terrestre.", "Una cometa": "Le comete orbitano anch'esse intorno al Sole: la Terra non gira attorno a una cometa." } },
  { topic: "terra-universo", difficulty: 2, prompt: "Come si chiama il satellite naturale della Terra?", answer: "La Luna", distractors: ["Marte", "Il Sole", "Venere"], explanation: "Le mostra sempre la stessa faccia, perché impiega lo stesso tempo a girare su di sé e attorno a noi.",
    distractorWhy: { "Marte": "Marte è un pianeta, non un satellite della Terra.", "Il Sole": "Il Sole è la stella al centro del sistema solare, non un satellite della Terra.", "Venere": "Venere è un altro pianeta del sistema solare, non un satellite della Terra." } },
  { topic: "terra-universo", difficulty: 2, prompt: "Cosa provoca l'alternarsi del giorno e della notte?", answer: "La rotazione della Terra su se stessa", distractors: ["La Terra che gira intorno al Sole", "Le nuvole", "La Luna che si sposta"], explanation: "Ruotando su se stessa, ogni punto della Terra si affaccia al Sole e poi all'ombra.",
    distractorWhy: { "La Terra che gira intorno al Sole": "Quello (la rivoluzione) determina l'anno e le stagioni, non l'alternanza quotidiana di giorno e notte.", "Le nuvole": "Le nuvole non causano il ciclo giorno-notte: sono un fenomeno atmosferico locale e variabile.", "La Luna che si sposta": "Il movimento della Luna non causa il ciclo giorno-notte sulla Terra: è la rotazione terrestre a farlo." } },
  { topic: "terra-universo", difficulty: 4, prompt: "Cosa provoca soprattutto l'alternarsi delle stagioni?", answer: "L'inclinazione della Terra mentre gira intorno al Sole", distractors: ["La distanza che cambia dalla Luna", "Il vento che soffia da nord per tutto l'anno", "Le maree provocate dalla Luna"], explanation: "L'asse inclinato fa arrivare i raggi del Sole più o meno diretti nei vari periodi dell'anno.",
    distractorWhy: { "La distanza che cambia dalla Luna": "La distanza dalla Luna non ha un ruolo significativo nelle stagioni: conta l'inclinazione dell'asse terrestre rispetto al Sole.", "Il vento che soffia da nord per tutto l'anno": "Il vento non soffia sempre da nord, e comunque non è la causa delle stagioni.", "Le maree provocate dalla Luna": "Le maree sono un fenomeno diverso, legato all'attrazione gravitazionale, non alle stagioni." } },
  ...
  { topic: "ambiente", difficulty: 1, prompt: "Cosa dovremmo fare con carta, plastica e vetro per aiutare l'ambiente?", answer: "Fare la raccolta differenziata", distractors: ["Buttarli tutti nello stesso sacco", "Bruciarli nel cortile di casa", "Lasciarli per terra dove capita"], explanation: "Separare i rifiuti permette di riciclarli e sprecare meno risorse.",
    distractorWhy: { "Buttarli tutti nello stesso sacco": "Mescolare i rifiuti rende difficile o impossibile riciclarli correttamente.", "Bruciarli nel cortile di casa": "Bruciare i rifiuti in modo incontrollato produce inquinamento pericoloso.", "Lasciarli per terra dove capita": "Abbandonare i rifiuti danneggia l'ambiente invece di aiutarlo." } },
  { topic: "ambiente", difficulty: 2, prompt: "Perché è importante non sprecare l'acqua?", answer: "È una risorsa preziosa e limitata", distractors: ["Perché è pesante da trasportare", "Perché è di colore trasparente", "Non è importante, ce n'è tanta"], explanation: "L'acqua dolce pulita è limitata: va usata con attenzione.",
    distractorWhy: { "Perché è pesante da trasportare": "Il peso non è il motivo per cui risparmiare acqua: è la sua scarsità come risorsa.", "Perché è di colore trasparente": "Il colore dell'acqua non ha nulla a che fare con l'importanza di non sprecarla.", "Non è importante, ce n'è tanta": "È il contrario: l'acqua dolce pulita è una risorsa limitata e preziosa." } },
  { topic: "ambiente", difficulty: 3, prompt: "Come si chiama l'aumento della temperatura del pianeta legato anche ai gas prodotti dall'uomo?", answer: "Riscaldamento globale", distractors: ["Effetto arcobaleno", "Effetto marea", "Effetto eco"], explanation: "L'eccesso di gas serra trattiene più calore e riscalda il pianeta.",
    distractorWhy: { "Effetto arcobaleno": "Non è un termine scientifico legato al riscaldamento del pianeta.", "Effetto marea": "L'effetto marea riguarda l'attrazione gravitazionale della Luna, non il riscaldamento del pianeta.", "Effetto eco": "Non è un termine scientifico legato al riscaldamento del pianeta." } },
  ...
  { topic: "ambiente", difficulty: 1, prompt: "Perché ridurre i rifiuti conta più che riciclarli?", answer: "Perché un rifiuto che non nasce non va nemmeno trattato", distractors: ["Perché il riciclo funziona bene soltanto con la carta e il vetro", "Perché i rifiuti riciclati costano di più di quelli nuovi", "Perché riciclare è vietato per la maggior parte dei materiali"], explanation: "Riciclare consuma energia e acqua: meglio non produrre l'oggetto inutile.",
    distractorWhy: { "Perché il riciclo funziona bene soltanto con la carta e il vetro": "Il riciclo funziona anche con molti altri materiali: non è questo il motivo per preferire la riduzione.", "Perché i rifiuti riciclati costano di più di quelli nuovi": "Il costo economico non è il punto: ridurre evita del tutto il consumo di energia e risorse per il trattamento.", "Perché riciclare è vietato per la maggior parte dei materiali": "Il riciclo non è vietato: è consentito e incoraggiato per molti materiali, ma la riduzione resta preferibile." } },
  { topic: "viventi", difficulty: 1, prompt: "Che cosa distingue un essere vivente da un sasso?", answer: "Si nutre, cresce e può riprodursi", distractors: ["Si muove da solo da un posto all'altro durante il giorno", "Ha una forma che resta uguale per tutta la sua esistenza", "È fatto di materia, mentre il sasso non lo è affatto"], explanation: "Le piante non camminano e certi organismi non respirano ossigeno: il resto vale per tutti.",
    distractorWhy: { "Si muove da solo da un posto all'altro durante il giorno": "Le piante sono viventi ma non si spostano da sole: il movimento non è il criterio giusto.", "Ha una forma che resta uguale per tutta la sua esistenza": "Gli esseri viventi cambiano forma crescendo: non è la forma costante a distinguerli da un sasso.", "È fatto di materia, mentre il sasso non lo è affatto": "Anche il sasso è fatto di materia: la differenza è che il vivente si nutre, cresce e si riproduce." } },
  { topic: "corpo", difficulty: 1, prompt: "Perché è importante lavarsi le mani prima di mangiare?", answer: "Perché sulle mani restano microbi che finirebbero nel cibo", distractors: ["Perché le mani sporche rendono il cibo più difficile da masticare", "Perché l'acqua fredda sulle mani aiuta lo stomaco a digerire", "Perché è una regola di buona educazione senza effetti sulla salute"], explanation: "Gran parte delle infezioni intestinali passa proprio dalle mani.",
    distractorWhy: { "Perché le mani sporche rendono il cibo più difficile da masticare": "Lo sporco sulle mani non influenza la masticazione: il problema reale sono i microbi trasferiti al cibo.", "Perché l'acqua fredda sulle mani aiuta lo stomaco a digerire": "L'acqua sulle mani non ha alcun effetto sulla digestione nello stomaco.", "Perché è una regola di buona educazione senza effetti sulla salute": "Ha effetti concreti sulla salute: previene il passaggio di microbi nel cibo, non è solo educazione." } },
  { topic: "ecosistema", difficulty: 1, prompt: "Che cosa succede a un ecosistema se sparisce una sola specie?", answer: "Cambiano anche le specie collegate a quella", distractors: ["Non cambia niente, perché ogni specie vive per conto suo", "Sparisce subito tutto l'ecosistema nel giro di pochi giorni", "Le altre specie diventano automaticamente più numerose e forti"], explanation: "Gli anelli sono legati: togliendone uno la catena si riorganizza, a volte male.",
    distractorWhy: { "Non cambia niente, perché ogni specie vive per conto suo": "Le specie sono collegate fra loro in una rete: nessuna vive completamente isolata dalle altre.", "Sparisce subito tutto l'ecosistema nel giro di pochi giorni": "Un ecosistema di solito si riorganizza gradualmente, non sparisce interamente in pochi giorni.", "Le altre specie diventano automaticamente più numerose e forti": "Non tutte diventano più numerose: alcune, dipendenti dalla specie scomparsa, ne soffrono." } },
  { topic: "energia", difficulty: 1, prompt: "Perché il Sole è la fonte di quasi tutta l'energia sulla Terra?", answer: "Perché le piante ne catturano la luce e la passano a tutti gli altri", distractors: ["Perché scalda direttamente il corpo di ogni animale del pianeta", "Perché è l'unico corpo celeste visibile durante tutto il giorno", "Perché la sua luce si trasforma da sola in elettricità nell'aria"], explanation: "Anche il carbone e il petrolio sono luce solare immagazzinata milioni di anni fa.",
    distractorWhy: { "Perché scalda direttamente il corpo di ogni animale del pianeta": "Il Sole non scalda direttamente ogni animale: l'energia passa attraverso le piante e la catena alimentare.", "Perché è l'unico corpo celeste visibile durante tutto il giorno": "La visibilità del Sole di giorno non spiega perché sia la fonte di quasi tutta l'energia sulla Terra.", "Perché la sua luce si trasforma da sola in elettricità nell'aria": "La luce solare non si trasforma spontaneamente in elettricità nell'aria: servono pannelli solari o altri processi." } },
  { topic: "materia", difficulty: 1, prompt: "Perché lo zucchero sparisce alla vista quando lo sciogli nell'acqua?", answer: "Perché si divide in parti troppo piccole da vedere, ma resta lì", distractors: ["Perché si trasforma in acqua e smette del tutto di esistere", "Perché evapora subito appena entra in contatto con il liquido", "Perché scende sul fondo e si nasconde sotto lo strato d'acqua"], explanation: "L'acqua diventa dolce: la prova che lo zucchero c'è ancora.",
    distractorWhy: { "Perché si trasforma in acqua e smette del tutto di esistere": "Lo zucchero non smette di esistere: resta disciolto, come dimostra il sapore dolce dell'acqua.", "Perché evapora subito appena entra in contatto con il liquido": "Lo zucchero non evapora: si scioglie, restando presente nell'acqua in particelle minuscole.", "Perché scende sul fondo e si nasconde sotto lo strato d'acqua": "Se fosse solo depositato sul fondo, si potrebbe vedere o filtrare: invece è disciolto uniformemente." } },
];
...
const STORIA_CORE = [
  ...
  { topic: "civilta", difficulty: 1, prompt: "Che cosa hanno in comune le prime grandi civiltà?", answer: "Sono nate vicino a grandi fiumi", distractors: ["Sono nate in cima alle montagne","Sono nate lontano dall'acqua","Sono nate tutte nello stesso anno"], explanation: "Nilo, Tigri, Eufrate, Indo, Fiume Giallo: l'acqua permetteva di coltivare e di spostarsi.",
    distractorWhy: { "Sono nate in cima alle montagne": "Le montagne non offrivano acqua regolare per irrigare i campi: le civiltà nascono lungo i fiumi in pianura.", "Sono nate lontano dall'acqua": "È il contrario: senza acqua vicina non si poteva coltivare né trasportare merci.", "Sono nate tutte nello stesso anno": "Sono nate in epoche diverse, anche a distanza di secoli l'una dall'altra." } },
  { topic: "civilta", difficulty: 2, prompt: "Quale invenzione segna il passaggio dalla preistoria alla storia?", answer: "La scrittura", distractors: ["La ruota","Il fuoco","L'agricoltura"], explanation: "Con la scrittura gli uomini cominciano a lasciare documenti: da lì possiamo leggere il loro racconto.",
    distractorWhy: { "La ruota": "La ruota fu importante per i trasporti, ma non segna il confine fra preistoria e storia.", "Il fuoco": "Il fuoco è una scoperta molto più antica, della preistoria stessa, non il segno del suo passaggio alla storia.", "L'agricoltura": "L'agricoltura segna il Neolitico, ma è la scrittura, arrivata dopo, a segnare l'inizio della storia." } },
  { topic: "civilta", difficulty: 2, prompt: "In quale zona nacquero Sumeri e Babilonesi?", answer: "Mesopotamia", distractors: ["Valle del Nilo","Penisola italiana","Isola di Creta"], explanation: "Mesopotamia significa «terra fra i fiumi»: Tigri ed Eufrate, l'attuale Iraq.",
    distractorWhy: { "Valle del Nilo": "La valle del Nilo è la culla della civiltà egizia, non di Sumeri e Babilonesi.", "Penisola italiana": "La penisola italiana è dove nacque la civiltà romana, non quella sumera o babilonese.", "Isola di Creta": "Creta è dove nacque la civiltà minoica, non quella sumera o babilonese." } },
  { topic: "civilta", difficulty: 3, prompt: "Perché la nascita dell'agricoltura cambiò tutto?", answer: "Perché permise di restare fermi in un luogo", distractors: ["Perché rese il cibo molto più saporito","Perché portò a scoprire i primi metalli","Perché richiedeva molte meno persone"], explanation: "Chi coltiva resta: nascono i villaggi, le case stabili, le proprietà e i primi conflitti su di esse.",
    distractorWhy: { "Perché rese il cibo molto più saporito": "Il sapore del cibo non è il motivo storico del cambiamento: è la possibilità di restare stanziali.", "Perché portò a scoprire i primi metalli": "I metalli vengono lavorati in un'epoca successiva, non è l'agricoltura a portarli direttamente.", "Perché richiedeva molte meno persone": "L'agricoltura richiedeva lavoro organizzato, non meno persone: è il fatto di poter restare fermi a cambiare tutto." } },
  { topic: "civilta", difficulty: 3, prompt: "A cosa servivano i primi segni di scrittura in Mesopotamia?", answer: "A registrare merci e magazzini", distractors: ["A scrivere poesie e canzoni","A raccontare le guerre vinte","A insegnare ai bambini a leggere"], explanation: "La scrittura nasce come contabilità: quante pecore, quanto grano, di chi. La letteratura arriva molto dopo.",
    distractorWhy: { "A scrivere poesie e canzoni": "La letteratura arriva molto dopo: i primi segni servivano a contare beni, non a comporre poesie.", "A raccontare le guerre vinte": "I racconti di guerra sono un uso successivo della scrittura, non il suo scopo iniziale.", "A insegnare ai bambini a leggere": "L'istruzione di massa non esisteva ancora: la scrittura nacque per la contabilità dei magazzini." } },
  { topic: "civilta", difficulty: 3, prompt: "Che cos'era il codice di Hammurabi?", answer: "Una raccolta di leggi scritte", distractors: ["Un manuale di costruzione","Un elenco di divinità babilonesi","Un trattato di pace fra regni"], explanation: "Scrivere le leggi significa renderle uguali per tutti e non modificabili a piacere: è un passo enorme.",
    distractorWhy: { "Un manuale di costruzione": "Non insegna a costruire nulla: raccoglie norme giuridiche, cioè leggi.", "Un elenco di divinità babilonesi": "Non elenca gli dèi: stabilisce regole di comportamento e punizioni.", "Un trattato di pace fra regni": "Non è un accordo fra Stati: è un insieme di leggi interne al regno." } },
  { topic: "civilta", difficulty: 4, prompt: "Perché la ruota fu importante quanto l'aratro?", answer: "Perché permise di trasportare pesi lontano", distractors: ["Perché rese più belle le città","Perché serviva a costruire i templi","Perché sostituì la forza animale"], explanation: "Coltivare di più serve a poco se non puoi spostare il raccolto: produzione e trasporto crescono insieme.",
    distractorWhy: { "Perché rese più belle le città": "L'estetica delle città non è il motivo storico della sua importanza: conta il trasporto di merci.", "Perché serviva a costruire i templi": "I templi si costruivano soprattutto con altre tecniche: la ruota serviva soprattutto al trasporto.", "Perché sostituì la forza animale": "La ruota non sostituisce la forza animale: anzi, spesso viene trainata proprio da animali." } },
  { topic: "civilta", difficulty: 2, prompt: "Quale civiltà antica si sviluppò lungo il fiume Indo?", answer: "La civiltà della valle dell'Indo", distractors: ["La civiltà cinese degli Shang","La civiltà egizia del Nilo","La civiltà minoica di Creta"], explanation: "Città come Mohenjo-daro avevano strade regolari e fognature: erano pianificate, non cresciute a caso.",
    distractorWhy: { "La civiltà cinese degli Shang": "Gli Shang si svilupparono lungo il Fiume Giallo in Cina, non lungo l'Indo.", "La civiltà egizia del Nilo": "La civiltà egizia si sviluppò lungo il Nilo, non lungo l'Indo.", "La civiltà minoica di Creta": "La civiltà minoica si sviluppò sull'isola di Creta, non lungo l'Indo." } },
  { topic: "civilta", difficulty: 4, prompt: "Che cos'è una civiltà, in senso storico?", answer: "Una società con città, scrittura e organizzazione", distractors: ["Un popolo che vive in modo educato","Un gruppo che possiede molte ricchezze","Una popolazione numerosa e in crescita"], explanation: "Non è un giudizio di valore: è un insieme di caratteristiche osservabili, come vivere in città e amministrare per iscritto.",
    distractorWhy: { "Un popolo che vive in modo educato": "Non è un giudizio morale sui comportamenti: è una definizione basata su caratteristiche osservabili come città e scrittura.", "Un gruppo che possiede molte ricchezze": "La ricchezza da sola non definisce una civiltà: serve organizzazione, città e scrittura.", "Una popolazione numerosa e in crescita": "Il numero di abitanti da solo non basta: conta l'organizzazione sociale e la scrittura." } },
  { topic: "civilta", difficulty: 3, prompt: "Perché le prime città avevano bisogno di magazzini?", answer: "Per conservare il cibo e superare le carestie", distractors: ["Per esporre gli oggetti più preziosi","Per ospitare i viaggiatori di passaggio","Per tenerci gli strumenti dei contadini"], explanation: "Un raccolto abbondante serve a poco se marcisce: chi sa conservare sopravvive agli anni cattivi.",
    distractorWhy: { "Per esporre gli oggetti più preziosi": "Quello sarebbe un tesoro o un museo: i magazzini servivano a conservare il cibo, non a esporre oggetti.", "Per ospitare i viaggiatori di passaggio": "Ospitare persone è compito di un alloggio, non di un magazzino per derrate.", "Per tenerci gli strumenti dei contadini": "Gli attrezzi si conservavano altrove: i magazzini servivano soprattutto per il raccolto." } },
  { topic: "civilta", difficulty: 4, prompt: "Perché nelle prime civiltà nacquero classi sociali diverse?", answer: "Perché non tutti dovevano più produrre cibo", distractors: ["Perché alcuni erano più intelligenti","Perché lo imponevano le divinità","Perché il territorio era troppo grande"], explanation: "Con un surplus agricolo qualcuno può fare altro: il sacerdote, lo scriba, il soldato. Da lì nascono le differenze.",
    distractorWhy: { "Perché alcuni erano più intelligenti": "Non è una differenza di intelligenza: è la disponibilità di cibo in eccesso a liberare alcuni dal lavoro agricolo.", "Perché lo imponevano le divinità": "Non è imposto dalla religione: è una conseguenza economica del surplus di cibo prodotto.", "Perché il territorio era troppo grande": "La dimensione del territorio non spiega la nascita delle classi sociali: conta il surplus di cibo prodotto." } },
  { topic: "civilta", difficulty: 2, prompt: "Che cosa sono le ziggurat mesopotamiche?", answer: "Templi a gradoni dedicati alle divinità", distractors: ["Tombe reali sotterranee","Mura di difesa delle città","Magazzini per conservare il grano"], explanation: "Salivano verso il cielo perché lì si pensava abitassero gli dèi: la religione era al centro della città.",
    distractorWhy: { "Tombe reali sotterranee": "Le ziggurat si innalzano verso il cielo, non scendono sottoterra come le tombe.", "Mura di difesa delle città": "Le ziggurat non servivano a difendersi: erano edifici religiosi dedicati agli dèi.", "Magazzini per conservare il grano": "Le ziggurat erano templi, non depositi per il cibo." } },
  { topic: "civilta", difficulty: 3, prompt: "Perché il bronzo cambiò la vita delle prime civiltà?", answer: "Perché diede attrezzi e armi più resistenti", distractors: ["Perché era più bello da guardare dell'oro","Perché si trovava dappertutto in natura","Perché era leggerissimo da trasportare"], explanation: "Il bronzo è più duro del rame puro. E poiché serve lo stagno, spesso lontano, nascono le grandi rotte commerciali.",
    distractorWhy: { "Perché era più bello da guardare dell'oro": "L'estetica non è il motivo storico: conta la maggiore resistenza rispetto al rame puro.", "Perché si trovava dappertutto in natura": "È il contrario: lo stagno per farlo era spesso raro e lontano, e questo spinse i commerci.", "Perché era leggerissimo da trasportare": "Il peso non è il punto: conta la maggiore durezza e resistenza degli attrezzi." } },
  { topic: "civilta", difficulty: 4, prompt: "Perché la scrittura cuneiforme si chiama così?", answer: "Perché i segni hanno forma di cuneo", distractors: ["Perché veniva incisa sui cunei di legno","Perché la inventò un popolo detto cuneo","Perché si leggeva partendo da un angolo"], explanation: "Si imprimeva su tavolette d'argilla morbida con uno stilo a punta triangolare: ogni segno resta a forma di chiodo.",
    distractorWhy: { "Perché veniva incisa sui cunei di legno": "Non si incideva sul legno: si imprimeva sull'argilla morbida con uno stilo a punta triangolare.", "Perché la inventò un popolo detto cuneo": "Non esiste un popolo chiamato «cuneo»: il nome viene dalla forma dei segni stessi.", "Perché si leggeva partendo da un angolo": "Il nome non riguarda la direzione di lettura, ma la forma a cuneo di ogni singolo segno." } },
  { topic: "egizi", difficulty: 2, prompt: "Perché il Nilo era essenziale per gli Egizi?", answer: "Perché le sue piene rendevano fertile la terra", distractors: ["Perché conteneva molti pesci pregiati","Perché segnava il confine con i nemici","Perché era l'unica via per il deserto"], explanation: "Ogni anno la piena depositava limo: senza quel fango il deserto sarebbe arrivato fino alle case.",
    distractorWhy: { "Perché conteneva molti pesci pregiati": "La pesca era un'attività secondaria: l'essenziale era il limo fertile lasciato dalle piene.", "Perché segnava il confine con i nemici": "Il Nilo non era usato come confine militare: era la fonte di fertilità dei campi.", "Perché era l'unica via per il deserto": "Il Nilo era una via d'acqua fertile, non una strada verso il deserto." } },
  { topic: "egizi", difficulty: 2, prompt: "Come si chiamava la scrittura sacra degli Egizi?", answer: "Geroglifica", distractors: ["Cuneiforme","Alfabetica","Ideografica cinese"], explanation: "Geroglifico significa «incisione sacra»: si usava sui monumenti e nei testi religiosi.",
    distractorWhy: { "Cuneiforme": "La scrittura cuneiforme è quella dei Sumeri e dei Babilonesi, non degli Egizi.", "Alfabetica": "La scrittura geroglifica non è un semplice alfabeto: usa segni-disegno, non solo lettere.", "Ideografica cinese": "La scrittura cinese è un sistema diverso, sviluppato in un'altra civiltà." } },
  { topic: "egizi", difficulty: 3, prompt: "A che cosa servivano le piramidi?", answer: "Erano tombe monumentali dei faraoni", distractors: ["Erano templi per le cerimonie","Erano magazzini per il grano","Erano fortezze contro i nemici"], explanation: "Servivano a proteggere il corpo e il corredo del faraone per la vita dopo la morte.",
    distractorWhy: { "Erano templi per le cerimonie": "Le cerimonie religiose avvenivano in templi separati: le piramidi erano tombe.", "Erano magazzini per il grano": "Il grano si conservava in magazzini separati, non nelle piramidi.", "Erano fortezze contro i nemici": "Le piramidi non avevano funzione difensiva: erano monumenti funebri." } },
  { topic: "egizi", difficulty: 3, prompt: "Perché gli Egizi praticavano la mummificazione?", answer: "Per conservare il corpo per l'aldilà", distractors: ["Per evitare il diffondersi di malattie","Per riconoscere i defunti importanti","Per risparmiare spazio nelle tombe"], explanation: "Credevano che l'anima avesse bisogno del corpo per continuare a esistere: conservarlo era un atto religioso.",
    distractorWhy: { "Per evitare il diffondersi di malattie": "Non era una pratica igienica: era un rito religioso legato alla vita dopo la morte.", "Per riconoscere i defunti importanti": "Il riconoscimento non era lo scopo: era conservare il corpo per l'aldilà.", "Per risparmiare spazio nelle tombe": "Una mummia richiede comunque spazio e cura: lo scopo era religioso, non pratico." } },
  { topic: "egizi", difficulty: 4, prompt: "Che cos'è la stele di Rosetta?", answer: "Una pietra con lo stesso testo in tre scritture", distractors: ["Il primo calendario egizio conosciuto","Una lastra con le leggi del faraone","La mappa del corso completo del Nilo"], explanation: "Avendo lo stesso testo in greco e in egizio, permise finalmente di decifrare i geroglifici.",
    distractorWhy: { "Il primo calendario egizio conosciuto": "Non è un calendario: è una pietra con lo stesso testo scritto in tre scritture diverse.", "Una lastra con le leggi del faraone": "Non contiene leggi: contiene lo stesso testo in tre scritture, utile per decifrare i geroglifici.", "La mappa del corso completo del Nilo": "Non è una mappa geografica: è un testo trilingue inciso su pietra." } },
  { topic: "egizi", difficulty: 3, prompt: "Chi era il faraone per gli antichi Egizi?", answer: "Un sovrano considerato anche divino", distractors: ["Il capo dell'esercito eletto ogni anno","Il sacerdote più anziano del tempio","Il proprietario di tutte le terre coltivate"], explanation: "Non era solo un re: era il legame fra gli dèi e gli uomini, e questo giustificava il suo potere assoluto.",
    distractorWhy: { "Il capo dell'esercito eletto ogni anno": "Il faraone non veniva eletto ogni anno: il suo potere era ereditario e considerato divino.", "Il sacerdote più anziano del tempio": "Il faraone non era semplicemente il sacerdote più anziano: era considerato lui stesso divino.", "Il proprietario di tutte le terre coltivate": "Questo descrive un aspetto economico, ma non coglie il suo ruolo religioso di legame fra dèi e uomini." } },
  { topic: "egizi", difficulty: 4, prompt: "Perché gli Egizi svilupparono la geometria?", answer: "Per ridisegnare i campi dopo ogni piena", distractors: ["Per decorare meglio i loro templi","Per contare le tasse dei mercanti","Per orientare le navi sul fiume"], explanation: "La piena cancellava i confini dei terreni ogni anno: bisognava misurarli di nuovo, e da lì nasce la «misura della terra».",
    distractorWhy: { "Per decorare meglio i loro templi": "La decorazione non richiedeva calcoli geometrici precisi come quelli per ridefinire i confini dei campi.", "Per contare le tasse dei mercanti": "Le tasse si calcolavano con l'aritmetica, non con la geometria dei terreni.", "Per orientare le navi sul fiume": "La navigazione non richiedeva la geometria dei campi: nasce dalla necessità di ridisegnare i confini dopo le piene." } },
  { topic: "egizi", difficulty: 2, prompt: "Su quale materiale scrivevano principalmente gli Egizi?", answer: "Papiro", distractors: ["Tavolette d'argilla","Pergamena di pelle","Tavolette di cera"], explanation: "Il papiro si ricavava da una pianta che cresceva lungo il Nilo: leggero, arrotolabile, ed è la radice della parola «carta».",
    distractorWhy: { "Tavolette d'argilla": "Le tavolette d'argilla erano usate in Mesopotamia, non principalmente in Egitto.", "Pergamena di pelle": "La pergamena si diffonde altrove e più tardi: gli Egizi usavano il papiro, ricavato da una pianta.", "Tavolette di cera": "Le tavolette di cera erano usate nel mondo greco-romano, non come materiale principale degli Egizi." } },
  { topic: "metodo", difficulty: 3, prompt: "Che cosa vuol dire contestualizzare una fonte?", answer: "Capire in che epoca e situazione è nata", distractors: ["Tradurla nella lingua di oggi","Riassumerla nei suoi punti chiave","Confrontarla con il libro di testo"], explanation: "Una frase può cambiare senso a seconda di chi la dice, quando e a chi: senza contesto si legge male.",
    distractorWhy: { "Tradurla nella lingua di oggi": "La traduzione linguistica non basta a capire il contesto storico in cui è nata.", "Riassumerla nei suoi punti chiave": "Riassumere non spiega l'epoca e la situazione: quello è contestualizzare.", "Confrontarla con il libro di testo": "Il libro di testo è un'altra fonte, secondaria: contestualizzare significa capire l'epoca originale." } },
  { topic: "metodo", difficulty: 4, prompt: "Uno storico trova un solo documento su un fatto. Cosa può concludere?", answer: "Una ricostruzione provvisoria, da verificare", distractors: ["Una verità certa, perché è scritta","Che il fatto non è mai avvenuto","Che il documento è sicuramente falso"], explanation: "Una fonte sola può bastare a formulare un'ipotesi, non a chiuderla: serve incrocio con altre testimonianze.",
    distractorWhy: { "Una verità certa, perché è scritta": "Essere scritta non garantisce che sia vera: serve sempre l'incrocio con altre fonti.", "Che il fatto non è mai avvenuto": "Un solo documento non basta a negare un fatto: serve prudenza, non una conclusione negativa affrettata.", "Che il documento è sicuramente falso": "Non c'è motivo di presumere che sia falso solo perché è l'unico trovato." } },
  { topic: "metodo", difficulty: 3, prompt: "Perché si dice che la storia si riscrive?", answer: "Perché nuove fonti cambiano le ricostruzioni", distractors: ["Perché ogni epoca inventa il suo passato","Perché gli storici non sono mai d'accordo","Perché i libri vanno aggiornati per legge"], explanation: "Non cambiano i fatti: cambia quello che sappiamo. Uno scavo nuovo può ribaltare una certezza di cent'anni.",
    distractorWhy: { "Perché ogni epoca inventa il suo passato": "Non si tratta di inventare: le ricostruzioni cambiano quando emergono nuove fonti verificabili.", "Perché gli storici non sono mai d'accordo": "Il disaccordo esiste, ma il motivo principale della riscrittura è la scoperta di nuove fonti.", "Perché i libri vanno aggiornati per legge": "Non è un obbligo legale: è la scienza storica che si aggiorna con nuove prove." } },
  { topic: "metodo", difficulty: 4, prompt: "Che cos'è un anacronismo?", answer: "Attribuire a un'epoca qualcosa che non aveva", distractors: ["Confondere due date molto vicine","Raccontare i fatti in ordine sbagliato","Usare una fonte non affidabile"], explanation: "Un romano con l'orologio da polso è un anacronismo evidente; giudicarne le scelte con la nostra morale è un anacronismo più sottile.",
    distractorWhy: { "Confondere due date molto vicine": "Questo è un semplice errore cronologico, non l'attribuzione di qualcosa che l'epoca non aveva.", "Raccontare i fatti in ordine sbagliato": "L'ordine dei fatti è un altro tipo di errore: l'anacronismo riguarda cose fuori dal loro tempo.", "Usare una fonte non affidabile": "L'affidabilità della fonte è un problema diverso dall'anacronismo, che riguarda il tempo storico." } },
  { topic: "metodo", difficulty: 3, prompt: "Perché lo storico deve dichiarare le proprie fonti?", answer: "Perché altri possano controllare il lavoro", distractors: ["Perché è una regola di cortesia fra studiosi","Perché così il testo risulta più lungo","Perché lo impongono i regolamenti degli archivi"], explanation: "Una ricostruzione senza fonti dichiarate non è verificabile, e ciò che non si può controllare non si può correggere.",
    distractorWhy: { "Perché è una regola di cortesia fra studiosi": "Non è solo cortesia: è necessario per la verificabilità scientifica del lavoro.", "Perché così il testo risulta più lungo": "La lunghezza del testo non è lo scopo: lo scopo è permettere il controllo del lavoro.", "Perché lo impongono i regolamenti degli archivi": "Non è un obbligo burocratico: è un principio del metodo storico stesso." } },
  { topic: "metodo", difficulty: 4, prompt: "Che differenza c'è fra un fatto e un'interpretazione?", answer: "Il fatto è accaduto, l'interpretazione lo spiega", distractors: ["Il fatto è antico, l'interpretazione recente","Il fatto è scritto, l'interpretazione è orale","Non c'è differenza, sono sinonimi"], explanation: "Che Roma sia caduta nel 476 è un fatto; perché sia caduta è interpretazione, e su quella gli storici discutono ancora.",
    distractorWhy: { "Il fatto è antico, l'interpretazione recente": "Anche fatti recenti hanno interpretazioni diverse: non è una questione di età.", "Il fatto è scritto, l'interpretazione è orale": "Entrambi possono essere scritti o orali: la differenza è che uno è accaduto e l'altra lo spiega.", "Non c'è differenza, sono sinonimi": "Sono concetti diversi: il fatto è oggettivo, l'interpretazione è una spiegazione soggetta a discussione." } },
  { topic: "metodo", difficulty: 3, prompt: "Perché è utile studiare anche la storia della gente comune?", answer: "Perché racconta come si viveva davvero", distractors: ["Perché è più facile da ricostruire","Perché ci sono più fonti disponibili","Perché i re non lasciano documenti"], explanation: "La storia dei soli sovrani spiega le decisioni, non la vita: il cibo, il lavoro e le case dicono il resto.",
    distractorWhy: { "Perché è più facile da ricostruire": "È spesso più difficile, non più facile: la gente comune lasciava meno documenti dei sovrani.", "Perché ci sono più fonti disponibili": "Di solito ci sono meno fonti sulla gente comune rispetto ai sovrani: il valore sta nel raccontare la vita reale.", "Perché i re non lasciano documenti": "È il contrario: i re e le corti lasciavano spesso più documenti della gente comune." } },
  { topic: "preistoria", difficulty: 2, prompt: "Perché il periodo prima della scrittura si chiama preistoria?", answer: "Perché mancano documenti scritti da studiare", distractors: ["Perché gli uomini non pensavano ancora","Perché non era ancora nata l'agricoltura","Perché non esistevano ancora le città"], explanation: "Lo studiamo solo con le fonti materiali: ossa, strumenti, pitture. Nessuno ci ha lasciato il proprio racconto.",
    distractorWhy: { "Perché gli uomini non pensavano ancora": "Gli uomini preistorici pensavano e comunicavano: mancava solo la scrittura, non il pensiero.", "Perché non era ancora nata l'agricoltura": "L'agricoltura nasce nel Neolitico, ma già lì manca ancora la scrittura: il confine è la scrittura, non l'agricoltura.", "Perché non esistevano ancora le città": "Alcune prime città nascono prima della scrittura diffusa: il confine storico è segnato dalla scrittura." } },
  { topic: "preistoria", difficulty: 2, prompt: "Quale scoperta permise all'uomo preistorico di cuocere e riscaldarsi?", answer: "Il fuoco", distractors: ["La ruota","L'arco","Il bronzo"], explanation: "Il fuoco allunga la giornata, rende il cibo digeribile e tiene lontani gli animali: cambia tutto.",
    distractorWhy: { "La ruota": "La ruota serve al trasporto, non a cuocere il cibo o a riscaldarsi.", "L'arco": "L'arco serve alla caccia, non a cuocere il cibo o a riscaldarsi.", "Il bronzo": "Il bronzo dà attrezzi migliori, ma non è ciò che permette di cuocere e riscaldarsi." } },
  { topic: "preistoria", difficulty: 3, prompt: "Che cosa distingue il Paleolitico dal Neolitico?", answer: "Nel Neolitico nascono agricoltura e allevamento", distractors: ["Nel Neolitico si scopre l'uso del fuoco","Nel Paleolitico si vive già nelle città","Nel Paleolitico si lavora già il ferro"], explanation: "Paleolitico significa «pietra antica»: si caccia e si raccoglie. Nel Neolitico si produce il cibo, e si diventa stanziali.",
    distractorWhy: { "Nel Neolitico si scopre l'uso del fuoco": "Il fuoco è già usato nel Paleolitico, molto prima del Neolitico.", "Nel Paleolitico si vive già nelle città": "Le città nascono più tardi, dopo che l'agricoltura del Neolitico rende possibile restare stanziali.", "Nel Paleolitico si lavora già il ferro": "Il ferro si lavora in un'epoca molto successiva, non nel Paleolitico." } },
  { topic: "preistoria", difficulty: 3, prompt: "Perché gli uomini del Paleolitico erano nomadi?", answer: "Perché seguivano gli animali e le stagioni", distractors: ["Perché temevano le altre tribù","Perché cercavano metalli preziosi","Perché il clima era sempre uguale"], explanation: "Chi vive di caccia e raccolta deve spostarsi dove c'è cibo: restare fermi diventa possibile solo coltivando.",
    distractorWhy: { "Perché temevano le altre tribù": "La paura di altri gruppi non è il motivo principale: era la ricerca di cibo a imporre gli spostamenti.", "Perché cercavano metalli preziosi": "La ricerca di metalli è un'attività di epoche successive, non del Paleolitico nomade.", "Perché il clima era sempre uguale": "È il contrario: il cambio di stagioni spingeva a seguire gli animali e le risorse disponibili." } },
  { topic: "preistoria", difficulty: 4, prompt: "A che cosa servivano probabilmente le pitture rupestri?", answer: "Avevano un valore rituale e simbolico", distractors: ["A decorare le pareti delle case","A insegnare a disegnare ai bambini","A segnare i confini fra i gruppi"], explanation: "Stanno spesso in grotte profonde e scomode, non nei luoghi in cui si viveva: la spiegazione decorativa non basta.",
    distractorWhy: { "A decorare le pareti delle case": "Le pitture stanno spesso in grotte profonde e scomode, non nei luoghi dove si viveva davvero.", "A insegnare a disegnare ai bambini": "Non c'è prova di uno scopo didattico: la posizione nascosta suggerisce un valore rituale.", "A segnare i confini fra i gruppi": "I confini si segnano di solito in luoghi visibili, non in grotte profonde e nascoste." } },
  { topic: "preistoria", difficulty: 3, prompt: "Che cos'è un menhir?", answer: "Una grande pietra piantata verticalmente", distractors: ["Una capanna di pietra e paglia","Una tomba scavata nella roccia","Un utensile per lavorare la pelle"], explanation: "Erigerlo richiedeva molte persone coordinate: dice che quei gruppi sapevano organizzarsi per uno scopo comune.",
    distractorWhy: { "Una capanna di pietra e paglia": "Un menhir non è un'abitazione: è una singola grande pietra piantata verticalmente.", "Una tomba scavata nella roccia": "Un menhir non è scavato: è una pietra eretta, non una cavità funeraria.", "Un utensile per lavorare la pelle": "Un menhir è un monumento di grandi dimensioni, non un piccolo attrezzo." } },
  { topic: "preistoria", difficulty: 4, prompt: "Perché la lavorazione dei metalli segna una svolta?", answer: "Perché dà strumenti migliori e nuovi scambi", distractors: ["Perché rende inutile l'agricoltura","Perché fa nascere subito la scrittura","Perché elimina le guerre fra gruppi"], explanation: "Gli attrezzi di metallo durano e tagliano meglio; e poiché i minerali sono in pochi luoghi, nascono commerci a lunga distanza.",
    distractorWhy: { "Perché rende inutile l'agricoltura": "L'agricoltura resta essenziale: i metalli danno solo attrezzi migliori per lavorare, non la sostituiscono.", "Perché fa nascere subito la scrittura": "La scrittura nasce per altre ragioni (la contabilità) e non è una conseguenza diretta e immediata dei metalli.", "Perché elimina le guerre fra gruppi": "I metalli anzi danno anche armi migliori: non eliminano i conflitti." } },
  { topic: "grecia", difficulty: 2, prompt: "Che cos'era una polis greca?", answer: "Una città-stato indipendente", distractors: ["Una piazza per il mercato","Un tempio dedicato agli dèi","Un'assemblea di soli anziani"], explanation: "Ogni polis aveva leggi, monete ed esercito propri: la Grecia era un insieme di città, non uno Stato unico.",
    distractorWhy: { "Una piazza per il mercato": "La piazza (agorà) era una parte della polis, non l'intera città-stato.", "Un tempio dedicato agli dèi": "Il tempio era un edificio religioso dentro la polis, non la città-stato intera.", "Un'assemblea di soli anziani": "L'assemblea era un'istituzione politica della polis, non la polis stessa." } },
  { topic: "grecia", difficulty: 3, prompt: "In quale città nacque la democrazia antica?", answer: "Atene", distractors: ["Sparta","Corinto","Tebe"], explanation: "Ad Atene i cittadini decidevano in assemblea. «Cittadini» però escludeva donne, schiavi e stranieri.",
    distractorWhy: { "Sparta": "Sparta aveva un sistema oligarchico-militare, non la democrazia.", "Corinto": "Corinto era famosa per i commerci, non per aver dato i natali alla democrazia.", "Tebe": "Tebe era un'altra importante polis, ma non è dove nacque la democrazia." } },
  { topic: "grecia", difficulty: 3, prompt: "Che cosa significa la parola «democrazia»?", answer: "Governo del popolo", distractors: ["Governo dei più ricchi","Governo di uno solo","Governo dei sacerdoti"], explanation: "Da «demos» (popolo) e «kratos» (potere). Il nome dice il principio: le decisioni spettano ai cittadini.",
    distractorWhy: { "Governo dei più ricchi": "Il governo dei più ricchi si chiama «oligarchia» o «plutocrazia», non democrazia.", "Governo di uno solo": "Il governo di uno solo si chiama «monarchia» o «tirannide», non democrazia.", "Governo dei sacerdoti": "Il governo dei sacerdoti si chiama «teocrazia», non democrazia." } },
  { topic: "grecia", difficulty: 3, prompt: "Per che cosa era famosa Sparta?", answer: "Per l'educazione militare durissima", distractors: ["Per i suoi teatri e le sue commedie","Per i commerci con tutto il Mediterraneo","Per le scuole di filosofia e matematica"], explanation: "A Sparta il cittadino era prima di tutto un soldato: l'addestramento cominciava da bambini e durava tutta la vita.",
    distractorWhy: { "Per i suoi teatri e le sue commedie": "Il teatro fioriva soprattutto ad Atene, non a Sparta.", "Per i commerci con tutto il Mediterraneo": "Sparta era chiusa e poco commerciale, diversamente da altre città come Corinto.", "Per le scuole di filosofia e matematica": "Le scuole di filosofia fiorivano soprattutto ad Atene, non a Sparta." } },
  { topic: "grecia", difficulty: 4, prompt: "Perché i Greci fondarono colonie nel Mediterraneo?", answer: "Perché la terra coltivabile in patria era poca", distractors: ["Perché volevano conquistare Roma","Perché fuggivano da un'epidemia","Perché cercavano nuovi dèi da adorare"], explanation: "Il territorio greco è montuoso e povero: chi non aveva terra partiva. Così nacque anche la Magna Grecia in Italia.",
    distractorWhy: { "Perché volevano conquistare Roma": "Roma era ancora poco rilevante in quel periodo: le colonie nascevano per necessità di terra, non per conquista militare.", "Perché fuggivano da un'epidemia": "Non ci sono prove di una fuga da epidemie: il motivo principale era la scarsità di terra coltivabile.", "Perché cercavano nuovi dèi da adorare": "I Greci portavano con sé i propri dèi nelle colonie: non partivano per cercarne di nuovi." } },
  { topic: "grecia", difficulty: 3, prompt: "Che cosa erano i Giochi olimpici antichi?", answer: "Gare sportive in onore di Zeus", distractors: ["Battaglie simulate fra due città","Feste per il raccolto dell'anno","Prove per scegliere i governanti"], explanation: "Si tenevano a Olimpia ogni quattro anni, e durante i giochi le guerre fra le poleis venivano sospese.",
    distractorWhy: { "Battaglie simulate fra due città": "Non erano battaglie: erano gare sportive, e anzi durante i giochi le guerre venivano sospese.", "Feste per il raccolto dell'anno": "Non erano legate al raccolto agricolo: erano dedicate a Zeus.", "Prove per scegliere i governanti": "Non servivano a scegliere chi governava: erano competizioni sportive religiose." } },
  { topic: "grecia", difficulty: 4, prompt: "Perché il teatro era importante nella Grecia antica?", answer: "Perché faceva discutere la città sui suoi problemi", distractors: ["Perché serviva solo a far divertire","Perché era riservato ai sacerdoti","Perché sostituiva le assemblee politiche"], explanation: "Le tragedie mettevano in scena giustizia, potere e destino davanti a migliaia di cittadini: era spettacolo e riflessione pubblica.",
    distractorWhy: { "Perché serviva solo a far divertire": "Il teatro greco, soprattutto la tragedia, affrontava temi seri come giustizia e potere, non solo intrattenimento.", "Perché era riservato ai sacerdoti": "Il teatro era aperto a migliaia di cittadini, non riservato ai sacerdoti.", "Perché sostituiva le assemblee politiche": "Il teatro non sostituiva le assemblee: era un luogo diverso di riflessione pubblica, non decisionale." } },
  { topic: "cronologia", difficulty: 3, prompt: "A quale secolo appartiene l'anno 1789?", answer: "XVIII secolo", distractors: ["XVII secolo","XIX secolo","XVI secolo"], explanation: "Gli anni dal 1701 al 1800 formano il XVIII secolo: si prendono le centinaia e si aggiunge uno.",
    distractorWhy: { "XVII secolo": "Il XVII secolo copre gli anni 1601-1700: il 1789 viene dopo.", "XIX secolo": "Il XIX secolo copre gli anni 1801-1900: il 1789 viene prima.", "XVI secolo": "Il XVI secolo copre gli anni 1501-1600: il 1789 è molto più tardi." } },
  { topic: "cronologia", difficulty: 3, prompt: "Quale anno viene prima: 300 a.C. o 100 a.C.?", answer: "300 a.C.", distractors: ["100 a.C.","Sono contemporanei","Non è determinabile"], explanation: "Prima di Cristo si conta all'indietro: più il numero è grande, più l'anno è lontano nel passato.",
    distractorWhy: { "100 a.C.": "Il 100 a.C. è più vicino alla nascita di Cristo: viene dopo il 300 a.C., non prima.", "Sono contemporanei": "Non sono lo stesso anno: fra i due passano duecento anni.", "Non è determinabile": "Si può determinare con certezza: prima di Cristo si conta all'indietro." } },
  ...
  { topic: "cronologia", difficulty: 4, prompt: "In quale secolo si colloca l'anno 1900?", answer: "XIX secolo", distractors: ["XX secolo","XVIII secolo","XXI secolo"], explanation: "Il 1900 chiude il XIX secolo: il XX comincia con il 1901, perché si conta da 1 e non da 0.",
    distractorWhy: { "XX secolo": "Il XX secolo inizia nel 1901, non nel 1900: il conteggio parte da 1, non da 0.", "XVIII secolo": "Il XVIII secolo copre gli anni 1701-1800: il 1900 è molto più tardi.", "XXI secolo": "Il XXI secolo inizia nel 2001: il 1900 è ancora nel secolo precedente." } },
  { topic: "cronologia", difficulty: 3, prompt: "Che cos'è una linea del tempo?", answer: "Uno schema che mette gli eventi in ordine", distractors: ["L'elenco delle date più importanti","Il racconto di un secolo intero","La durata di una singola epoca"], explanation: "Serve a vedere la successione e le distanze: quali fatti sono vicini, quali lontani, cosa è avvenuto insieme.",
    distractorWhy: { "L'elenco delle date più importanti": "Un elenco di date non mostra le distanze e la successione visiva come fa la linea del tempo.", "Il racconto di un secolo intero": "La linea del tempo può coprire periodi diversi, non necessariamente un secolo intero, e non è un racconto ma uno schema.", "La durata di una singola epoca": "La linea del tempo mette in ordine più eventi ed epoche, non misura la durata di una sola." } },
  { topic: "roma", difficulty: 3, prompt: "Chi poteva votare nella Roma repubblicana?", answer: "Solo i cittadini maschi liberi", distractors: ["Tutti gli abitanti della città","Soltanto i senatori e i loro figli","Chiunque avesse prestato servizio"], explanation: "Donne, schiavi e stranieri restavano fuori. E il voto pesava di più per i cittadini più ricchi.",
    distractorWhy: { "Tutti gli abitanti della città": "Donne, schiavi e stranieri erano esclusi dal voto, quindi non tutti gli abitanti potevano votare.", "Soltanto i senatori e i loro figli": "Il diritto di voto era più ampio dei soli senatori: riguardava i cittadini maschi liberi.", "Chiunque avesse prestato servizio": "Il servizio militare non era l'unico requisito: contava essere cittadino maschio libero." } },
  { topic: "roma", difficulty: 3, prompt: "A che cosa serviva una via consolare romana?", answer: "A spostare rapidamente eserciti e merci", distractors: ["A segnare i confini dell'impero","A collegare i templi principali","A far defluire l'acqua piovana"], explanation: "Strade dritte e lastricate significano legioni che arrivano prima: l'impero si teneva insieme anche così.",
    distractorWhy: { "A segnare i confini dell'impero": "I confini si segnavano con altre strutture (come i limes), non con le strade interne.", "A collegare i templi principali": "Le strade collegavano città e province per scopi militari e commerciali, non solo templi.", "A far defluire l'acqua piovana": "Quello era compito delle fognature e degli acquedotti, non delle vie consolari." } },
  { topic: "roma", difficulty: 4, prompt: "Perché la cittadinanza romana era così ambita?", answer: "Perché dava diritti e protezione legale", distractors: ["Perché esentava da qualsiasi tassa","Perché permetteva di non fare il soldato","Perché consentiva di possedere schiavi"], explanation: "Un cittadino non poteva essere condannato senza processo e poteva appellarsi: era una garanzia enorme per l'epoca.",
    distractorWhy: { "Perché esentava da qualsiasi tassa": "La cittadinanza non eliminava le tasse: il suo valore era nei diritti e nella protezione legale.", "Perché permetteva di non fare il soldato": "Il servizio militare restava un dovere per i cittadini: il valore stava nella protezione legale.", "Perché consentiva di possedere schiavi": "Possedere schiavi non era un privilegio riservato ai soli cittadini romani." } },
  { topic: "roma", difficulty: 3, prompt: "Che cos'erano le terme romane?", answer: "Bagni pubblici e luogo di incontro", distractors: ["Palestre riservate ai soldati","Templi dedicati alle divinità dell'acqua","Magazzini per conservare le derrate"], explanation: "Ci si lavava, ma soprattutto si parlava d'affari e di politica: erano il centro della vita sociale.",
    distractorWhy: { "Palestre riservate ai soldati": "Le terme erano aperte a tutti i cittadini, non riservate ai soli soldati.", "Templi dedicati alle divinità dell'acqua": "Le terme erano luoghi di bagno e incontro sociale, non edifici religiosi.", "Magazzini per conservare le derrate": "Le terme non conservavano cibo: erano bagni pubblici e luoghi di socialità." } },
  { topic: "roma", difficulty: 4, prompt: "Perché l'impero romano riuscì a durare secoli?", answer: "Per l'organizzazione di leggi, strade ed esercito", distractors: ["Perché non ebbe mai nemici veri","Perché tutti parlavano la stessa lingua","Perché il territorio era piccolo"], explanation: "Non bastava conquistare: servivano un diritto comune, vie di comunicazione e un esercito stabile per tenere insieme il tutto.",
    distractorWhy: { "Perché non ebbe mai nemici veri": "Roma affrontò molti nemici seri nel corso dei secoli: la sua forza era l'organizzazione, non l'assenza di rivali.", "Perché tutti parlavano la stessa lingua": "L'impero era multilingue: a tenerlo insieme erano leggi, strade ed esercito, non un'unica lingua.", "Perché il territorio era piccolo": "Il territorio dell'impero era enorme, non piccolo: la sua tenuta dipendeva dall'organizzazione." } },
  { topic: "medioevo", difficulty: 3, prompt: "Chi lavorava la terra del feudo?", answer: "I contadini, in gran parte servi della gleba", distractors: ["I soldati del signore quando non combattevano","I monaci che vivevano nei monasteri vicini","Gli abitanti liberi delle città vicine"], explanation: "I servi della gleba erano legati alla terra: non potevano lasciarla, e passavano al signore successivo insieme al campo.",
    distractorWhy: { "I soldati del signore quando non combattevano": "I soldati avevano compiti militari: il lavoro dei campi era affidato ai contadini legati alla terra.", "I monaci che vivevano nei monasteri vicini": "I monaci si dedicavano soprattutto a preghiera e copiatura di libri, non al lavoro dei campi del feudo.", "Gli abitanti liberi delle città vicine": "Gli abitanti delle città erano spesso liberi e non legati al feudo: erano i servi della gleba a lavorare la terra." } },
  { topic: "medioevo", difficulty: 3, prompt: "Che cosa facevano i monaci amanuensi?", answer: "Copiavano a mano i libri antichi", distractors: ["Insegnavano nelle scuole cittadine","Costruivano le grandi cattedrali","Curavano i malati negli ospedali"], explanation: "Prima della stampa ogni copia era scritta a mano: senza quel lavoro paziente molti testi antichi sarebbero andati perduti.",
    distractorWhy: { "Insegnavano nelle scuole cittadine": "L'insegnamento era un'altra attività, non quella specifica degli amanuensi, dedicati a copiare libri.", "Costruivano le grandi cattedrali": "La costruzione era compito di architetti e maestranze, non degli amanuensi.", "Curavano i malati negli ospedali": "La cura dei malati era un'altra attività religiosa: gli amanuensi erano specificamente dedicati alla copiatura." } },
  { topic: "medioevo", difficulty: 4, prompt: "Perché nel Basso Medioevo rinascono le città?", answer: "Perché ripartono commerci e artigianato", distractors: ["Perché i castelli vengono abbandonati","Perché la popolazione smette di crescere","Perché i signori le fanno costruire"], explanation: "Con più scambi servono luoghi dove vendere e produrre: nascono i mercati, le corporazioni e i Comuni.",
    distractorWhy: { "Perché i castelli vengono abbandonati": "L'abbandono dei castelli non è la causa principale: è la ripresa di commerci e artigianato a far rinascere le città.", "Perché la popolazione smette di crescere": "È il contrario: la popolazione cresce, ed è proprio questo a favorire commerci e città.", "Perché i signori le fanno costruire": "Le città rinascono spontaneamente grazie ai commerci, non per costruzione pianificata dei signori." } },
  { topic: "medioevo", difficulty: 3, prompt: "Che cos'era un Comune medievale italiano?", answer: "Una città che si governava da sé", distractors: ["Un villaggio di contadini liberi","Un accordo fra due signori vicini","Un territorio dato alla Chiesa"], explanation: "I cittadini si organizzavano per decidere da soli, spesso in conflitto con l'imperatore o con il vescovo.",
    distractorWhy: { "Un villaggio di contadini liberi": "Il Comune era tipicamente una città, con un governo proprio, non un semplice villaggio agricolo.", "Un accordo fra due signori vicini": "Il Comune non era un patto fra signori: era un governo cittadino autonomo.", "Un territorio dato alla Chiesa": "Il Comune si autogovernava, spesso in conflitto con i poteri religiosi, non era un dono alla Chiesa." } },
  { topic: "medioevo", difficulty: 4, prompt: "Quale invenzione della metà del Quattrocento cambiò la diffusione del sapere?", answer: "La stampa a caratteri mobili", distractors: ["La bussola per la navigazione","L'orologio meccanico da torre","Gli occhiali da lettura"], explanation: "Copiare un libro richiedeva mesi; stamparne centinaia diventa questione di giorni. Le idee cominciano a viaggiare.",
    distractorWhy: { "La bussola per la navigazione": "La bussola aiutò i viaggi per mare, non la diffusione dei testi scritti.", "L'orologio meccanico da torre": "L'orologio misurava il tempo pubblico, ma non moltiplicava la diffusione dei libri.", "Gli occhiali da lettura": "Gli occhiali aiutavano chi già leggeva, ma non moltiplicavano il numero di copie disponibili." } },
  // --- metodo ---
  { topic: "metodo", difficulty: 1, prompt: "Chi studia il passato usando le tracce che ci ha lasciato?", answer: "Lo storico", distractors: ["Il meteorologo", "Il geologo", "L'astronomo"], explanation: "Lo storico ricostruisce il passato interpretando le fonti.",
    distractorWhy: { "Il meteorologo": "Il meteorologo studia il tempo atmosferico, non il passato umano.", "Il geologo": "Il geologo studia le rocce e la Terra, non le tracce lasciate dagli uomini nel passato.", "L'astronomo": "L'astronomo studia i corpi celesti, non le fonti storiche umane." } },
  { topic: "metodo", difficulty: 2, prompt: "Che cosa sono le fonti storiche?", answer: "Le tracce che ci parlano del passato", distractors: ["Le sorgenti d'acqua di montagna", "Soltanto i libri stampati oggi", "Le previsioni sul futuro lontano"], explanation: "Documenti, oggetti, resti e racconti sono fonti: ci fanno conoscere il passato.",
    distractorWhy: { "Le sorgenti d'acqua di montagna": "È un altro significato della parola «fonte»: qui si parla di tracce del passato, non di acqua.", "Soltanto i libri stampati oggi": "Le fonti includono oggetti, immagini e testimonianze, non solo libri stampati oggi.", "Le previsioni sul futuro lontano": "Le fonti storiche raccontano il passato, non prevedono il futuro." } },
  { topic: "metodo", difficulty: 3, prompt: "Una piramide egizia è un esempio di fonte…", answer: "materiale", distractors: ["scritta", "orale", "immaginaria"], explanation: "Le fonti materiali sono oggetti e costruzioni; quelle scritte sono i testi.",
    distractorWhy: { "scritta": "Una piramide non è un testo da leggere: è una costruzione, quindi una fonte materiale.", "orale": "Una piramide non è un racconto tramandato a voce: è un oggetto costruito.", "immaginaria": "Una piramide è reale e osservabile, non immaginaria." } },
  // --- cronologia ---
  { topic: "cronologia", difficulty: 1, prompt: "Quanti anni dura un secolo?", answer: "Cento", distractors: ["Dieci", "Mille", "Cinquanta"], explanation: "Attenzione al conto: il Novecento è il ventesimo secolo, perché il primo comprende gli anni dall'1 al 100.",
    distractorWhy: { "Dieci": "Dieci anni sono un decennio, non un secolo.", "Mille": "Mille anni sono un millennio, non un secolo.", "Cinquanta": "Cinquanta anni sono metà di un secolo, non un secolo intero." } },
  { topic: "cronologia", difficulty: 2, prompt: "Come si indicano gli anni prima della nascita di Cristo?", answer: "a.C.", distractors: ["d.C.", "km", "d.o.c."], explanation: "a.C. significa 'avanti Cristo'; d.C. significa 'dopo Cristo'.",
    distractorWhy: { "d.C.": "«d.C.» significa «dopo Cristo»: è l'opposto di «avanti Cristo».", "km": "«Km» è un'unità di misura di lunghezza, non un'indicazione temporale.", "d.o.c.": "«D.o.c.» è una sigla usata per prodotti alimentari, non per indicare epoche storiche." } },
  { topic: "cronologia", difficulty: 3, prompt: "A quale secolo appartiene l'anno 1492?", answer: "XV secolo", distractors: ["XIV secolo", "XVI secolo", "XIII secolo"], explanation: "Gli anni dal 1401 al 1500 formano il XV secolo (il '400).",
    distractorWhy: { "XIV secolo": "Il XIV secolo copre gli anni 1301-1400: il 1492 viene dopo.", "XVI secolo": "Il XVI secolo copre gli anni 1501-1600: il 1492 viene prima.", "XIII secolo": "Il XIII secolo copre gli anni 1201-1300: il 1492 è molto più tardi." } },
  // --- preistoria ---
  { topic: "preistoria", difficulty: 2, prompt: "Che cosa distingue la Preistoria dalla Storia?", answer: "L'assenza della scrittura", distractors: ["L'assenza del fuoco", "L'assenza degli animali", "L'assenza del Sole"], explanation: "La Storia inizia con l'invenzione della scrittura; prima c'è la Preistoria.",
    distractorWhy: { "L'assenza del fuoco": "Il fuoco era già usato nella Preistoria: non è questo il confine con la Storia.", "L'assenza degli animali": "Gli animali esistevano in entrambi i periodi: non è questo il confine.", "L'assenza del Sole": "Il Sole non c'entra: il confine fra Preistoria e Storia è la scrittura." } },
  { topic: "preistoria", difficulty: 2, prompt: "Di che cosa viveva soprattutto l'uomo del Paleolitico?", answer: "Caccia e raccolta", distractors: ["Agricoltura intensiva", "Commercio con l'estero", "Allevamento in stalla"], explanation: "Nel Paleolitico l'uomo era nomade e viveva di caccia, pesca e raccolta.",
    distractorWhy: { "Agricoltura intensiva": "L'agricoltura nasce solo dopo, nel Neolitico, non nel Paleolitico.", "Commercio con l'estero": "Non esistevano ancora scambi commerciali organizzati nel Paleolitico.", "Allevamento in stalla": "L'allevamento stanziale nasce con il Neolitico, non nel Paleolitico nomade." } },
  { topic: "preistoria", difficulty: 3, prompt: "Quale grande scoperta segnò il passaggio al Neolitico?", answer: "L'agricoltura", distractors: ["La ruota a motore", "L'elettricità", "La stampa"], explanation: "Con l'agricoltura l'uomo diventò sedentario e nacquero i primi villaggi.",
    distractorWhy: { "La ruota a motore": "La ruota a motore è un'invenzione modernissima, lontanissima nel tempo dal Neolitico.", "L'elettricità": "L'elettricità è una scoperta modernissima, non del Neolitico.", "La stampa": "La stampa nasce nel Quattrocento, migliaia di anni dopo il Neolitico." } },
  { topic: "preistoria", difficulty: 3, prompt: "Da quale metallo prende il nome l'Età del Bronzo?", answer: "Dal bronzo", distractors: ["Dal ferro", "Dall'oro", "Dall'argento"], explanation: "Il bronzo è una lega di rame e stagno: diede il nome a quell'età.",
    distractorWhy: { "Dal ferro": "Il ferro dà il nome a un'età successiva, l'Età del Ferro, non a quella del Bronzo.", "Dall'oro": "L'oro non ha dato il nome a nessuna età della preistoria: si usava per ornamenti, non per attrezzi diffusi.", "Dall'argento": "L'argento non ha dato il nome a nessuna età della preistoria." } },
  { topic: "egizi", difficulty: 1, prompt: "Come si chiamava il re dell'antico Egitto?", answer: "Faraone", distractors: ["Console", "Imperatore", "Doge"], explanation: "Il faraone era il sovrano dell'Egitto, considerato quasi un dio.",
    distractorWhy: { "Console": "Il console era una carica della Roma repubblicana, non dell'Egitto.", "Imperatore": "L'imperatore era il titolo del sovrano romano, non egizio.", "Doge": "Il doge era il capo di città come Venezia nel Medioevo, non dell'antico Egitto." } },
  { topic: "egizi", difficulty: 2, prompt: "Lungo quale fiume nacque la civiltà egizia?", answer: "Il Nilo", distractors: ["Il Tevere", "Il Po", "Il Danubio"], explanation: "La civiltà egizia fiorì lungo le rive del Nilo.",
    distractorWhy: { "Il Tevere": "Il Tevere è il fiume di Roma, non dell'Egitto.", "Il Po": "Il Po è un fiume italiano, non dell'Egitto.", "Il Danubio": "Il Danubio scorre in Europa centrale, non in Egitto." } },
  { topic: "egizi", difficulty: 3, prompt: "Perché il Nilo era fondamentale per gli Egizi?", answer: "Perché con le piene rendeva fertili i campi", distractors: ["Perché era sempre gelato tutto l'anno", "Perché non aveva mai una goccia d'acqua", "Perché era pieno di pepite d'oro"], explanation: "Le piene del Nilo lasciavano fango fertile: permettevano l'agricoltura.",
    distractorWhy: { "Perché era sempre gelato tutto l'anno": "Il Nilo scorre in un clima caldo: non è mai stato gelato.", "Perché non aveva mai una goccia d'acqua": "È l'opposto: era proprio l'abbondanza d'acqua delle piene a renderlo fondamentale.", "Perché era pieno di pepite d'oro": "Il valore del Nilo era il fango fertile delle piene, non l'oro." } },
  { topic: "egizi", difficulty: 2, prompt: "Come si chiamava la scrittura degli antichi Egizi?", answer: "Geroglifici", distractors: ["Alfabeto latino", "Numeri romani", "Braille"], explanation: "Gli Egizi scrivevano con i geroglifici, piccoli disegni-simbolo.",
    distractorWhy: { "Alfabeto latino": "L'alfabeto latino è quello dei Romani, nato molto dopo e altrove.", "Numeri romani": "I numeri romani sono un sistema numerico romano, non una scrittura egizia.", "Braille": "Il Braille è un sistema moderno per non vedenti, inventato nell'Ottocento." } },
  { topic: "grecia", difficulty: 2, prompt: "Quale città greca era famosa per i suoi guerrieri e la disciplina?", answer: "Sparta", distractors: ["Atene", "Corinto", "Tebe"], explanation: "A Sparta l'educazione era tutta rivolta alla vita militare.",
    distractorWhy: { "Atene": "Atene era famosa per la democrazia e la cultura, non per la disciplina militare.", "Corinto": "Corinto era famosa per i commerci, non per la disciplina militare.", "Tebe": "Tebe era un'altra polis importante, ma non famosa quanto Sparta per la disciplina militare." } },
  { topic: "grecia", difficulty: 3, prompt: "In quale città greca nacque la democrazia?", answer: "Atene", distractors: ["Sparta", "Olimpia", "Micene"], explanation: "Ad Atene i cittadini partecipavano alle decisioni: nacque la democrazia.",
    distractorWhy: { "Sparta": "Sparta aveva un sistema oligarchico-militare, non la democrazia.", "Olimpia": "Olimpia era il luogo dei Giochi olimpici, non la culla della democrazia.", "Micene": "Micene fu una civiltà precedente, di tipo monarchico, non democratico." } },
  { topic: "grecia", difficulty: 3, prompt: "Come si chiamavano le città-stato indipendenti della Grecia antica?", answer: "Pòleis", distractors: ["Province", "Regioni", "Contee"], explanation: "Montagne e mare separavano le comunità greche, che restarono indipendenti invece di unirsi in un regno unico: ogni pòlis aveva le sue leggi e il suo esercito.",
    distractorWhy: { "Province": "«Provincia» è un termine amministrativo romano, non greco.", "Regioni": "«Regione» è un termine geografico generico, non il nome delle città-stato greche.", "Contee": "«Contea» è un termine medievale europeo, non greco antico." } },
  { topic: "grecia", difficulty: 2, prompt: "In quale luogo si tenevano gli antichi Giochi Olimpici?", answer: "A Olimpia", distractors: ["A Roma", "Ad Alessandria", "A Cartagine"], explanation: "I Giochi si svolgevano a Olimpia, in onore del dio Zeus.",
    distractorWhy: { "A Roma": "Roma è la città dei Romani, non il luogo dei Giochi olimpici greci.", "Ad Alessandria": "Alessandria è una città egizia fondata dai Greci, ma non è dove si tenevano i Giochi.", "A Cartagine": "Cartagine era una città fenicia in Nord Africa, non il luogo dei Giochi." } },
  { topic: "roma", difficulty: 1, prompt: "Quale lingua parlavano gli antichi Romani?", answer: "Il latino", distractors: ["Il greco", "L'italiano", "L'inglese"], explanation: "I Romani parlavano latino, da cui deriva anche l'italiano.",
    distractorWhy: { "Il greco": "Il greco era parlato dai Greci, anche se colto e conosciuto a Roma.", "L'italiano": "L'italiano nasce secoli dopo, come evoluzione del latino parlato.", "L'inglese": "L'inglese è una lingua germanica, nata in un'epoca e in un luogo molto lontani da Roma antica." } },
  { topic: "roma", difficulty: 2, prompt: "Secondo la leggenda, chi fondò Roma?", answer: "Romolo", distractors: ["Enea", "Cesare", "Annibale"], explanation: "La leggenda narra che Roma fu fondata da Romolo, con il fratello Remo.",
    distractorWhy: { "Enea": "Enea è un antenato leggendario di Romolo, ma non il fondatore diretto di Roma.", "Cesare": "Cesare visse secoli dopo la fondazione di Roma: non ne è il fondatore.", "Annibale": "Annibale era un condottiero cartaginese, nemico di Roma, non il suo fondatore." } },
  { topic: "roma", difficulty: 3, prompt: "In quale anno la tradizione colloca la fondazione di Roma?", answer: "753 a.C.", distractors: ["1492 d.C.", "476 d.C.", "100 d.C."], explanation: "È una data di leggenda, non di scavo: serviva ai Romani per darsi un inizio preciso da cui contare gli anni.",
    distractorWhy: { "1492 d.C.": "Il 1492 è la data della scoperta dell'America, molti secoli dopo la fondazione di Roma.", "476 d.C.": "Il 476 d.C. è la data della caduta dell'Impero Romano d'Occidente, non della sua fondazione.", "100 d.C.": "Il 100 d.C. è già in pieno Impero romano, secoli dopo la fondazione leggendaria." } },
  { topic: "roma", difficulty: 3, prompt: "Dopo la monarchia, quale forma di governo ebbe Roma?", answer: "La repubblica", distractors: ["L'anarchia", "Il feudalesimo", "La democrazia diretta"], explanation: "Cacciato l'ultimo re, Roma diventò una repubblica guidata dai consoli.",
    distractorWhy: { "L'anarchia": "Roma non restò senza governo: passò a un sistema repubblicano organizzato con consoli e senato.", "Il feudalesimo": "Il feudalesimo è un sistema medievale, nato molto dopo la repubblica romana.", "La democrazia diretta": "Roma repubblicana non aveva una democrazia diretta come Atene: il potere era distribuito fra magistrati e senato." } },
  { topic: "roma", difficulty: 3, prompt: "Come si chiamava l'assemblea dei senatori a Roma?", answer: "Il Senato", distractors: ["Il Colosseo", "Il Foro", "La Curia dei re"], explanation: "Il Senato riuniva i patrizi e consigliava chi governava Roma.",
    distractorWhy: { "Il Colosseo": "Il Colosseo era l'anfiteatro per gli spettacoli, non l'assemblea dei senatori.", "Il Foro": "Il Foro era la piazza pubblica di Roma, non l'assemblea in sé.", "La Curia dei re": "La Curia era l'edificio dove si riuniva il Senato, ma «Curia dei re» non è il nome dell'assemblea." } },
  { topic: "roma", difficulty: 2, prompt: "Chi guidava l'Impero Romano?", answer: "L'imperatore", distractors: ["Il faraone", "Il doge", "Il presidente"], explanation: "Dopo la repubblica, Roma fu guidata da un imperatore, il primo fu Augusto.",
    distractorWhy: { "Il faraone": "Il faraone era il sovrano dell'antico Egitto, non di Roma.", "Il doge": "Il doge era il capo di città come Venezia nel Medioevo, non dell'Impero romano.", "Il presidente": "Il presidente è una carica moderna, non esisteva nella Roma antica." } },
  { topic: "medioevo", difficulty: 3, prompt: "Quale evento segna l'inizio del Medioevo?", answer: "La caduta dell'Impero Romano d'Occidente", distractors: ["La fondazione della città di Roma", "La scoperta dell'America nel 1492", "L'unità d'Italia con i Savoia"], explanation: "Il Medioevo inizia nel 476 d.C., con la caduta dell'Impero Romano d'Occidente.",
    distractorWhy: { "La fondazione della città di Roma": "La fondazione di Roma segna l'inizio della storia romana, non del Medioevo, che viene molti secoli dopo.", "La scoperta dell'America nel 1492": "Il 1492 segna piuttosto la fine del Medioevo e l'inizio dell'età moderna.", "L'unità d'Italia con i Savoia": "L'unità d'Italia avviene nell'Ottocento, molto dopo la fine del Medioevo." } },
  { topic: "medioevo", difficulty: 4, prompt: "Come si chiamava il sistema in cui il signore dava terre in cambio di fedeltà?", answer: "Feudalesimo", distractors: ["Democrazia", "Repubblica", "Impero"], explanation: "Nel feudalesimo il signore concedeva un feudo in cambio di fedeltà e aiuto militare.",
    distractorWhy: { "Democrazia": "La democrazia è un sistema di governo dei cittadini, non uno scambio di terre per fedeltà.", "Repubblica": "La repubblica è una forma di governo senza re, non uno scambio di terre.", "Impero": "L'impero è un tipo di Stato guidato da un imperatore, non lo scambio terra-fedeltà del feudalesimo." } },
  { topic: "medioevo", difficulty: 2, prompt: "A che cosa serviva soprattutto un castello medievale?", answer: "A difendersi dagli attacchi", distractors: ["A coltivare il grano nei campi", "A fare gare sportive fra nobili", "A conservare l'acqua piovana"], explanation: "Il castello, con mura e torri, proteggeva il signore e gli abitanti.",
    distractorWhy: { "A coltivare il grano nei campi": "I campi si coltivavano fuori dal castello: il castello serviva alla difesa.", "A fare gare sportive fra nobili": "I tornei si tenevano talvolta nei pressi dei castelli, ma non era il loro scopo principale.", "A conservare l'acqua piovana": "La raccolta d'acqua non era lo scopo di un castello: la sua funzione era difensiva." } },
  { topic: "medioevo", difficulty: 3, prompt: "Chi copiava a mano i libri nei monasteri medievali?", answer: "I monaci amanuensi", distractors: ["I cavalieri armati", "I mercanti stranieri", "I contadini del feudo"], explanation: "I monaci amanuensi ricopiavano a mano i testi, custodendo il sapere.",
    distractorWhy: { "I cavalieri armati": "I cavalieri si dedicavano alla guerra, non alla copiatura di libri.", "I mercanti stranieri": "I mercanti si dedicavano ai commerci, non alla copiatura di libri nei monasteri.", "I contadini del feudo": "I contadini lavoravano la terra, non copiavano libri nei monasteri." } },
  { topic: "medioevo", difficulty: 2, prompt: "Come si chiamavano i guerrieri a cavallo al servizio di un signore?", answer: "Cavalieri", distractors: ["Faraoni", "Consoli", "Legionari"], explanation: "I cavalieri combattevano a cavallo e giuravano fedeltà al loro signore.",
    distractorWhy: { "Faraoni": "I faraoni erano i sovrani egizi, non guerrieri al servizio di un signore medievale.", "Consoli": "I consoli erano magistrati della Roma repubblicana, non guerrieri medievali a cavallo.", "Legionari": "I legionari erano soldati dell'esercito romano, non cavalieri medievali." } },
  { topic: "medioevo", difficulty: 3, prompt: "Dove si conservava e si copiava il sapere nell'Alto Medioevo?", answer: "Nei monasteri", distractors: ["Nei supermercati", "Nelle fabbriche", "Nei porti"], explanation: "I monasteri furono centri di cultura: vi si custodivano e copiavano i libri.",
    distractorWhy: { "Nei supermercati": "I supermercati sono un'istituzione modernissima, inesistente nel Medioevo.", "Nelle fabbriche": "Le fabbriche moderne non esistevano nel Medioevo: il sapere si conservava nei monasteri.", "Nei porti": "I porti servivano ai commerci marittimi, non alla conservazione dei libri." } },
  ...
  "coding-base": [
    {
      ...
      "distractorWhy": { "È scritto in un solo linguaggio": "Lo stesso algoritmo può essere scritto in linguaggi diversi: non è legato a uno solo.", "Usa sempre almeno un ciclo": "Un algoritmo può anche non avere cicli: la caratteristica che conta è che sia finito e definito.", "Contiene almeno una funzione": "Un algoritmo non richiede necessariamente funzioni: può essere una sequenza semplice di passi." }
    },
    {
      ...
      "distractorWhy": { "Quattro volte": "Il quarto valore sarebbe 11, ma range si ferma prima di 10: i valori sono solo 2, 5 e 8.", "Otto volte": "Il passo è 3, non 1: non si contano tutti i numeri da 2 a 10, solo quelli distanziati di 3.", "Dieci volte": "10 è il limite escluso di range, non il numero di giri: i giri sono solo tre." }
    },
    {
    ...
    },
    {
      ...
      "distractorWhy": { "a": "'a' è all'indice 0, non 1.", "c": "'c' è all'indice 2, non 1.", "bc": "L'indicizzazione singola restituisce un solo carattere, non due." }
    },
    {
    ...
    },
    {
      ...
      "distractorWhy": { "False": "True and False dà False, ma not lo capovolge: il risultato finale è True.", "None": "not restituisce sempre un booleano, mai None.", "Zero": "not restituisce un valore booleano (True), non il numero 0." }
    },
    {
    ...
    },
    {
      ...
      "distractorWhy": { "Un numero intero": "In Python 3 la divisione con / dà sempre un float, anche quando il risultato è un numero esatto come 5.0.", "Una stringa di testo": "Il risultato è un valore numerico, non testo fra virgolette.", "Un valore booleano": "Il risultato di una divisione è un numero, non True o False." }
    },
    {
  ...
  "storia-base": [
    {
      ...
      "distractorWhy": { "Le forme dei terreni": "Quella è la geografia, non la storia.", "I numeri e le figure": "Quella è la matematica, non la storia.", "Le lingue straniere": "Quello è lo studio delle lingue, non la storia." }
    },
    {
      ...
      "distractorWhy": { "Geologo": "Il geologo studia le rocce e la Terra, non i resti umani sepolti.", "Astronomo": "L'astronomo studia i corpi celesti, non i resti sepolti nel terreno.", "Biologo": "Il biologo studia gli esseri viventi, non i resti sepolti del passato." }
    },
    {
      ...
      "distractorWhy": { "orale": "Un vaso non è un racconto a voce: è un oggetto.", "scritta": "Un vaso non porta un testo da leggere: è un oggetto.", "immaginaria": "Un vaso è reale e osservabile, non immaginario." }
    },
    {
    ...
    },
    {
      ...
      "distractorWhy": { "Cento": "Cento anni sono un secolo, non un millennio.", "Diecimila": "Diecimila anni sono dieci millenni, non uno solo.", "Cinquecento": "Cinquecento anni sono metà di un millennio." }
    },
    {
      ...
      "distractorWhy": { "dopo di Cristo": "«Dopo Cristo» si indica con d.C., l'opposto di a.C.", "nel Medioevo": "Il Medioevo è un periodo dopo Cristo, non indicato dalla sigla a.C.", "in epoca moderna": "L'epoca moderna è molto dopo Cristo, non indicata da a.C." }
    },
    {
      ...
      "distractorWhy": { "il fuoco": "Il fuoco era già conosciuto nella preistoria.", "la caccia": "La caccia era già praticata nella preistoria.", "la pietra": "La pietra era già lavorata nella preistoria: è il materiale che dà il nome a quell'epoca." }
    },
    {
      ...
      "distractorWhy": { "Il ferro fuso": "Il ferro si lavora in un'epoca molto più tarda, non nel Paleolitico.", "La plastica": "La plastica è un materiale modernissimo, non della preistoria.", "Il vetro soffiato": "Il vetro soffiato è una tecnica sviluppata molto più tardi, non nel Paleolitico." }
    },
    {
      ...
      "distractorWhy": { "Atene": "Atene è la città della civiltà greca, non di quella romana.", "Il Cairo": "Il Cairo è una città moderna dell'Egitto, non la culla della civiltà romana.", "Babilonia": "Babilonia è una città mesopotamica, non la culla della civiltà romana." }
    },
    {
      ...
      "distractorWhy": { "Il Tevere": "Il Tevere è il fiume di Roma, non dell'Egitto.", "Il Danubio": "Il Danubio scorre in Europa centrale, non in Egitto.", "Il Gange": "Il Gange scorre in India, non in Egitto." }
    },
    {
      ...
      "distractorWhy": { "La tirannide": "La tirannide è il governo di un singolo tiranno, diverso dal sistema repubblicano romano.", "La democrazia diretta": "Roma repubblicana non aveva una democrazia diretta come Atene: il potere era nei magistrati e nel senato.", "L'oligarchia militare": "Non era un governo di soli militari: la repubblica aveva magistrati eletti e senato." }
    },
    {
      ...
      "distractorWhy": { "Giulio Cesare": "Cesare fu dittatore, ma morì prima di diventare imperatore: il primo fu Augusto.", "Nerone": "Nerone fu un imperatore successivo, non il primo.", "Traiano": "Traiano fu un imperatore successivo, non il primo." }
    },
    {
      ...
      "distractorWhy": { "Sparta": "Sparta aveva un sistema oligarchico-militare, non la democrazia.", "Corinto": "Corinto era famosa per i commerci, non per aver dato i natali alla democrazia.", "Tebe": "Tebe era un'altra polis importante, ma non è dove nacque la democrazia." }
    },
    {
      ...
      "distractorWhy": { "Un tempio sacro": "Il tempio era un edificio dentro la polis, non la polis stessa.", "Una nave da guerra": "La nave da guerra è uno strumento militare, non l'organizzazione politica della città.", "Una moneta d'oro": "La moneta era un oggetto usato dalla polis, non la polis stessa." }
    },
    {
      ...
      "distractorWhy": { "una nave da comandare": "Il feudo era terra, non una nave: lo scambio riguardava terra per fedeltà.", "una moneta da coniare": "Coniare moneta era un privilegio del sovrano, non ciò che il signore dava al vassallo.", "una legge da scrivere": "Le leggi non erano date in feudo: il feudo era terra da amministrare." }
    },
    {
      ...
      "distractorWhy": { "Federico Barbarossa": "Federico Barbarossa visse secoli dopo, nel XII secolo, non nell'800.", "Ottone I": "Ottone I fu incoronato nel 962, non la notte di Natale dell'800.", "Giustiniano": "Giustiniano fu un imperatore bizantino del VI secolo, non incoronato nell'800." }
    },
    {
      ...
      "distractorWhy": { "La caduta di Roma": "La caduta di Roma segna l'inizio del Medioevo, non la sua fine.", "La prima crociata": "La prima crociata avviene nell'XI secolo, in pieno Medioevo, non alla sua fine.", "La peste nera": "La peste nera del Trecento è un evento importante ma non è convenzionalmente la fine del Medioevo." }
    },
    {
      ...
      "distractorWhy": { "La nascita di Cristo": "La nascita di Cristo segna l'inizio del calendario cristiano, non del Medioevo.", "La fondazione di Roma": "La fondazione di Roma è all'inizio della sua storia antica, non del Medioevo.", "La scoperta dell'America": "La scoperta dell'America segna la fine del Medioevo, non il suo inizio." }
    },
    {
      ...
      "distractorWhy": { "A curare le malattie dei vivi": "La mummificazione riguardava i defunti, non la cura dei vivi.", "A misurare il tempo dell'anno": "Misurare il tempo era compito del calendario, non della mummificazione.", "A segnare i confini dei campi": "I confini si ridisegnavano con la geometria, non con la mummificazione." }
    },
    {
      ...
      "distractorWhy": { "Si spense l'uso del fuoco": "Il fuoco continuò a essere usato anche nel Neolitico: non si spense.", "Sparirono gli utensili di pietra": "Gli utensili di pietra continuarono a essere usati, ora levigata invece che scheggiata.", "Comparve la scrittura alfabetica": "La scrittura alfabetica arriva molto più tardi, non nel Neolitico." }
    }
  ]
};
