...
export class LanguageRepairConsole {
  static fromPuzzle(puzzle: GeneratedLanguagePuzzle): LanguageRepairModel {
    return {
      ...
      hints: puzzle.hints,
      difficultyLabel: puzzle.difficultyLabel ?? "Profondità 1 - riparazione guidata",
      conceptTags: puzzle.conceptTags ?? ["comprensione", "grammatica", "coerenza"],
      learningPurpose: puzzle.learningPurpose ?? "Calibra comprensione e grammatica dentro un messaggio tecnico da rendere eseguibile.",
