...
L'atlante operativo è `godot/assets/radura-academia-natural-atlas-v2.png`:
...
L'atlante operativo `godot/assets/bosco-variabile-natural-atlas-v2.png` è dedicato
al Bosco Variabile: usa silhouette più selvagge, muschio, radici, funghi e
bacche, con mapping separato nel visual factory.

L'atlante operativo `godot/assets/dorsale-geografica-natural-atlas-v2.png` è dedicato
alla Dorsale Geografica: acqua, cascate, ponti, rocce stratificate, pozze,
segnali di sentiero e fiori alpini.

L'atlante operativo `godot/assets/cratere-logico-natural-atlas-v2.png` è dedicato
