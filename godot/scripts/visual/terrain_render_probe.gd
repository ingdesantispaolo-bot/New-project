...
const PROBES := [
	...
	{"id": "enigma-map", "position": Vector2(-80, 80), "enigma_stage": 4, "enigma_id": "enigma-mappa-stellare"},
	{"id": "enigma-greenhouse", "position": Vector2(80, 700), "enigma_stage": 4, "enigma_id": "enigma-serra-bio"},
	{"id": "enigma-network", "position": Vector2(820, 700), "enigma_stage": 4, "enigma_id": "enigma-rete-civica"},
	{"id": "enigma-grid", "position": Vector2(980, 100), "enigma_stage": 4, "enigma_id": "enigma-griglia-logica"},
