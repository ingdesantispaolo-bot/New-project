...
const CATALOG := [
	...
	# non aveva mai fatto.
	{"id": "pet-dog", "slot": "pet", "name": "Cane Scout", "description": "Il Custode prende forma di cane scout: resta basso, vicino, e si pianta dove hai smesso di guardare.", "origine": "Randagio del molo. Si è imbarcato da solo e nessuno se l’è sentita di dirgli di no.", "cost": 1700, "glyph": "🐶", "color": 0xd9a15f, "minLevel": 4},
	{"id": "pet-cat", "slot": "pet", "name": "Gatto Prisma", "description": "Il Custode prende forma di gatto: gira largo e torna quando decide lui.", "origine": "Viveva nell’Archivio, sopra gli scaffali. Conosce i libri meglio dei copisti.", "cost": 2200, "glyph": "🐱", "color": 0xc7b8ff, "minLevel": 5},
	{"id": "pet-rabbit", "slot": "pet", "name": "Coniglio Luma", "description": "Il Custode prende forma di coniglio: sta fermo, poi copre in un salto la distanza che aveva tenuto.", "origine": "Dalla Serra delle Simbiosi, dove niente cresce da solo.", "cost": 2800, "glyph": "🐰", "color": 0xf2f7ff, "minLevel": 6},
	{"id": "pet-spark", "slot": "pet", "name": "Pet Scintilla", "description": "La forma piu' semplice del Custode: un nucleo di luce, senza corpo.", "origine": "Scintilla staccata da un quadro della Tempesta. Non si è più spenta.", "cost": 1500, "glyph": "✦", "color": 0xf6c85f, "minLevel": 4},
	{"id": "pet-comet", "slot": "pet", "name": "Pet Cometa", "description": "Il Custode diventa una scia: lascia dietro di se' un tratto morbido di dove siete passati.", "origine": "Frammento di scia del Deserto delle Orbite, catturato a mano.", "cost": 1900, "glyph": "≋", "color": 0xffb85c, "minLevel": 5},
	...
	{"id": "pet-luma", "slot": "pet", "name": "Pet Luma", "description": "Il Custode diventa una stella viva che pulsa nei momenti in cui hai capito qualcosa.", "origine": "Luce delle caverne della Biosfera. Al buio conta le persone e si tranquillizza.", "cost": 4300, "glyph": "✸", "color": 0xffd75e, "minLevel": 9},
	{"id": "pet-guardiano", "slot": "pet", "name": "Pet Guardiano", "description": "Il Custode assume il passo lento e dorato dei guardiani dei cristalli.", "origine": "Il guardiano dei cristalli, che Puccio saluta per nome. Tutti e quaranta.", "cost": 5200, "glyph": "⬡", "color": 0xffd75e, "minLevel": 10},
