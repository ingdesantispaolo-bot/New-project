...
export const proceduralFocusPaths: Record<ProceduralSpecialization, ProceduralFocusPath> = {
  ...
  italiano: {
    ...
    sideNote: "Il percorso privilegia comprensione, coesione, modi e tempi verbali, nessi logici, lessico preciso e pensiero critico sul testo.",
    ...
    stageHint: "Percorso italiano: cerca soggetto reale, verbo reggente, modo e tempo, causa, conseguenza, negazioni e dettagli inutili. Il bonus focus premia il segnale.",
    primaryPuzzle: "language",
    challengeStages: [
      { label: "Verbo e accordo", description: "Ripara articolo, nome, verbo e aggettivo mantenendo il significato tecnico." },
      { label: "Modi e tempi", description: "Riconosci indicativo, congiuntivo, condizionale, imperativo e scegli il tempo coerente." },
    ...
    hotspots: {
      language: { label: "Nucleo del messaggio", description: "Il messaggio corrotto va riparato controllando verbo, modo, tempo, causa, ordine e senso tecnico." },
    ...
    objectives: {
      language: { label: "Ripara il messaggio centrale", description: "Correggi verbi, accordi, connettivi e riferimenti senza perdere il significato." },
