...
const INCARICHI := {
	1: {
		...
		"apertura": "L'obelisco dei numeri è spento da quattrocento anni. La Prima lo aveva acceso per contare i giorni: si è fermato a metà di un conto, e nessuno sa a quale numero.",
	...
	2: {
		...
		"apertura": "La Seconda teneva delle rondini nell'Archivio: entravano dalle finestre alte e le portavano le parole che sentivano fuori. Le finestre si sono chiuse con loro dentro.",
	...
	3: {
		...
		"apertura": "La Terza aveva costruito una macchina che ripete un gesto finché la condizione regge. Si è inceppata al terzo giro, e da allora fa sempre il terzo giro.",
	...
	4: {
		...
		"apertura": "Un braciere di segnalazione è caduto sul molo e da allora cova. La Quarta lo teneva acceso per farsi vedere da lontano: adesso si vede troppo.",
		"esito": "Il fuoco si spegne. Sotto la cenere il molo è intero, e le boe tornano a rispondere.",
	},
	5: {
		"forma": FORMA_RIPARARE,
		"titolo": "La grande leva",
		"apertura": "La Quinta aveva calcolato il fulcro al centimetro. Qualcuno l'ha spostato di un palmo per fare prima, e la leva non solleva più niente.",
	...
	6: {
		...
		"apertura": "La Sesta accordava l'albero risonante ogni stagione. Da quattrocento anni nessuno lo accorda: le corde ci sono, la nota no.",
		"esito": "L'albero riprende la sua nota. Le terrazze attorno si illuminano al ritmo, una per battuta.",
	},
	7: {
		"forma": FORMA_LIBERARE,
		"titolo": "Il cortile murato",
		"apertura": "La Settima aveva murato un cortile per proteggere le iscrizioni dal vento. Dentro c'era anche una colonia di lucertole di pietra, e la protezione è diventata una prigione.",
	...
	8: {
		...
		"apertura": "L'Ottavo aveva messo le stanze in parallelo perché la caduta di una non spegnesse le altre. Un nodo è in corto e le sta trascinando giù una per una.",
	...
	9: {
		...
		"apertura": "La Nona misurava le rotte da questa torre. Il braccio dello strumento è caduto in mare: senza, la carta dell'arcipelago resta una carta di quattro secoli fa.",
	...
	10: {
		...
		"apertura": "La Decima aveva separato le specie in vasche per studiarle una per volta. Poi ha capito che nessuna sopravvive da sola, ed è arrivato il Silenzio prima che potesse rimetterle insieme.",
	...
	11: {
		...
		"apertura": "L'Undicesima teneva acceso il portale per confrontare due date che non tornavano. Si è spento con la domanda ancora aperta.",
	...
	12: {
		...
		"apertura": "Il labirinto muove i muri da solo, e il meccanismo al centro sta andando in temperatura. La Dodicesima l'aveva progettato per riposare ogni notte: non riposa da quattro secoli.",
	...
	13: {
		...
		"apertura": "La lente maggiore è coperta di sabbia da tanto tempo che la sabbia è diventata crosta. Sotto, lo specchio è intatto: qualcuno l'aveva chiuso bene prima di andarsene.",
	...
	14: {
		...
		"apertura": "La sala registra chi la attraversa e ripete quello che ha sentito. Le porte si sono bloccate con dentro quattro secoli di voci, che si ripetono addosso l'una all'altra.",
	...
	15: {
		...
		"apertura": "Il mulino muove l'acqua per tutta la rete bassa. Una pala è saltata e le altre tre girano storte: la rete beve, ma male.",
	...
	16: {
		...
		"apertura": "Il mercato del valico ha preso fuoco da una parte sola, e da quella parte c'erano le insegne in sei lingue. Se brucia quello, la frontiera resta muta.",
	...
	17: {
		...
		"apertura": "Una rete da misurazione si è impigliata sulla cattedrale sottomarina. Serviva a contare quello che passava: adesso lo trattiene.",
	...
	18: {
		...
		"apertura": "Metà del grande organo non prende più aria. Suona lo stesso, ma con metà delle voci: da secoli la cattedrale canta un accordo incompleto e nessuno ricorda quello intero.",
	...
	19: {
		...
		"apertura": "L'albero delle radici cresce da solo da quattrocento anni e sta scoperchiando gli archivi sotto. Nessuno l'ha potato: nessuno c'era.",
	...
	20: {
		...
		"apertura": "La torre di campo doveva scaricare a terra. Il collegamento è saltato e adesso raccoglie e basta: ogni scarica se la tiene, e la tempesta lo ha capito.",
	...
	21: {
		...
		"apertura": "Il pilastro tiene ferme due placche che vogliono andare in direzioni diverse. Si è crepato in tre punti, e la crepa si allarga di un dito all'anno.",
	...
	22: {
		...
		"apertura": "Una paratia di sicurezza ha sigillato il nucleo vivente insieme a tutto quello che ci viveva attorno. Doveva restare chiusa un'ora.",
	...
	23: {
		...
		"apertura": "L'archivio si illumina solo dove qualcuno sta leggendo. Da quattrocento anni non legge nessuno, e quindi è tutto buio: le fonti ci sono ancora, ma non si vedono.",
