...
import noraPresenceAwakeningV3Url from "../assets/images/generative/nora-presence-awakening-v3.webp";
import noraPresenceDormantV3Url from "../assets/images/generative/nora-presence-dormant-v3.webp";
import noraPresenceGuardianV3Url from "../assets/images/generative/nora-presence-guardian-v3.webp";
import noraPresenceMemoryV3Url from "../assets/images/generative/nora-presence-memory-v3.webp";
...
const packs: Record<SceneAssetPack, AssetEntry[]> = {
  ...
  story: [
    image("nora-presence-dormant-v3", noraPresenceDormantV3Url),
    image("nora-presence-awakening-v3", noraPresenceAwakeningV3Url),
    image("nora-presence-memory-v3", noraPresenceMemoryV3Url),
    image("nora-presence-portrait-v2", noraPresencePortraitV2Url),
    image("nora-presence-guardian-v3", noraPresenceGuardianV3Url),
