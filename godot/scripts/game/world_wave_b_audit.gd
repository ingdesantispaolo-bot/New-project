...
## Gate visuale C-P5, ondata B. Verifica in istanze reali i mondi 5–8:
## topologia, ingresso nave, landmark, semantica O-P5, reazioni e budget Web.
...
const SPECS := {
	5: {
		"theme": "motion_forge",
		"landmark": "motionLever",
		"underpaint": "res://assets/officine-moto-underpaint-v1.png",
		"texture": "res://assets/officine-grande-leva-v1.png",
		"water": 0,
	},
	6: {
		"theme": "resonance_garden",
		"landmark": "resonantTree",
		"underpaint": "res://assets/giardino-risonanza-underpaint-v1.png",
		"texture": "res://assets/giardino-albero-risonante-v1.png",
		"water": 2,
	},
	7: {
		"theme": "glyph_ruins",
		"landmark": "glyphArch",
		"underpaint": "res://assets/rovine-glifi-underpaint-v1.png",
		"texture": "res://assets/rovine-arco-glifi-v1.png",
		"water": 0,
	},
	8: {
		"theme": "circuit_delta",
		"landmark": "circuitNode",
		"underpaint": "res://assets/delta-circuiti-underpaint-v1.png",
		"texture": "res://assets/delta-nodo-centrale-v1.png",
		"water": 3,
	},
}
...
func _request_for(level: int) -> Dictionary:
	...
	var request := NativeWorldState.default_request("p5-wave-b-audit")
	request["loadLocalSave"] = false
	request["initialSave"] = initial
	return request

func _open_world(level: int) -> Node:
	print("P5 WAVE B audit — caricamento mondo %d" % level)
...
func _assert_world(world: Node, level: int, spec: Dictionary) -> Dictionary:
	...
	assert(floori(float(budget["streamRadius"]) / float(OutdoorChunkManager.CHUNK_SIZE)) <= 1,
		"il tier Web deve mantenere al massimo 9 chunk residenti")
...
func _run() -> void:
	...
	print("P5 WAVE B audit OK — mondi 5/8 distinti, semantica, nave, reazioni e budget Web")
	quit(0)
