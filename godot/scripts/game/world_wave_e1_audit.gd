...
## Gate visuale C-P5, ondata E1. Verifica i mondi 21–23 in scene reali:
...
const SPECS := {
	21: {
		"theme": "fractured_atlas",
		"landmark": "tectonicPillar",
		"underpaint": "res://assets/atlante-fratturato-underpaint-v1.png",
		"texture": "res://assets/atlante-pilastro-tettonico-v1.png",
		"water": 0,
	},
	22: {
		"theme": "deep_biosphere",
		"landmark": "livingCore",
		"underpaint": "res://assets/biosfera-profonda-underpaint-v1.png",
		"texture": "res://assets/biosfera-nucleo-vivente-v1.png",
		"water": 1,
	},
	23: {
...
func _request_for(level: int) -> Dictionary:
	...
	initial["level"] = 23
	initial["worlds"] = {"unlocked": range(1, 24), "current": level}
	var request := NativeWorldState.default_request("p5-wave-e1-audit")
	request["loadLocalSave"] = false
	request["initialSave"] = initial
	return request

func _open_world(level: int) -> Node:
	print("P5 WAVE E1 audit — caricamento mondo %d" % level)
...
func _run() -> void:
	print("P5 WAVE E1 audit — avvio")
	var signatures: Array[Dictionary] = []
	for level in range(21, 24):
	...
	print("P5 WAVE E1 audit OK — mondi 21/23 distinti, semantica, nave, reazioni e budget")
	quit(0)
