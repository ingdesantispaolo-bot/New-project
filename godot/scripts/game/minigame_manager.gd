...
const MATCHING := {
	...
	"fisica": [
		...
		{"explanation": "Il fulcro è il punto fermo; allontanare la mano dal fulcro fa diminuire lo sforzo necessario.", "topic": "leve", "minLevel": 4, "pairs": [["Punto fisso", "Fulcro"], ["Mano più lontana", "Meno forza"], ["Peso più vicino", "Più facile da sollevare"], ["Distanze uguali", "Nessun vantaggio"]]},
		{"explanation": "La pressione cresce quando la stessa forza si concentra su meno superficie; sott'acqua cresce anche con la profondità.", "topic": "pressione", "minLevel": 13, "pairs": [["Punta sottile", "Pressione maggiore"], ["Base larga", "Pressione minore"], ["Acqua bassa", "Pressione minore"], ["Acqua profonda", "Pressione maggiore"]]},
		{"explanation": "Il peso spinge in basso e l'acqua spinge in alto: dal confronto fra le due forze dipende il movimento verticale.", "topic": "galleggiamento", "minLevel": 13, "pairs": [["Forze uguali", "Resta alla stessa altezza"], ["Peso maggiore", "Affonda"], ["Spinta maggiore", "Sale"], ["Corpo più cavo", "Sposta più acqua"]]},
