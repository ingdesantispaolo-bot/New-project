...
## Gate visuale C-P5, ondata D2. Verifica i mondi 17–20 in scene reali:
...
const SPECS := {
	17: {
		"theme": "force_ocean",
		"landmark": "underwaterCathedral",
		"underpaint": "res://assets/oceano-forze-underpaint-v1.png",
		"texture": "res://assets/oceano-cattedrale-sottomarina-v1.png",
		"water": 3,
	},
	18: {
		"theme": "sound_cathedral",
		"landmark": "grandOrgan",
		"underpaint": "res://assets/cattedrale-suono-underpaint-v1.png",
		"texture": "res://assets/cattedrale-grande-organo-v1.png",
		"water": 0,
	},
	19: {
		"theme": "root_necropolis",
		"landmark": "rootTree",
		"underpaint": "res://assets/necropoli-radici-underpaint-v1.png",
		"texture": "res://assets/necropoli-albero-radici-v1.png",
		"water": 0,
	},
	20: {
		"theme": "electromagnetic_storm",
		"landmark": "fieldTower",
		"underpaint": "res://assets/tempesta-elettromagnetica-underpaint-v1.png",
		"texture": "res://assets/tempesta-torre-campo-v1.png",
		"water": 0,
	},
}
...
func _request_for(level: int) -> Dictionary:
	...
	initial["level"] = 20
	initial["worlds"] = {"unlocked": range(1, 21), "current": level}
	var request := NativeWorldState.default_request("p5-wave-d2-audit")
	request["loadLocalSave"] = false
	request["initialSave"] = initial
	return request

func _open_world(level: int) -> Node:
	print("P5 WAVE D2 audit — caricamento mondo %d" % level)
...
func _run() -> void:
	...
	print("P5 WAVE D2 audit OK — mondi 17/20 distinti, semantica, nave, reazioni e budget")
	quit(0)
