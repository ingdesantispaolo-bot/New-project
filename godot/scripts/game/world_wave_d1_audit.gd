...
## Gate visuale C-P5, ondata D1. Verifica i mondi 13–16 in scene reali:
...
const SPECS := {
	13: {
		"theme": "orbital_desert",
		"landmark": "orbitalObservatory",
		"underpaint": "res://assets/deserto-orbite-underpaint-v1.png",
		"texture": "res://assets/deserto-osservatorio-v1.png",
		"water": 0,
	},
	14: {
		"theme": "voices_library",
		"landmark": "hallOfVoices",
		"underpaint": "res://assets/biblioteca-voci-underpaint-v1.png",
		"texture": "res://assets/biblioteca-sala-voci-v1.png",
		"water": 0,
	},
	15: {
		"theme": "machine_city",
		"landmark": "controlTower",
		"underpaint": "res://assets/citta-macchina-underpaint-v1.png",
		"texture": "res://assets/citta-torre-controllo-v1.png",
		"water": 0,
	},
	16: {
		"theme": "language_frontier",
		"landmark": "languageGate",
		"underpaint": "res://assets/frontiera-lingue-underpaint-v1.png",
		"texture": "res://assets/frontiera-porta-lingue-v1.png",
		"water": 1,
	},
}
...
func _request_for(level: int) -> Dictionary:
	...
	initial["level"] = 16
	initial["worlds"] = {"unlocked": range(1, 17), "current": level}
	var request := NativeWorldState.default_request("p5-wave-d1-audit")
	request["loadLocalSave"] = false
	request["initialSave"] = initial
	return request

func _open_world(level: int) -> Node:
	print("P5 WAVE D1 audit — caricamento mondo %d" % level)
...
func _run() -> void:
	...
	print("P5 WAVE D1 audit OK — mondi 13/16 distinti, semantica, nave, reazioni e budget")
	quit(0)
